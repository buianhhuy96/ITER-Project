...
DatasetName='TestSet'; % CS_synthetic_1,'kuka_2', 'TestSet' NOTE: %d should be replaced with the dataset number
...
[imagePoints, validIdx, worldPoints, err]=extractCheckerboardPoint(images(:,:,:,1:3), square_size, board_size) 
%{
...
fprintf('Mean error reprojected: %f \n', MREf);
%}
