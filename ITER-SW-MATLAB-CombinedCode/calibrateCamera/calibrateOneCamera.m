...
function [cameraParams, errorOptimized, MREf, validIdx, err] = calibrateOneCamera(images, squareSize, boardSize)
...
lb = -ones(size(initialParamsSerial))*realmax;
ub = ones(size(initialParamsSerial))*realmax;
