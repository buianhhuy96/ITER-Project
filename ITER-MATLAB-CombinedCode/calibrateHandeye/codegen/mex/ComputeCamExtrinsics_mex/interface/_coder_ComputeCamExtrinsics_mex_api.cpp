...
static void h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *valid_idx,
                               const char_T *identifier,
...
static char_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                 const emlrtMsgIdentifier *msgId);
                               ...
                               coder::array<boolean_T, 1U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  i_emlrt_marshallIn(sp, emlrtAlias(valid_idx), &thisId, y);
                        ...
                        const mxArray *plhs[2])
{
  ...
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "robot_poses_vec",
                   robot_poses_vec);
  valid_idx.no_free();
  h_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "valid_idx", valid_idx);
  // Invoke the target function
