                          ...
                          ::coder::array<boolean_T, 2U> &mask)
{
  ...
  if (!(height >= 0.0)) {
    emlrtNonNegativeCheckR2012b(height, &gg_emlrtDCI, (emlrtCTX)sp);
  }
  d = static_cast<int32_T>(muDoubleScalarFloor(height));
  if (height != d) {
    emlrtIntegerCheckR2012b(height, &fg_emlrtDCI, (emlrtCTX)sp);
  }
  mask.set_size(&qq_emlrtRTEI, sp, static_cast<int32_T>(height), mask.size(1));
  if (!(width >= 0.0)) {
    emlrtNonNegativeCheckR2012b(width, &ig_emlrtDCI, (emlrtCTX)sp);
  }
  ...
  if (height != d) {
    emlrtIntegerCheckR2012b(height, &jg_emlrtDCI, (emlrtCTX)sp);
  }
  if (width != d1) {
    emlrtIntegerCheckR2012b(width, &jg_emlrtDCI, (emlrtCTX)sp);
  }
  ...
  if (Y[1] > Y[2]) {
    ...
    if (Y[1] != static_cast<int32_T>(muDoubleScalarFloor(Y[1]))) {
      emlrtIntegerCheckR2012b(Y[1], &bg_emlrtDCI, (emlrtCTX)sp);
    }
    if ((static_cast<int32_T>(Y[1]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(Y[1]), 1,
                                    static_cast<int32_T>(height), &gt_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i = static_cast<int32_T>(Y[1]) - 1;
    if (Y[2] != static_cast<int32_T>(muDoubleScalarFloor(Y[2]))) {
      emlrtIntegerCheckR2012b(Y[2], &cg_emlrtDCI, (emlrtCTX)sp);
    }
    if ((static_cast<int32_T>(Y[2]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(Y[2]), 1,
                                    static_cast<int32_T>(height), &ht_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  if (b_X[1] > b_X[2]) {
    ...
    if (b_X[1] != static_cast<int32_T>(muDoubleScalarFloor(b_X[1]))) {
      emlrtIntegerCheckR2012b(b_X[1], &dg_emlrtDCI, (emlrtCTX)sp);
    }
    if ((static_cast<int32_T>(b_X[1]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_X[1]), 1,
                                    static_cast<int32_T>(width), &it_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i2 = static_cast<int32_T>(b_X[1]) - 1;
    if (b_X[2] != static_cast<int32_T>(muDoubleScalarFloor(b_X[2]))) {
      emlrtIntegerCheckR2012b(b_X[2], &eg_emlrtDCI, (emlrtCTX)sp);
    }
    if ((static_cast<int32_T>(b_X[2]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_X[2]), 1,
                                    static_cast<int32_T>(width), &jt_emlrtBCI,
                                    (emlrtCTX)sp);
    }
                        ...
                        ::coder::array<real_T, 2U> &points, real_T boardSize[2])
{
  ...
  if ((b_I.size(0) == 0) || (b_I.size(1) == 0)) {
    Ig.set_size(&vd_emlrtRTEI, &b_st, b_I.size(0), b_I.size(1));
    ...
    Ig.set_size(&ue_emlrtRTEI, &e_st, b_I.size(0), b_I.size(1));
    if (!tooBig) {
      padSizeT[0] = a.size(0);
      startT[0] = 15.0;
      padSizeT[1] = a.size(1);
  ...
  Iy.set_size(&wd_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  ...
  b_imfilter(&b_st, Ig);
  Ixy.set_size(&xd_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  loop_ub = Ig.size(0) * Ig.size(1);
  for (i = 0; i < loop_ub; i++) {
    Ixy[i] = Ig[i];
  }
  ...
  imfilter(&b_st, Ixy);
  r.set_size(&yd_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  loop_ub = Ig.size(0) * Ig.size(1);
  for (i = 0; i < loop_ub; i++) {
    r[i] = Ig[i] * 0.707106769F;
  }
  I_45.set_size(&ae_emlrtRTEI, &st, Iy.size(0), Iy.size(1));
  ...
  r1.set_size(&ce_emlrtRTEI, &st, Iy.size(0), Iy.size(1));
  loop_ub = Iy.size(0) * Iy.size(1);
  for (i = 0; i < loop_ub; i++) {
  ...
  I_45_x.set_size(&de_emlrtRTEI, &st, I_45.size(0), I_45.size(1));
  ...
  a.set_size(&ee_emlrtRTEI, &st, I_45.size(0), I_45.size(1));
  loop_ub = I_45.size(0) * I_45.size(1);
  for (i = 0; i < loop_ub; i++) {
    a[i] = I_45[i];
  }
  ...
  b_abs(&b_st, I_45, a);
  I_45.set_size(&fe_emlrtRTEI, &st, r.size(0), r.size(1));
  loop_ub = r.size(0) * r.size(1);
  for (i = 0; i < loop_ub; i++) {
    I_45[i] = r[i] + r1[i];
  }
  ...
  cxy.set_size(&ge_emlrtRTEI, &st, b.size(0), b.size(1));
  loop_ub = b.size(0) * b.size(1);
  for (i = 0; i < loop_ub; i++) {
    cxy[i] = b[i] - a[i];
  }
  ...
  r2.set_size(&he_emlrtRTEI, &st, trueCount);
  trueCount = 0;
  for (loop_ub = 0; loop_ub <= end; loop_ub++) {
    if (b[loop_ub] - a[loop_ub] < 0.0F) {
  ...
  for (i = 0; i < loop_ub; i++) {
    if ((r2[i] < 1) || (r2[i] > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(r2[i], 1, trueCount, &p_emlrtBCI, &st);
    }
    cxy[r2[i] - 1] = 0.0F;
  }
  ...
  r3.set_size(&he_emlrtRTEI, &st, trueCount);
  trueCount = 0;
  for (loop_ub = 0; loop_ub <= end; loop_ub++) {
    if (b[loop_ub] < 0.0F) {
  ...
  for (i = 0; i <= loop_ub; i++) {
    if ((r3[i] < 1) || (r3[i] > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(r3[i], 1, trueCount, &q_emlrtBCI, &st);
    }
    b[r3[i] - 1] = 0.0F;
  }
  st.site = &vb_emlrtRSI;
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    if ((end < 1) || (end > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(end, 1, trueCount, &r_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  }
  ...
  points.set_size(&me_emlrtRTEI, sp, 0, 0);
  boardSize[0] = 0.0;
  boardSize[1] = 0.0;
  st.site = &yb_emlrtRSI;
  ...
  st.site = &ac_emlrtRSI;
  loop_ub = points0.size(0);
  b_points0.set_size(&ne_emlrtRTEI, &st, points0.size(0));
  for (i = 0; i < loop_ub; i++) {
    b_points0[i] = points0[i + points0.size(0)];
  }
  loop_ub = points0.size(0);
  c_points0.set_size(&oe_emlrtRTEI, &st, points0.size(0));
  for (i = 0; i < loop_ub; i++) {
    c_points0[i] = points0[i];
  }
  b_iv[0] = (*(int32_T(*)[2])b.size())[0];
  ...
  b_st.site = &tf_emlrtRSI;
  eml_sub2ind(&b_st, b_iv, b_points0, c_points0, r2);
  s.set_size(&pe_emlrtRTEI, &st, r2.size(0));
  loop_ub = r2.size(0);
  for (i = 0; i < loop_ub; i++) {
    s[i] = r2[i];
  }
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    if ((end < 1) || (end > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(end, 1, trueCount, &s_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  }
  b_points0.set_size(&qe_emlrtRTEI, sp, s.size(0));
  loop_ub = s.size(0);
  for (i = 0; i < loop_ub; i++) {
                               ...
                               real_T theta, Checkerboard *iobj_0)
{
  ...
  if (scores.size(0) == 0) {
    ...
    board = &iobj_0[0];
    iobj_0[0].BoardIdx.set_size(&pf_emlrtRTEI, &st, 1, 1);
    iobj_0[0].BoardIdx[0] = 0.0;
    iobj_0[0].BoardIdx.set_size(&qf_emlrtRTEI, &st, 3, 3);
    for (i = 0; i < 9; i++) {
      iobj_0[0].BoardIdx[i] = 0.0;
    }
    iobj_0[0].BoardCoords.set_size(&rf_emlrtRTEI, &st, 1, 1, 1);
    iobj_0[0].BoardCoords[0] = 0.0;
    iobj_0[0].BoardCoords.set_size(&sf_emlrtRTEI, &st, 3, 3, 2);
    for (i = 0; i < 18; i++) {
      iobj_0[0].BoardCoords[i] = 0.0;
    }
    iobj_0[0].Points.set_size(&tf_emlrtRTEI, &st, 1, 1);
    iobj_0[0].Points[0] = 0.0F;
    iobj_0[0].Points.set_size(&uf_emlrtRTEI, &st, 0, 2);
  } else {
    int32_T b_i;
    int32_T i;
    int32_T sgn2;
    if (points.size(0) < 1) {
      seedIdx.set_size(&lf_emlrtRTEI, sp, 1, 0);
    } else {
      seedIdx.set_size(&lf_emlrtRTEI, sp, 1, points.size(0));
    ...
    for (i = 0; i < sgn2; i++) {
      ...
      if (seedIdx[i] != b_i) {
        emlrtIntegerCheckR2012b(seedIdx[i], &i_emlrtDCI, &st);
      }
      if (b_i > scores.size(0)) {
        emlrtDynamicBoundsCheckR2012b(b_i, 1, scores.size(0), &qb_emlrtBCI,
                                      &st);
      }
    }
    x.set_size(&mf_emlrtRTEI, &st, seedIdx.size(1));
    sgn2 = seedIdx.size(1);
    for (i = 0; i < sgn2; i++) {
    ...
    b_seedIdx.set_size(&nf_emlrtRTEI, sp, 1, iidx.size(0));
    sgn2 = iidx.size(0);
    for (i = 0; i < sgn2; i++) {
      if ((iidx[i] < 1) || (iidx[i] > seedIdx.size(1))) {
        emlrtDynamicBoundsCheckR2012b(iidx[i], 1, seedIdx.size(1), &rb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      b_seedIdx[i] = static_cast<uint32_T>(seedIdx[iidx[i] - 1]);
    }
    seedIdx.set_size(&nf_emlrtRTEI, sp, 1, b_seedIdx.size(1));
    ...
    if (iidx.size(0) > 2000) {
      ...
      if (1 > sgn2) {
        ...
        if (1 > seedIdx.size(1)) {
          emlrtDynamicBoundsCheckR2012b(1, 1, seedIdx.size(1), &nb_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if (sgn2 > seedIdx.size(1)) {
          emlrtDynamicBoundsCheckR2012b(sgn2, 1, seedIdx.size(1), &ob_emlrtBCI,
                                        (emlrtCTX)sp);
        }
      }
      b_seedIdx.set_size(&of_emlrtRTEI, sp, 1, sgn2);
      for (i = 0; i < sgn2; i++) {
        b_seedIdx[i] = static_cast<uint32_T>(seedIdx[i]);
      }
      seedIdx.set_size(&of_emlrtRTEI, sp, 1, b_seedIdx.size(1));
      sgn2 = b_seedIdx.size(1);
      for (i = 0; i < sgn2; i++) {
        seedIdx[i] = b_seedIdx[i];
      }
    ...
    for (b_i = 0; b_i < i; b_i++) {
      ...
      if (b_i + 1 > seedIdx.size(1)) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, seedIdx.size(1), &sb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      sgn2 = static_cast<int32_T>(static_cast<uint32_T>(seedIdx[b_i]));
      if (sgn2 > points.size(0)) {
        emlrtDynamicBoundsCheckR2012b(sgn2, 1, points.size(0), &pb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      ...
      b = Ixy[(static_cast<int32_T>(static_cast<real32_T>(
              ...
              1];
      if (static_cast<real_T>(b_x[1]) != static_cast<int32_T>(b_x[1])) {
        emlrtIntegerCheckR2012b(static_cast<real_T>(b_x[1]), &n_emlrtDCI, &st);
      }
      if ((static_cast<int32_T>(static_cast<real32_T>(d)) < 1) ||
      ...
      if (static_cast<real_T>(b_x[0]) != static_cast<int32_T>(b_x[0])) {
        emlrtIntegerCheckR2012b(static_cast<real_T>(b_x[0]), &o_emlrtDCI, &st);
      }
      if ((static_cast<int32_T>(static_cast<real32_T>(d1)) < 1) ||
                     ...
                     const ::coder::array<real32_T, 2U> &b_I)
{
  ...
  if (!muSingleScalarIsInf(x)) {
    ...
    if (b_board->BoardCoords.size(0) < b_board->BoardCoords.size(1)) {
      ...
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &hq_emlrtBCI, &st);
      }
    ...
    if (::coder::internal::ifWhileCond(&st, y)) {
      ...
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &ds_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &bs_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &wr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &ur_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &sr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &qr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &or_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &kr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &ir_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &gr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (3 > i) {
        emlrtDynamicBoundsCheckR2012b(3, 1, i, &er_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &cr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (3 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &xq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &vq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &tq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (3 > i) {
        emlrtDynamicBoundsCheckR2012b(3, 1, i, &rq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &pq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (3 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &lq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
      ...
      for (i = 0; i < loop_ub; i++) {
        if ((r4[i] < 1) || (r4[i] > npages)) {
          emlrtDynamicBoundsCheckR2012b(r4[i], 1, npages, &et_emlrtBCI, &b_st);
        }
        c_I[i] = b_I[r4[i] - 1];
      }
      ...
      for (i = 0; i < loop_ub; i++) {
        if ((r5[i] < 1) || (r5[i] > npages)) {
          emlrtDynamicBoundsCheckR2012b(r5[i], 1, npages, &ft_emlrtBCI, &b_st);
        }
        c_I[i] = b_I[r5[i] - 1];
      }
      c_st.site = &rs_emlrtRSI;
      ...
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &ls_emlrtBCI, &st);
      }
      i = b_board->BoardIdx.size(1);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &ks_emlrtBCI, &st);
      }
      i = b_board->BoardIdx.size(1);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &js_emlrtBCI, &st);
      }
      i = b_board->BoardIdx.size(0);
      if (1 > i) {
      ...
      if (i1 < 0) {
        emlrtDynamicBoundsCheckR2012b(i1, 0, MAX_int32_T, &us_emlrtBCI, &st);
      }
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &ts_emlrtBCI, &st);
      }
      cornerIdx[1] = b_board->BoardIdx[i1 - 1];
      i = b_board->BoardIdx.size(0);
      i1 = b_board->BoardIdx.size(0);
      if (i1 < 0) {
        emlrtDynamicBoundsCheckR2012b(i1, 0, MAX_int32_T, &ws_emlrtBCI, &st);
      }
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &vs_emlrtBCI, &st);
      }
      i = b_board->BoardIdx.size(1);
      ...
      if ((npages < 1) || (npages > i)) {
        emlrtDynamicBoundsCheckR2012b(npages, 1, i, &vs_emlrtBCI, &st);
      }
      cornerIdx[2] =
          b_board
      ...
      if (i1 < 0) {
        emlrtDynamicBoundsCheckR2012b(i1, 0, MAX_int32_T, &ys_emlrtBCI, &st);
      }
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &xs_emlrtBCI, &st);
      }
      ...
      if (::coder::internal::ifWhileCond(&st, y)) {
        ...
        if (i2 != 0) {
          ...
          i = b_board->BoardCoords.size(2);
          if (1 > i) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i, &jq_emlrtBCI, &st);
          }
          loop_ub = b_board->BoardCoords.size(0);
          npages = b_board->BoardCoords.size(1);
    ...
    if (p == t) {
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &ss_emlrtBCI, (emlrtCTX)sp);
      }
      i = b_board->BoardCoords.size(1);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &rs_emlrtBCI, (emlrtCTX)sp);
      }
      ...
      if ((npages < 1) || (npages > i)) {
        emlrtDynamicBoundsCheckR2012b(npages, 1, i, &ps_emlrtBCI, (emlrtCTX)sp);
      }
      i = b_board->BoardCoords.size(1);
      i2 = b_board->BoardCoords.size(1);
      if (i2 < 0) {
        emlrtDynamicBoundsCheckR2012b(i2, 0, MAX_int32_T, &os_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if ((i2 < 1) || (i2 > i)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, i, &ns_emlrtBCI, (emlrtCTX)sp);
      }
      loop_ub = b_board->BoardCoords.size(2);
      ...
      if (d_any(&st, r3)) {
        ...
        if (i1 < 0) {
          emlrtDynamicBoundsCheckR2012b(i1, 0, MAX_int32_T, &bt_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if ((i1 < 1) || (i1 > i)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, i, &at_emlrtBCI, (emlrtCTX)sp);
        }
        i = b_board->BoardCoords.size(1);
        npages = b_board->BoardCoords.size(1);
        if (npages < 0) {
          emlrtDynamicBoundsCheckR2012b(npages, 0, MAX_int32_T, &dt_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if ((npages < 1) || (npages > i)) {
          emlrtDynamicBoundsCheckR2012b(npages, 1, i, &ct_emlrtBCI,
                                        (emlrtCTX)sp);
        }
              ...
              ::coder::array<real_T, 2U> &points, real_T boardSize[2])
{
  ...
  if (b_any(&st, d_this)) {
    ...
    if (!(numPoints >= 0.0)) {
      emlrtNonNegativeCheckR2012b(numPoints, &lg_emlrtDCI, (emlrtCTX)sp);
    }
    ...
    if (numPoints != static_cast<int32_T>(numPoints)) {
      emlrtIntegerCheckR2012b(numPoints, &mg_emlrtDCI, (emlrtCTX)sp);
    }
    ...
    if (1 > i) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i, &kt_emlrtBCI, (emlrtCTX)sp);
    }
    ...
    i = b_this->BoardCoords.size(2);
    if (2 > i) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i, &lt_emlrtBCI, (emlrtCTX)sp);
    }
    c_this = b_this->BoardCoords.size(0);
    loop_ub = b_this->BoardCoords.size(1);
