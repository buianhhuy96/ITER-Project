                ...
                ::coder::array<int32_T, 1U> &ib)
{
  ...
  na = a.size(1);
  c.set_size(&vk_emlrtRTEI, sp, 1, a.size(1));
  ia.set_size(&wk_emlrtRTEI, sp, a.size(1));
  ib.set_size(&xk_emlrtRTEI, sp, 0);
  st.site = &ao_emlrtRSI;
  ...
  if (a.size(1) > 0) {
    ...
    ia.set_size(&bl_emlrtRTEI, sp, na);
  }
  st.site = &go_emlrtRSI;
  b_st.site = &ig_emlrtRSI;
  internal::sort(&b_st, ia, ieb_emlrtRSI);
  st.site = &ho_emlrtRSI;
  ...
  if (a.size(1) > 0) {
    ...
    c.set_size(&cl_emlrtRTEI, sp, c.size(0), nc);
  }
                ...
                ::coder::array<int32_T, 1U> &ib)
{
  ...
  st.site = &bo_emlrtRSI;
  n = b.size(0) + 1;
  bperm.set_size(&yk_emlrtRTEI, &st, b.size(0));
  i = b.size(0);
  for (b_i = 0; b_i < i; b_i++) {
    bperm[b_i] = 0;
  }
  if (b.size(0) != 0) {
    ...
    iwork.set_size(&al_emlrtRTEI, &c_st, b.size(0));
    i = b.size(0) - 1;
  ...
  if (a.size(1) > 0) {
    ...
    ia.set_size(&bl_emlrtRTEI, sp, b_i);
  }
  st.site = &go_emlrtRSI;
  b_st.site = &ig_emlrtRSI;
  internal::sort(&b_st, ia, ieb_emlrtRSI);
