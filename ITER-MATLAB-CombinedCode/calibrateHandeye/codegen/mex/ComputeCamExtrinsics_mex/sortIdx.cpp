                        ...
                        ::coder::array<real32_T, 1U> &xwork)
{
  ...
  if ((preSortLevel < 0) || (preSortLevel > 31)) {
    emlrtDynamicBoundsCheckR2012b(preSortLevel, 0, 31, &nw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
             ...
             ::coder::array<int32_T, 1U> &idx)
{
  ...
  idx.set_size(&xv_emlrtRTEI, sp, static_cast<int32_T>(u));
  ...
  if (x.size(0) != 0) {
    ...
    iwork.set_size(&yv_emlrtRTEI, &b_st, static_cast<int32_T>(u));
    ib = static_cast<int32_T>(u);
    for (quartetOffset = 0; quartetOffset < ib; quartetOffset++) {
    ...
    u = static_cast<uint32_T>(x.size(0));
    xwork.set_size(&aw_emlrtRTEI, &b_st, static_cast<int32_T>(u));
    ib = static_cast<int32_T>(u);
    for (quartetOffset = 0; quartetOffset < ib; quartetOffset++) {
