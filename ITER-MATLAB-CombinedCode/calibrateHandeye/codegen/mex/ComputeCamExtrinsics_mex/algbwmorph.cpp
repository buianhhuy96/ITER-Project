...
void bwmorphApplyOnce(const emlrtStack *sp, ::coder::array<boolean_T, 2U> &bw)
{
  ...
  i = bw.size(0);
  if (i < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(i), &yg_emlrtDCI, &st);
  }
  i1 = bw.size(1);
  if (i1 < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(i1), &yg_emlrtDCI, &st);
  }
  m.set_size(&iv_emlrtRTEI, &st, i, i1);
  ...
  i4 = bw.size(0);
  if (i4 < 0) {
    emlrtDynamicBoundsCheckR2012b(i4, 0, MAX_int32_T, &mw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (1 > bw.size(0)) {
    i4 = 1;
    ...
    i4 = bw.size(0);
    if (1 > i4) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i4, &lw_emlrtBCI, (emlrtCTX)sp);
    }
    i4 = 2;
    i5 = bw.size(0);
    i6 = bw.size(0);
    if ((i6 < 1) || (i6 > i5)) {
      emlrtDynamicBoundsCheckR2012b(i6, 1, i5, &kw_emlrtBCI, (emlrtCTX)sp);
    }
    i5 = i6 - 1;
  }
  i6 = bw.size(1);
  if (i6 < 0) {
    emlrtDynamicBoundsCheckR2012b(i6, 0, MAX_int32_T, &jw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (1 > bw.size(1)) {
    i6 = 1;
    ...
    i6 = bw.size(1);
    if (1 > i6) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i6, &iw_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = 2;
    i7 = bw.size(1);
    i8 = bw.size(1);
    if ((i8 < 1) || (i8 > i7)) {
      emlrtDynamicBoundsCheckR2012b(i8, 1, i7, &hw_emlrtBCI, (emlrtCTX)sp);
    }
    i7 = i8 - 1;
  }
  ...
  if (2 > bw.size(0)) {
    ...
    i6 = bw.size(0);
    if (2 > i6) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i6, &fw_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = 1;
    i7 = 2;
    i8 = bw.size(0);
    i9 = bw.size(0);
    if ((i9 < 1) || (i9 > i8)) {
      emlrtDynamicBoundsCheckR2012b(i9, 1, i8, &ew_emlrtBCI, (emlrtCTX)sp);
    }
    i8 = i9 - 1;
  }
  i9 = bw.size(1);
  if (i9 < 0) {
    emlrtDynamicBoundsCheckR2012b(i9, 0, MAX_int32_T, &dw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > bw.size(1)) {
    i9 = 0;
    ...
    i9 = bw.size(1);
    if (2 > i9) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i9, &cw_emlrtBCI, (emlrtCTX)sp);
    }
    i9 = 1;
    i10 = 2;
    i11 = bw.size(1);
    ...
    if ((b_loop_ub < 1) || (b_loop_ub > i11)) {
      emlrtDynamicBoundsCheckR2012b(b_loop_ub, 1, i11, &bw_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i11 = b_loop_ub - 1;
  }
  ...
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&pv_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (1 > m.size(0)) {
  ...
  i5 = bw.size(0);
  if (i5 < 0) {
    emlrtDynamicBoundsCheckR2012b(i5, 0, MAX_int32_T, &aw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (1 > bw.size(0)) {
    i5 = 1;
    ...
    i5 = bw.size(0);
    if (1 > i5) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i5, &yv_emlrtBCI, (emlrtCTX)sp);
    }
    i5 = 2;
    i6 = bw.size(0);
    i7 = bw.size(0);
    if ((i7 < 1) || (i7 > i6)) {
      emlrtDynamicBoundsCheckR2012b(i7, 1, i6, &xv_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = i7 - 1;
  }
  i7 = bw.size(1);
  if (i7 < 0) {
    emlrtDynamicBoundsCheckR2012b(i7, 0, MAX_int32_T, &wv_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > bw.size(1)) {
    i7 = 0;
    ...
    i7 = bw.size(1);
    if (2 > i7) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i7, &vv_emlrtBCI, (emlrtCTX)sp);
    }
    i7 = 1;
    i8 = 2;
    i9 = bw.size(1);
    i10 = bw.size(1);
    if ((i10 < 1) || (i10 > i9)) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, &uv_emlrtBCI, (emlrtCTX)sp);
    }
    i9 = i10 - 1;
  }
  st.site = &feb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i6, i5);
  r.set_size(&qv_emlrtRTEI, sp, loop_ub + 1);
  for (i6 = 0; i6 <= loop_ub; i6++) {
    r[i6] = i5 * i6;
  }
  st.site = &feb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i9 - i7, i8);
  r1.set_size(&rv_emlrtRTEI, sp, loop_ub + 1);
  for (i5 = 0; i5 <= loop_ub; i5++) {
    r1[i5] = i7 + i8 * i5;
  }
  b_iv[0] = r.size(0);
  ...
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&sv_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (2 > m.size(0)) {
  ...
  i5 = bw.size(0);
  if (i5 < 0) {
    emlrtDynamicBoundsCheckR2012b(i5, 0, MAX_int32_T, &tv_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > bw.size(0)) {
    i5 = 0;
    ...
    i5 = bw.size(0);
    if (2 > i5) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i5, &sv_emlrtBCI, (emlrtCTX)sp);
    }
    i5 = 1;
    i6 = 2;
    i7 = bw.size(0);
    i8 = bw.size(0);
    if ((i8 < 1) || (i8 > i7)) {
      emlrtDynamicBoundsCheckR2012b(i8, 1, i7, &rv_emlrtBCI, (emlrtCTX)sp);
    }
    i7 = i8 - 1;
  }
  i8 = bw.size(1);
  if (i8 < 0) {
    emlrtDynamicBoundsCheckR2012b(i8, 0, MAX_int32_T, &qv_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (1 > bw.size(1)) {
    i8 = 1;
    ...
    i8 = bw.size(1);
    if (1 > i8) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i8, &pv_emlrtBCI, (emlrtCTX)sp);
    }
    i8 = 2;
    i9 = bw.size(1);
    i10 = bw.size(1);
    if ((i10 < 1) || (i10 > i9)) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, &ov_emlrtBCI, (emlrtCTX)sp);
    }
    i9 = i10 - 1;
  }
  st.site = &eeb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i7 - i5, i6);
  r.set_size(&tv_emlrtRTEI, sp, loop_ub + 1);
  for (i7 = 0; i7 <= loop_ub; i7++) {
    r[i7] = i5 + i6 * i7;
  }
  st.site = &eeb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i9, i8);
  r1.set_size(&uv_emlrtRTEI, sp, loop_ub + 1);
  for (i5 = 0; i5 <= loop_ub; i5++) {
    r1[i5] = i8 * i5;
  }
  b_iv[0] = r.size(0);
