...
static void db_emlrt_marshallIn(const emlrtStack *sp, const mxArray *images,
                                const char_T *identifier,
                                coder::array<uint8_T, 4U> &y);
...
static void fb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *valid_idx,
                                const char_T *identifier,
                                ...
                                coder::array<uint8_T, 4U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  eb_emlrt_marshallIn(sp, emlrtAlias(images), &thisId, y);
                                ...
                                coder::array<boolean_T, 1U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  gb_emlrt_marshallIn(sp, emlrtAlias(valid_idx), &thisId, y);
                     ...
                     const mxArray *plhs[3])
{
  ...
  // Marshall function inputs
  As.no_free();
  s_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "As", As);
  Bs.no_free();
  s_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "Bs", Bs);
  // Invoke the target function
...
void preprocessImages_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  ...
  // Marshall function inputs
  images.no_free();
  db_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "images", images);
                        ...
                        const mxArray *plhs[2])
{
  ...
  s_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "robot_poses_vec",
                     robot_poses_vec);
  valid_idx.no_free();
  fb_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "valid_idx", valid_idx);
  // Invoke the target function
