              ...
              ::coder::array<bool, 2U> &b_B)
{
  ...
  int b_rowInd;
  int lookUpInd;
  b_B.set_size(bwin.size(0), bwin.size(1));
  if ((bwin.size(0) != 0) && (bwin.size(1) != 0)) {
    ...
    if (bwin.size(0) >= 2) {
      if (bwin.size(1) >= 2) {
        ...
        b_B[0] = lut[((((static_cast<int>(bwin[0])) * 16) +
...
#pragma omp parallel for num_threads(omp_get_max_threads()) private(           \
    lookUpInd, b_i, b_rowInd)
            ...
            lookUpInd =
                (((((((((static_cast<int>(
                 ...
                 ((static_cast<int>(
                  ...
                  256)) +
                1;
            b_B[(b_rowInd + (b_B.size(0) * (b_colInd + 1))) + 1] =
                lut[lookUpInd - 1];
          }
        }
        ...
        for (colInd = 0; colInd <= (ub_loop - 3); colInd++) {
          ...
          b_B[((static_cast<int>(inDims[0])) + (b_B.size(0) * (colInd + 1))) -
              1] =
        ...
        b_B[b_B.size(0) * ((static_cast<int>(inDims[1])) - 1)] = lut
            [((((static_cast<int>(
        ...
        for (rowInd = 0; rowInd <= (ub_loop - 3); rowInd++) {
          b_B[(rowInd + (b_B.size(0) * colInd)) + 1] = lut
              [(((((static_cast<int>(
        ...
        b_B[((static_cast<int>(inDims[0])) +
             (b_B.size(0) * ((static_cast<int>(inDims[1])) - 1))) -
            1] = lut
            [(((static_cast<int>(
    ...
    if (guard1) {
      ...
      if (bwin.size(0) > 1) {
        ...
        ub_loop = bwin.size(0);
        for (rowInd = 0; rowInd <= (ub_loop - 3); rowInd++) {
          b_B[rowInd + 1] = lut[(((static_cast<int>(bwin[rowInd])) * 8) +
                                 ((static_cast<int>(bwin[rowInd + 1])) * 16)) +
                                ((static_cast<int>(bwin[rowInd + 2])) * 32)];
        }
        b_B[bwin.size(0) - 1] =
