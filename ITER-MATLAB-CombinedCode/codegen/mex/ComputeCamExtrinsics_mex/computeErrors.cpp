                   ...
                   real_T errors[3])
{
  ...
  r.set_size(&rr_emlrtRTEI, &b_st, result,
  ...
  angR.set_size(&sr_emlrtRTEI, sp, imgPts.size(2));
  loop_ub = imgPts.size(2);
  for (i = 0; i < loop_ub; i++) {
    angR[i] = 0.0;
  }
  PoseErrR.set_size(&tr_emlrtRTEI, sp, 3, 3, imgPts.size(2));
  ...
  for (j = 0; j < i; j++) {
    ...
    if (j + 1 > Hcam2grid.size(2)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, Hcam2grid.size(2), &ut_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (j + 1 > Hhand2base.size(2)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, Hhand2base.size(2), &vt_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    for (i1 = 0; i1 < 3; i1++) {
      alpha1 = Hhand2eye[i1];
    ...
    if (j + 1 > PoseErrR.size(2)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, PoseErrR.size(2), &tt_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    for (i1 = 0; i1 < 3; i1++) {
      alpha1 = a[i1];
    ...
    if (j + 1 > angR.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, angR.size(0), &fu_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  r1.set_size(&cs_emlrtRTEI, &b_st, angR.size(0));
  loop_ub = angR.size(0);
  for (i = 0; i < loop_ub; i++) {
    alpha1 = angR[i];
    r1[i] = alpha1 * alpha1;
  ...
  PoseErrt.set_size(&ur_emlrtRTEI, sp, imgPts.size(2), 3);
  i = imgPts.size(2);
  for (j = 0; j < i; j++) {
    covrtLogFor(&emlrtCoverageInstance, 2, 0, 2, 1);
    covrtLogBasicBlock(&emlrtCoverageInstance, 2, 6);
    if (j + 1 > Hhand2base.size(2)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, Hhand2base.size(2), &xt_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (j + 1 > Hcam2grid.size(2)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, Hcam2grid.size(2), &au_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    if (j + 1 > PoseErrt.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, PoseErrt.size(0), &bu_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  PoseErrt.set_size(&vr_emlrtRTEI, sp, PoseErrt.size(0), 3);
  for (i = 0; i < loop_ub; i++) {
    alpha1 = PoseErrt[i];
  ...
  err.set_size(&wr_emlrtRTEI, sp, imgPts.size(0), imgPts.size(2));
  ...
  for (j = 0; j < i; j++) {
    ...
    if (j + 1 > imgPts.size(2)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, imgPts.size(2), &du_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    if ((r.size(0) == 0) || (r.size(1) == 0)) {
      y.set_size(&dh_emlrtRTEI, &b_st, 4, r.size(0));
      loop_ub = r.size(0) << 2;
      ...
      ldc_t = (ptrdiff_t)4;
      y.set_size(&ch_emlrtRTEI, &d_st, 4, r.size(0));
    ...
    b_st.site = &ui_emlrtRSI;
    if (y.size(1) == 0) {
      b_y.set_size(&dh_emlrtRTEI, &b_st, 3, 0);
    } else {
      c_st.site = &wi_emlrtRSI;
      d_st.site = &xi_emlrtRSI;
      TRANSB1 = 'N';
      ...
      ldb_t = (ptrdiff_t)4;
      ldc_t = (ptrdiff_t)3;
      b_y.set_size(&ch_emlrtRTEI, &d_st, 3, y.size(1));
    ...
    loop_ub = b_y.size(1);
    c_y.set_size(&xr_emlrtRTEI, &c_st, 1, b_y.size(1));
    for (i1 = 0; i1 < loop_ub; i1++) {
      c_y[i1] = b_y[3 * i1 + 2];
    }
    d_st.site = &sbb_emlrtRSI;
    coder::bsxfun(&d_st, b_y, c_y, x);
    covrtLogFcn(&emlrtCoverageInstance, 2, 1);
    covrtLogBasicBlock(&emlrtCoverageInstance, 2, 1);
    loop_ub = x.size(1);
    proj.set_size(&yr_emlrtRTEI, sp, x.size(1), 2);
    for (i1 = 0; i1 < 2; i1++) {
    ...
    loop_ub = err.size(0);
    r2.set_size(&as_emlrtRTEI, sp, err.size(0));
    for (i1 = 0; i1 < loop_ub; i1++) {
      r2[i1] = i1;
    }
    if (j + 1 > err.size(1)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, err.size(1), &eu_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    loop_ub = imgPts.size(0);
    if (imgPts.size(0) == proj.size(0)) {
      proj.set_size(&vr_emlrtRTEI, sp, imgPts.size(0), 2);
      for (i1 = 0; i1 < 2; i1++) {
        for (i2 = 0; i2 < loop_ub; i2++) {
