...
{
  array<int32_T, 2U> aperm;
  array<int32_T, 2U> bperm;
  array<int32_T, 1U> feb_emlrtRSI;
  emlrtStack b_st;
  emlrtStack st;
  int32_T b_ialast;
  int32_T exponent;
  ...
  na = a.size(1);
  c.set_size(&qk_emlrtRTEI, sp, 1, a.size(1));
  ia.set_size(&rk_emlrtRTEI, sp, a.size(1));
  ib.set_size(&sk_emlrtRTEI, sp, 0);
  st.site = &co_emlrtRSI;
  ...
  if (a.size(1) > 0) {
    ...
    ia.set_size(&vk_emlrtRTEI, sp, na);
  }
  st.site = &io_emlrtRSI;
  b_st.site = &kg_emlrtRSI;
  internal::sort(&b_st, ia, feb_emlrtRSI);
  st.site = &jo_emlrtRSI;
  ...
  if (a.size(1) > 0) {
    ...
    c.set_size(&wk_emlrtRTEI, sp, c.size(0), nc);
  }
                ...
                ::coder::array<int32_T, 1U> &ib)
{
  ...
  st.site = &do_emlrtRSI;
  n = b.size(0) + 1;
  bperm.set_size(&tk_emlrtRTEI, &st, b.size(0));
  i = b.size(0);
  for (b_i = 0; b_i < i; b_i++) {
    bperm[b_i] = 0;
  }
  if (b.size(0) != 0) {
    ...
    iwork.set_size(&uk_emlrtRTEI, &c_st, b.size(0));
    i = b.size(0) - 1;
  ...
  if (a.size(1) > 0) {
    ...
    ia.set_size(&vk_emlrtRTEI, sp, b_i);
  }
  st.site = &io_emlrtRSI;
  b_st.site = &kg_emlrtRSI;
  internal::sort(&b_st, ia, feb_emlrtRSI);
