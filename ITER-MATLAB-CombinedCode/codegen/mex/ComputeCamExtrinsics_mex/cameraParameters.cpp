    ...
    const ::coder::array<boolean_T, 2U> &varargin_1_DetectedKeypoints)
{
  ...
  this_->RotationVectors.set_size(&qc_emlrtRTEI, &st,
  ...
  c_this.set_size(&iu_emlrtRTEI, &st, this_->RotationVectors.size(0), 3);
  ...
  this_->TranslationVectors.set_size(&rc_emlrtRTEI, &st,
  ...
  c_this.set_size(&ju_emlrtRTEI, &st, this_->TranslationVectors.size(0), 3);
  loop_ub =
  ...
  this_->WorldPoints.set_size(&sc_emlrtRTEI, &st,
  ...
  this_->DetectedKeypoints.set_size(&tc_emlrtRTEI, &st,
  ...
  if ((varargin_1_ReprojectionErrors.size(0) == 0) ||
    ...
    this_->ReprojectionErrors.set_size(&vc_emlrtRTEI, &st, 0, 2, 1);
  } else {
    this_->ReprojectionErrors.set_size(&uc_emlrtRTEI, &st,
  ...
  if ((!b) && (!b1) &&
    ...
    emlrtErrorWithMessageIdR2018a(
        sp, &d_emlrtRTEI, "vision:calibrate:reprojectionErrorsSizeMismatch",
  ...
  this_->UndistortMap.SizeOfImage.set_size(&ku_emlrtRTEI, &st, 1, 2);
  this_->UndistortMap.SizeOfImage[0] = 0.0;
  this_->UndistortMap.SizeOfImage[1] = 0.0;
  this_->UndistortMap.SizeOfImage.set_size(&lu_emlrtRTEI, &st, 1, 3);
  this_->UndistortMap.SizeOfImage[0] = 0.0;
  this_->UndistortMap.SizeOfImage[1] = 0.0;
  this_->UndistortMap.SizeOfImage[2] = 0.0;
  this_->UndistortMap.ClassOfImage.set_size(&mu_emlrtRTEI, &st, 1, 1);
  this_->UndistortMap.ClassOfImage[0] = 'a';
  this_->UndistortMap.ClassOfImage.set_size(&nu_emlrtRTEI, &st, 1, 5);
  for (i = 0; i < 5; i++) {
    this_->UndistortMap.ClassOfImage[i] = b_cv[i];
  }
  this_->UndistortMap.OutputView.set_size(&ou_emlrtRTEI, &st, 1, 1);
  this_->UndistortMap.OutputView[0] = 'a';
  this_->UndistortMap.OutputView.set_size(&pu_emlrtRTEI, &st, 1, 4);
  ...
  this_->UndistortMap.XmapSingle.set_size(&qu_emlrtRTEI, &st, 2, 2);
  ...
  this_->UndistortMap.YmapSingle.set_size(&ru_emlrtRTEI, &st, 2, 2);
