                   ...
                   ::coder::array<real_T, 2U> &distortedPoints)
{
  ...
  centeredPoints.set_size(&xf_emlrtRTEI, &st, points.size(0), 2);
  if (points.size(0) != 0) {
  ...
  yNorm.set_size(&ft_emlrtRTEI, sp, centeredPoints.size(0));
  for (b = 0; b < acoef; b++) {
    yNorm[b] = centeredPoints[b + centeredPoints.size(0)] / intrinsicMatrix[4];
  }
  acoef = centeredPoints.size(0);
  xNorm.set_size(&gt_emlrtRTEI, sp, centeredPoints.size(0));
  for (b = 0; b < acoef; b++) {
  ...
  r4.set_size(&ht_emlrtRTEI, sp, r2.size(0));
  acoef = r2.size(0);
  for (b = 0; b < acoef; b++) {
    r4[b] = r2[b] * r2[b];
  }
  ...
  alpha.set_size(&it_emlrtRTEI, sp, r2.size(0));
  acoef = r2.size(0);
  for (b = 0; b < acoef; b++) {
    alpha[b] = k_idx_0 * r2[b];
  }
  dxTangential.set_size(&jt_emlrtRTEI, sp, r4.size(0));
  acoef = r4.size(0);
  for (b = 0; b < acoef; b++) {
  ...
  r4.set_size(&kt_emlrtRTEI, sp, r2.size(0));
  acoef = r2.size(0);
  for (b = 0; b < acoef; b++) {
  ...
  xyProduct.set_size(&lt_emlrtRTEI, sp, xNorm.size(0));
  acoef = xNorm.size(0);
  for (b = 0; b < acoef; b++) {
  ...
  dxTangential.set_size(&mt_emlrtRTEI, sp, xyProduct.size(0));
  acoef = xyProduct.size(0);
  for (b = 0; b < acoef; b++) {
    dxTangential[b] = k_idx_0 * xyProduct[b];
  }
  r4.set_size(&nt_emlrtRTEI, sp, r2.size(0));
  acoef = r2.size(0);
  for (b = 0; b < acoef; b++) {
  ...
  centeredPoints.set_size(&ot_emlrtRTEI, &b_st, xNorm.size(0), 2);
  acoef = xNorm.size(0);
  for (b = 0; b < acoef; b++) {
  ...
  b_st.site = &wo_emlrtRSI;
  r.set_size(&pt_emlrtRTEI, &b_st, alpha.size(0), 2);
  acoef = alpha.size(0);
  for (b = 0; b < acoef; b++) {
    r[b] = alpha[b];
  }
  ...
  r.set_size(&qt_emlrtRTEI, sp, centeredPoints.size(0), 2);
  for (b = 0; b < acoef; b++) {
  ...
  r1.set_size(&rt_emlrtRTEI, &b_st, dxTangential.size(0), 2);
  acoef = dxTangential.size(0);
  for (b = 0; b < acoef; b++) {
    r1[b] = dxTangential[b];
  }
  ...
  emlrtSizeEqCheckNDR2012b(&b_iv[0], &iv1[0], &sd_emlrtECI, (emlrtCTX)sp);
  acoef = centeredPoints.size(0) * 2;
  centeredPoints.set_size(&st_emlrtRTEI, sp, centeredPoints.size(0), 2);
  for (b = 0; b < acoef; b++) {
    centeredPoints[b] = (centeredPoints[b] + r[b]) + r1[b];
  }
  acoef = centeredPoints.size(0);
  xyProduct.set_size(&tt_emlrtRTEI, sp, centeredPoints.size(0));
  for (b = 0; b < acoef; b++) {
    xyProduct[b] = centeredPoints[b] * intrinsicMatrix[0];
  }
  acoef = centeredPoints.size(0);
  dxTangential.set_size(&ut_emlrtRTEI, sp, centeredPoints.size(0));
  for (b = 0; b < acoef; b++) {
    dxTangential[b] =
  ...
  acoef = centeredPoints.size(0);
  r4.set_size(&vt_emlrtRTEI, sp, centeredPoints.size(0));
  for (b = 0; b < acoef; b++) {
  ...
  distortedPoints.set_size(&wt_emlrtRTEI, &b_st, xyProduct.size(0), 2);
  acoef = xyProduct.size(0);
  for (b = 0; b < acoef; b++) {
