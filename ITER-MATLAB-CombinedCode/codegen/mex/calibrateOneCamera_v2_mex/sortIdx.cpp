                        ...
                        ::coder::array<real32_T, 1U> &xwork)
{
  ...
  if ((preSortLevel < 0) || (preSortLevel > 31)) {
    emlrtDynamicBoundsCheckR2012b(preSortLevel, 0, 31, &fy_emlrtBCI,
                                  (emlrtCTX)sp);
  }
             ...
             ::coder::array<int32_T, 1U> &idx)
{
  ...
  idx.set_size(&ry_emlrtRTEI, sp, static_cast<int32_T>(u));
  ...
  if (x.size(0) != 0) {
    ...
    iwork.set_size(&sy_emlrtRTEI, &b_st, static_cast<int32_T>(u));
    ib = static_cast<int32_T>(u);
    for (quartetOffset = 0; quartetOffset < ib; quartetOffset++) {
    ...
    u = static_cast<uint32_T>(x.size(0));
    xwork.set_size(&ty_emlrtRTEI, &b_st, static_cast<int32_T>(u));
    ib = static_cast<int32_T>(u);
    for (quartetOffset = 0; quartetOffset < ib; quartetOffset++) {
             ...
             ::coder::array<int32_T, 2U> &idx)
{
  ...
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  n = x.size(1) + 1;
  idx.set_size(&hl_emlrtRTEI, sp, 1, x.size(1));
  i = x.size(1);
  for (b_i = 0; b_i < i; b_i++) {
    idx[b_i] = 0;
  }
  if (x.size(1) != 0) {
    ...
    iwork.set_size(&el_emlrtRTEI, &b_st, x.size(1));
    i = x.size(1) - 1;
