...
static emlrtDCInfo kh_emlrtDCI{
    30,                     // lineNo
    16,                     // colNo
    "subPixelLocationImpl", // fName
    "C:\\Program "
...
static emlrtDCInfo lh_emlrtDCI{
    30,                     // lineNo
    37,                     // colNo
    "subPixelLocationImpl", // fName
    "C:\\Program "
...
static emlrtDCInfo mh_emlrtDCI{
    31,                     // lineNo
    16,                     // colNo
    "subPixelLocationImpl", // fName
    "C:\\Program "
...
static emlrtDCInfo nh_emlrtDCI{
    31,                     // lineNo
    37,                     // colNo
    "subPixelLocationImpl", // fName
    "C:\\Program "
                      ...
                      ::coder::array<real_T, 2U> &loc)
{
  ...
  for (int32_T id{0}; id < i; id++) {
    ...
    i1 = loc.size(0);
    if ((id + 1 < 1) || (id + 1 > i1)) {
      emlrtDynamicBoundsCheckR2012b(id + 1, 1, i1, &hy_emlrtBCI, (emlrtCTX)sp);
    }
    loop_ub = loc.size(1);
    r.set_size(&xy_emlrtRTEI, sp, loop_ub);
    ...
    loop_ub = loc.size(1);
    b_loc.set_size(&yy_emlrtRTEI, &st, 1, loop_ub);
    for (i1 = 0; i1 < loop_ub; i1++) {
      b_loc[i1] = loc[id + loc.size(0) * i1];
    }
    loop_ub = loc.size(1);
    c_loc.set_size(&aab_emlrtRTEI, &st, loop_ub);
    for (i1 = 0; i1 < loop_ub; i1++) {
    ...
    if (b_any(&b_st, c_loc)) {
      ...
      i1 = loc.size(1);
      if (1 > i1) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i1, &iy_emlrtBCI, &st);
      }
      if (loc[id] > (static_cast<real_T>(metric.size(1)) - 2.0) - 1.0) {
        ...
        i1 = loc.size(1);
        if (2 > i1) {
          emlrtDynamicBoundsCheckR2012b(2, 1, i1, &jy_emlrtBCI, &st);
        }
        if (loc[id + loc.size(0)] >
          ...
          i1 = loc.size(1);
          if (2 > i1) {
            emlrtDynamicBoundsCheckR2012b(2, 1, i1, &ky_emlrtBCI, &st);
          }
          i1 = loc.size(1);
          if (2 > i1) {
            emlrtDynamicBoundsCheckR2012b(2, 1, i1, &ly_emlrtBCI, &st);
          }
          if (loc[id + loc.size(0)] - 2.0 > loc[id + loc.size(0)] + 2.0) {
            ...
            if (d != static_cast<int32_T>(muDoubleScalarFloor(d))) {
              emlrtIntegerCheckR2012b(d, &kh_emlrtDCI, &st);
            }
            if ((static_cast<int32_T>(d) < 1) ||
                (static_cast<int32_T>(d) > metric.size(0))) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(d), 1,
                                            metric.size(0), &my_emlrtBCI, &st);
            }
            i1 = static_cast<int32_T>(d) - 2;
            d = loc[id + loc.size(0)] + 2.0;
            if (d != static_cast<int32_T>(muDoubleScalarFloor(d))) {
              emlrtIntegerCheckR2012b(d, &lh_emlrtDCI, &st);
            }
            if ((static_cast<int32_T>(d) < 1) ||
                (static_cast<int32_T>(d) > metric.size(0))) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(d), 1,
                                            metric.size(0), &ny_emlrtBCI, &st);
            }
            i2 = static_cast<int32_T>(d) - 1;
          }
          i3 = loc.size(1);
          if (1 > i3) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i3, &oy_emlrtBCI, &st);
          }
          i3 = loc.size(1);
          if (1 > i3) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i3, &py_emlrtBCI, &st);
          }
          if (loc[id] - 2.0 > loc[id] + 2.0) {
            ...
            d = loc[id] - 2.0;
            if (d != static_cast<int32_T>(muDoubleScalarFloor(d))) {
              emlrtIntegerCheckR2012b(d, &mh_emlrtDCI, &st);
            }
            if ((static_cast<int32_T>(d) < 1) ||
                (static_cast<int32_T>(d) > metric.size(1))) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(d), 1,
                                            metric.size(1), &qy_emlrtBCI, &st);
            }
            i3 = static_cast<int32_T>(d) - 2;
            d = loc[id] + 2.0;
            if (d != static_cast<int32_T>(muDoubleScalarFloor(d))) {
              emlrtIntegerCheckR2012b(d, &nh_emlrtDCI, &st);
            }
            if ((static_cast<int32_T>(d) < 1) ||
                (static_cast<int32_T>(d) > metric.size(1))) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(d), 1,
                                            metric.size(1), &ry_emlrtBCI, &st);
            }
          ...
          b_metric.set_size(&bab_emlrtRTEI, &b_st, loop_ub, b_loop_ub);
          ...
          loop_ub = loc.size(1);
          d_loc.set_size(&yy_emlrtRTEI, &st, 1, loop_ub);
          for (i1 = 0; i1 < loop_ub; i1++) {
          ...
          emlrtSizeEqCheckNDR2012b(&iv1[0], &b_iv[0], &ne_emlrtECI, &st);
          subPixelLoc.set_size(&cab_emlrtRTEI, &st, 1, 2);
    ...
    if (guard1) {
      subPixelLoc.set_size(&dab_emlrtRTEI, &st, 1, b_loc.size(1));
      loop_ub = b_loc.size(1);
      for (i1 = 0; i1 < loop_ub; i1++) {
        subPixelLoc[i1] = static_cast<real32_T>(b_loc[i1]);
      }
    }
    b_loc.set_size(&eab_emlrtRTEI, sp, 1, subPixelLoc.size(1));
    ...
    b_iv[0] = 1;
    b_iv[1] = r.size(0);
    emlrtSubAssignSizeCheckR2012b(&b_iv[0], 2, b_loc.size(), 2, &me_emlrtECI,
                                  (emlrtCTX)sp);
    loop_ub = b_loc.size(1);
    for (i1 = 0; i1 < loop_ub; i1++) {
