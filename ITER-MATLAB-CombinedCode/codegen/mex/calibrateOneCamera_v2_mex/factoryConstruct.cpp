                      ...
                      d_struct_T *obj)
{
  ...
  obj->f_1 = 0.0;
  if (mCeq < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(mCeq), &vg_emlrtDCI,
                                (emlrtCTX)sp);
  }
  obj->cEq_1.set_size(&dv_emlrtRTEI, sp, mCeq);
  obj->f_2 = 0.0;
  obj->cEq_2.set_size(&dv_emlrtRTEI, sp, mCeq);
  obj->nVar = nVar;
  obj->mIneq = 0;
  obj->mEq = mCeq;
  obj->numEvals = 0;
  ...
  if (nVar < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(nVar), &vg_emlrtDCI,
                                (emlrtCTX)sp);
  }
  obj->hasLB.set_size(&dv_emlrtRTEI, sp, nVar);
  obj->hasUB.set_size(&dv_emlrtRTEI, sp, nVar);
