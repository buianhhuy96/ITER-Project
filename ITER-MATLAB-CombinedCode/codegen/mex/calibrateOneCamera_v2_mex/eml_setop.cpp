                ...
                ::coder::array<int32_T, 1U> &ib)
{
  ...
  na = a.size(1);
  c.set_size(&al_emlrtRTEI, sp, 1, a.size(1));
  ia.set_size(&bl_emlrtRTEI, sp, a.size(1));
  ib.set_size(&cl_emlrtRTEI, sp, 0);
  st.site = &yn_emlrtRSI;
  ...
  if (a.size(1) > 0) {
    ...
    ia.set_size(&fl_emlrtRTEI, sp, na);
  }
  st.site = &fo_emlrtRSI;
  b_st.site = &gg_emlrtRSI;
  internal::sort(&b_st, ia, kjb_emlrtRSI);
  st.site = &go_emlrtRSI;
  ...
  if (a.size(1) > 0) {
    ...
    c.set_size(&gl_emlrtRTEI, sp, c.size(0), nc);
  }
                ...
                ::coder::array<int32_T, 1U> &ib)
{
  ...
  st.site = &ao_emlrtRSI;
  n = b.size(0) + 1;
  bperm.set_size(&dl_emlrtRTEI, &st, b.size(0));
  i = b.size(0);
  for (b_i = 0; b_i < i; b_i++) {
    bperm[b_i] = 0;
  }
  if (b.size(0) != 0) {
    ...
    iwork.set_size(&el_emlrtRTEI, &c_st, b.size(0));
    i = b.size(0) - 1;
  ...
  if (a.size(1) > 0) {
    ...
    ia.set_size(&fl_emlrtRTEI, sp, b_i);
  }
  st.site = &fo_emlrtRSI;
  b_st.site = &gg_emlrtRSI;
  internal::sort(&b_st, ia, kjb_emlrtRSI);
