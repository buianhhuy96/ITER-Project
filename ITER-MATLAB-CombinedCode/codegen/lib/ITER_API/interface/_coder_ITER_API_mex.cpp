                 ...
                 const mxArray *prhs[])
{
  ...
  try {
    ...
    case 0:
      unsafe_calibrateOneCamera_v2_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
      break;
    case 1:
...
//
// File trailer for _coder_ITER_API_mex.cpp
//
// [EOF]
//
