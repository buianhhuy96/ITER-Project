           ...
           ::coder::array<double, 1U> &s, double V[6][6])
{
  ...
  for (int i4{0}; i4 < c_loop_ub; i4++) {
    ...
    for (int i5{0}; i5 < d_loop_ub; i5++) {
      U[i5 + (U.size(0) * i4)] = 0.0;
    }
  }
  (void)std::memset(&V[0][0], 0, 36U * (sizeof(double)));
  if (A.size(0) == 0) {
    ...
    for (int q{0}; q < i7; q++) {
      ...
      if ((q + 1) <= nct) {
        for (int e_ii{q + 1}; e_ii <= h_n; e_ii++) {
          U[(e_ii + (U.size(0) * q)) - 1] = e_A[(e_ii + (e_A.size(0) * q)) - 1];
        }
      }
      if ((q + 1) <= nrt) {
    ...
    if ((nct + 1) <= A.size(0)) {
      for (int c_jj{nctp1}; c_jj <= h_n; c_jj++) {
        for (int f_ii{0}; f_ii < h_n; f_ii++) {
          U[f_ii + (U.size(0) * (c_jj - 1))] = 0.0;
        }
        U[(c_jj + (U.size(0) * (c_jj - 1))) - 1] = 1.0;
      }
    }
    for (int b_q{nct}; b_q >= 1; b_q--) {
      ...
      if (s[b_q - 1] != 0.0) {
        for (int d_jj{qp1}; d_jj <= h_n; d_jj++) {
          ...
          b_t = -(b_t / U[qq]);
          blas::xaxpy(nmq_tmp + 1, b_t, qq + 1, U, qjj);
        }
        for (int m_ii{b_q}; m_ii <= h_n; m_ii++) {
          U[(m_ii + (U.size(0) * (b_q - 1))) - 1] =
              -U[(m_ii + (U.size(0) * (b_q - 1))) - 1];
        }
        U[qq] = U[qq] + 1.0;
        for (int p_ii{0}; p_ii <= (b_q - 2); p_ii++) {
          U[p_ii + (U.size(0) * (b_q - 1))] = 0.0;
        }
      } else {
        for (int k_ii{0}; k_ii < h_n; k_ii++) {
          U[k_ii + (U.size(0) * (b_q - 1))] = 0.0;
        }
        U[qq] = 1.0;
      }
    }
    for (int c_q{5}; c_q >= 0; c_q--) {
      if (((c_q + 1) <= nrt) && (e[c_q] != 0.0)) {
        ...
        for (int e_jj{qp1}; e_jj < 7; e_jj++) {
          ...
          blas::b_xaxpy(
              5 - c_q,
              -(blas::xdotc(5 - c_q, V, qp1q, V, qp1jj) / (&V[0][0])[qp1q - 1]),
              qp1q, V, qp1jj);
        }
      }
    ...
    for (int d_q{0}; d_q <= m; d_q++) {
      ...
      if ((d_q + 1) < (m + 1)) {
        ...
        if (b_d1 != 0.0) {
          ...
          c_ix0 = 6 * (d_q + 1);
          i12 = c_ix0 + 6;
          for (int k_k{c_ix0 + 1}; k_k <= i12; k_k++) {
            (&V[0][0])[k_k - 1] *= r;
          }
        }
      }
    ...
    while (((m + 1) > 0) && (iter < 75)) {
      ...
      case 1: {
        ...
        for (int p_k{m}; p_k >= (e_q + 1); p_k--) {
          ...
          blas::xrot(V, (6 * (p_k - 1)) + 1, (6 * m) + 1, b_cs, sn);
        }
      } break;
      case 2: {
        f = e[e_q - 1];
        ...
        for (int q_k{e_q + 1}; q_k <= (m + 1); q_k++) {
          ...
          if (h_n >= 1) {
            ...
            for (int s_k{0}; s_k < h_n; s_k++) {
              ...
              temp_tmp = b_iy + s_k;
              b_temp_tmp = b_ix + s_k;
              temp = (c_cs * U[b_temp_tmp]) + (b_sn * U[temp_tmp]);
              U[temp_tmp] = (c_cs * U[temp_tmp]) - (b_sn * U[b_temp_tmp]);
              U[b_temp_tmp] = temp;
            }
          }
        }
      ...
      case 3: {
        ...
        for (int u_k{e_q + 1}; u_k <= m; u_k++) {
          ...
          a__3 = c_sn * s[u_k];
          s[u_k] = s[u_k] * d_cs;
          blas::xrot(V, (6 * (u_k - 1)) + 1, (6 * u_k) + 1, d_cs, c_sn);
          ...
          if ((u_k < h_n) && (h_n >= 1)) {
            ...
            for (int v_k{0}; v_k < h_n; v_k++) {
              ...
              d_temp_tmp = d_iy + v_k;
              e_temp_tmp = d_ix + v_k;
              c_temp = (e_cs * U[e_temp_tmp]) + (d_sn * U[d_temp_tmp]);
              U[d_temp_tmp] = (e_cs * U[d_temp_tmp]) - (d_sn * U[e_temp_tmp]);
              U[e_temp_tmp] = c_temp;
            }
          }
        }
      ...
      default: {
        ...
        while ((!exitg2) && ((e_q + 1) < (mm + 1))) {
          if (s[e_q] < s[qp1]) {
            ...
            s[qp1] = rt;
            if ((e_q + 1) < 6) {
              blas::xswap(V, (6 * e_q) + 1, (6 * (e_q + 1)) + 1);
            }
            if ((e_q + 1) < h_n) {
              int c_ix;
              int c_iy;
  ...
  for (int b_q{1}; b_q >= 0; b_q--) {
    ...
    if (s[b_q] != 0.0) {
      for (int c_jj{qp1}; c_jj < 4; c_jj++) {
        ...
        blas::c_xaxpy(
            3 - b_q,
            -(blas::b_xdotc(3 - b_q, U, qq + 1, U, qjj) / (&U[0][0])[qq]),
            qq + 1, U, qjj);
      }
  ...
  while (((m + 2) > 0) && (iter < 75)) {
    ...
    case 1: {
      ...
      for (int i_k{i4}; i_k >= (e_q + 1); i_k--) {
        ...
        blas::b_xrot(V, (3 * (i_k - 1)) + 1, (3 * (m + 1)) + 1, b_cs, sn);
      }
    } break;
    case 2: {
      f = e[e_q - 1];
      ...
      for (int g_k{e_q + 1}; g_k <= (m + 2); g_k++) {
        ...
        f = (-b_sn) * f_tmp;
        e[g_k - 1] = f_tmp * c_cs;
        blas::b_xrot(U, (3 * (g_k - 1)) + 1, (3 * (e_q - 1)) + 1, c_cs, b_sn);
      }
    } break;
    case 3: {
      double b;
      ...
      for (int k_k{e_q + 1}; k_k <= mm1; k_k++) {
        ...
        a__3 = c_sn * s[k_k];
        s[k_k] *= d_cs;
        blas::b_xrot(V, (3 * (k_k - 1)) + 1, (3 * k_k) + 1, d_cs, c_sn);
        ...
        g = d_sn * e[k_k];
        e[k_k] *= e_cs;
        blas::b_xrot(U, (3 * (k_k - 1)) + 1, (3 * k_k) + 1, e_cs, d_sn);
      }
      e[m] = f;
      iter++;
    } break;
    default: {
      ...
      while (((e_q + 1) < 3) && (s[e_q] < s[qp1])) {
        ...
        s[e_q] = s[qp1];
        s[qp1] = rt;
        blas::b_xswap(V, (3 * e_q) + 1, (3 * (e_q + 1)) + 1);
        blas::b_xswap(U, (3 * e_q) + 1, (3 * (e_q + 1)) + 1);
        e_q = qp1;
        qp1++;
      }
      iter = 0;
  ...
  for (int b_q{7}; b_q >= 0; b_q--) {
    ...
    if (s[b_q] != 0.0) {
      for (int c_jj{qp1}; c_jj < 10; c_jj++) {
        ...
        blas::d_xaxpy(
            9 - b_q,
            -(blas::c_xdotc(9 - b_q, U, qq + 1, U, qjj) / (&U[0][0])[qq]),
            qq + 1, U, qjj);
      }
  ...
  for (int c_q{8}; c_q >= 0; c_q--) {
    if (((c_q + 1) <= 7) && (e[c_q] != 0.0)) {
      ...
      for (int d_jj{qp1}; d_jj < 10; d_jj++) {
        ...
        blas::d_xaxpy(
            8 - c_q,
            -(blas::c_xdotc(8 - c_q, V, qp1q, V, qp1jj) / (&V[0][0])[qp1q - 1]),
            qp1q, V, qp1jj);
      }
    }
  ...
  while (((m + 2) > 0) && (iter < 75)) {
    ...
    case 1: {
      ...
      for (int i_k{i5}; i_k >= (e_q + 1); i_k--) {
        ...
        blas::c_xrot(V, (9 * (i_k - 1)) + 1, (9 * (m + 1)) + 1, b_cs, sn);
      }
    } break;
    case 2: {
      f = e[e_q - 1];
      ...
      for (int g_k{e_q + 1}; g_k <= (m + 2); g_k++) {
        ...
        f = (-b_sn) * f_tmp;
        e[g_k - 1] = f_tmp * c_cs;
        blas::c_xrot(U, (9 * (g_k - 1)) + 1, (9 * (e_q - 1)) + 1, c_cs, b_sn);
      }
    } break;
    case 3: {
      double b;
      ...
      for (int k_k{e_q + 1}; k_k <= mm1; k_k++) {
        ...
        a__3 = c_sn * s[k_k];
        s[k_k] *= d_cs;
        blas::c_xrot(V, (9 * (k_k - 1)) + 1, (9 * k_k) + 1, d_cs, c_sn);
        ...
        g = d_sn * e[k_k];
        e[k_k] *= e_cs;
        blas::c_xrot(U, (9 * (k_k - 1)) + 1, (9 * k_k) + 1, e_cs, d_sn);
      }
      e[m] = f;
      iter++;
    } break;
    default: {
      ...
      while (((e_q + 1) < 9) && (s[e_q] < s[qp1])) {
        ...
        s[e_q] = s[qp1];
        s[qp1] = rt;
        blas::c_xswap(V, (9 * e_q) + 1, (9 * (e_q + 1)) + 1);
        blas::c_xswap(U, (9 * e_q) + 1, (9 * (e_q + 1)) + 1);
        e_q = qp1;
        qp1++;
      }
      iter = 0;
