...
// File: _coder_calibrateHandeye_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "calibrateHandeye",                                   // fFunctionName
...
static real_T (*bb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *K,
...
static real_T (*db_emlrt_marshallIn(const emlrtStack *sp, const mxArray *As,
...
static const mxArray *f_emlrt_marshallOut(const real_T u[4][4]);

static void fb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *images,
                                const char_T *identifier,
                                coder::array<uint8_T, 4U> &y);
...
static const mxArray *g_emlrt_marshallOut(const coder::array<uint8_T, 4U> &u);
...
static void hb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *valid_idx,
                                const char_T *identifier,
...
static char_T qb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                  const emlrtMsgIdentifier *msgId);

static void r_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                               const emlrtMsgIdentifier *parentId);

static boolean_T rb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                     const emlrtMsgIdentifier *msgId);

static void s_emlrt_marshallIn(const emlrtStack *sp, const mxArray *Hhand2base,
                               const char_T *identifier,
                               coder::array<real_T, 3U> &y);
...
static real_T (*u_emlrt_marshallIn(const emlrtStack *sp,
...
static void w_emlrt_marshallIn(const emlrtStack *sp, const mxArray *imgPts,
                               const char_T *identifier,
                               coder::array<real_T, 3U> &y);
...
static void y_emlrt_marshallIn(const emlrtStack *sp, const mxArray *Worldpts,
                               const char_T *identifier,
                               coder::array<real_T, 2U> &y);
                                    ...
                                    const char_T *identifier))[4][3]
{
  ...
  y = cb_emlrt_marshallIn(sp, emlrtAlias(K), &thisId);
  emlrtDestroyArray(&K);
  return y;
}
                                 ...
                                 const char_T *identifier)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = d_emlrt_marshallIn(sp, emlrtAlias(square_size), &thisId);
                                    ...
                                    const char_T *identifier))[15][4][4]
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = eb_emlrt_marshallIn(sp, emlrtAlias(As), &thisId);
                               ...
                               const char_T *identifier, struct0_T *y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  f_emlrt_marshallIn(sp, emlrtAlias(camera_params), &thisId, y);
                                ...
                                coder::array<uint8_T, 4U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  gb_emlrt_marshallIn(sp, emlrtAlias(images), &thisId, y);
  emlrtDestroyArray(&images);
}
                                ...
                                coder::array<boolean_T, 1U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  ib_emlrt_marshallIn(sp, emlrtAlias(valid_idx), &thisId, y);
                               ...
                               coder::array<real_T, 3U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  t_emlrt_marshallIn(sp, emlrtAlias(Hhand2base), &thisId, y);
                                   ...
                                   const char_T *identifier))[4][4]
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = v_emlrt_marshallIn(sp, emlrtAlias(Hhand2eye), &thisId);
                               ...
                               coder::array<real_T, 3U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  x_emlrt_marshallIn(sp, emlrtAlias(imgPts), &thisId, y);
                               ...
                               coder::array<real_T, 2U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  ab_emlrt_marshallIn(sp, emlrtAlias(Worldpts), &thisId, y);
                              ...
                              const mxArray *plhs[6])
{
  ...
  square_size = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "square_size");
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "camera_params",
                     &camera_params);
  // Invoke the target function
  ComputeCamExtrinsics(images, square_size, &camera_params, image_points,
  ...
  if (nlhs > 4) {
    ...
    plhs[4] = c_emlrt_marshallOut(b_world_points);
  }
  if (nlhs > 5) {
    plhs[5] = d_emlrt_marshallOut(err);
  }
                     ...
                     const mxArray *plhs[3])
{
  ...
  b_Y = (real_T(*)[4][4])mxMalloc(sizeof(real_T[4][4]));
  // Marshall function inputs
  As = db_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "As");
  Bs = db_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "Bs");
  // Invoke the target function
  HandeyeShah(*As, *Bs, *X, *b_Y, &err);
  // Marshall function outputs
  plhs[0] = f_emlrt_marshallOut(*X);
  if (nlhs > 1) {
    plhs[1] = f_emlrt_marshallOut(*b_Y);
  }
  if (nlhs > 2) {
    plhs[2] = d_emlrt_marshallOut(err);
  }
}
...
void calibrateHandeye_atexit()
{
  ...
  calibrateHandeye_xil_terminate();
  calibrateHandeye_xil_shutdown();
...
void computeErrors_api(const mxArray *const prhs[7], const mxArray **plhs)
{
  ...
  // Marshall function inputs
  Hhand2base.no_free();
  s_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "Hhand2base", Hhand2base);
  Hhand2eye = u_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "Hhand2eye");
  Hbase2grid = u_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "Hbase2grid");
  Hcam2grid.no_free();
  s_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "Hcam2grid", Hcam2grid);
  imgPts.no_free();
  w_emlrt_marshallIn(&st, emlrtAlias(prhs[4]), "imgPts", imgPts);
  Worldpts.no_free();
  y_emlrt_marshallIn(&st, emlrtAlias(prhs[5]), "Worldpts", Worldpts);
  K = bb_emlrt_marshallIn(&st, emlrtAlias(prhs[6]), "K");
  // Invoke the target function
  computeErrors(Hhand2base, *Hhand2eye, *Hbase2grid, Hcam2grid, imgPts,
                Worldpts, *K, *errors);
  // Marshall function outputs
  *plhs = e_emlrt_marshallOut(*errors);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}
...
void preprocessImages_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  ...
  // Marshall function inputs
  images.no_free();
  fb_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "images", images);
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "camera_params",
                     &camera_params);
  // Invoke the target function
  preprocessImages(images, &camera_params, gray_images);
  // Marshall function outputs
  gray_images.no_free();
  *plhs = g_emlrt_marshallOut(gray_images);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}
                        ...
                        const mxArray *plhs[2])
{
  ...
  s_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "robot_poses_vec",
                     robot_poses_vec);
  valid_idx.no_free();
  hb_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "valid_idx", valid_idx);
  // Invoke the target function
...
//
// File trailer for _coder_calibrateHandeye_api.cpp
//
// [EOF]
//
