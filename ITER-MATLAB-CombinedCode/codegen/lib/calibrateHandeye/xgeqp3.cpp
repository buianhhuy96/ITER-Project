              ...
              if (std::abs(beta1) < 1.0020841800044864E-292) {
                ...
                do {
                  ...
                  for (int f_k{ix0}; f_k <= i3; f_k++) {
                    A[f_k - 1] = 9.9792015476736E+291 * A[f_k - 1];
                  }
        ...
        if ((c_i + 1) < c_n) {
          ...
          if ((lastv + 1) > 0) {
            if ((lastc + 1) != 0) {
              ...
              i10 = ic0 + (ma * lastc);
              iac = ic0;
              while (((ma > 0) && (iac <= i10)) || ((ma < 0) && (iac >= i10))) {
                double c;
                int i12;
                c = 0.0;
                i12 = iac + lastv;
