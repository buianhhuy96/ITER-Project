                ...
                ::coder::array<int32_T, 2U> &i)
{
  ...
  st.site = &te_emlrtRSI;
  idx = 0;
  i.set_size(&vm_emlrtRTEI, &st, 1, x.size(1));
  ...
  if (x.size(1) == 1) {
    if (idx == 0) {
      i.set_size(&se_emlrtRTEI, &st, 1, 0);
    }
  } else {
    if (1 > idx) {
      idx = 0;
    }
    i.set_size(&se_emlrtRTEI, &st, i.size(0), idx);
  }
}
                ...
                ::coder::array<int32_T, 1U> &i)
{
  ...
  st.site = &te_emlrtRSI;
  idx = 0;
  i.set_size(&re_emlrtRTEI, &st, x.size(0));
  b_st.site = &ve_emlrtRSI;
