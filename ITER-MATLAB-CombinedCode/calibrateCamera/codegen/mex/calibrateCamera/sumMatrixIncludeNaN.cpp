...
real32_T sumColumnB(const emlrtStack *sp, const ::coder::array<real32_T, 1U> &x,
                    int32_T vlen)
{
  emlrtStack b_st;
  emlrtStack c_st;
...
real32_T sumColumnB(real32_T x)
{
  return x;
}
...
real32_T sumColumnB4(const ::coder::array<real32_T, 1U> &x, int32_T vstart)
{
  real32_T psum1;
  real32_T psum2;
  real32_T psum3;
