...
void b_imfilter(const emlrtStack *sp, ::coder::array<real32_T, 2U> &varargin_1)
{
  ...
  if ((varargin_1.size(0) != 0) && (varargin_1.size(1) != 0)) {
    ...
    varargin_1.set_size(&he_emlrtRTEI, &c_st, static_cast<int32_T>(outSizeT[0]),
...
void d_imfilter(const emlrtStack *sp, ::coder::array<real32_T, 2U> &varargin_1)
{
  ...
  if ((varargin_1.size(0) != 0) && (varargin_1.size(1) != 0)) {
    ...
    if (idx == 1) {
      ...
      b_a.set_size(&ns_emlrtRTEI, sp, a.size(0), a.size(1));
      i = a.size(0) * a.size(1);
      for (b_i = 0; b_i < i; b_i++) {
        b_a[b_i] = a[b_i];
      }
      ...
      c_st.site = &sc_emlrtRSI;
      b.set_size(&he_emlrtRTEI, &c_st, b_a.size(0),
      ...
      c_st.site = &sc_emlrtRSI;
      b_a.set_size(&os_emlrtRTEI, &c_st, b.size(0), b.size(1));
      i = b.size(0) * b.size(1);
      for (b_i = 0; b_i < i; b_i++) {
        b_a[b_i] = b[b_i];
      }
      b.set_size(&he_emlrtRTEI, &c_st, static_cast<int32_T>(outSizeT[0]),
                 static_cast<int32_T>(outSizeT[1]));
      if (tooBig) {
        padSizeT[0] = b_a.size(0);
        startT[0] = 29.0;
      ...
      varargin_1.set_size(&ps_emlrtRTEI, sp, b.size(0), b.size(1));
      i = b.size(1);
      for (b_i = 0; b_i < i; b_i++) {
        idx = b.size(0);
        for (k = 0; k < idx; k++) {
      ...
      c_st.site = &sc_emlrtRSI;
      varargin_1.set_size(&he_emlrtRTEI, &c_st,
              ...
              const real_T pad[2], ::coder::array<real32_T, 2U> &a)
{
  ...
  if ((a_tmp.size(0) == 0) || (a_tmp.size(1) == 0)) {
    ...
    a.set_size(&je_emlrtRTEI, &b_st, static_cast<int32_T>(sizeB_idx_0),
    ...
    a.set_size(&ie_emlrtRTEI, &b_st, static_cast<int32_T>(sizeB_idx_0),
               static_cast<int32_T>(sizeB_idx_1));
    ...
    for (j = 0; j < i1; j++) {
      ...
      for (b_i = 0; b_i < i2; b_i++) {
        ...
        k = (j + i) + 1;
        if ((k < 1) || (k > a.size(1))) {
          emlrtDynamicBoundsCheckR2012b(k, 1, a.size(1), &mb_emlrtBCI, &b_st);
        }
    ...
    for (j = 0; j < i1; j++) {
      ...
      for (b_i = k; b_i <= b; b_i++) {
        if ((b_i < 1) || (b_i > a.size(0))) {
          emlrtDynamicBoundsCheckR2012b(b_i, 1, a.size(0), &rb_emlrtBCI, &b_st);
        }
        i2 = (j + i) + 1;
        if ((i2 < 1) || (i2 > a.size(1))) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, a.size(1), &sb_emlrtBCI, &b_st);
        }
    ...
    for (j = 0; j < i1; j++) {
      ...
      for (b_i = 0; b_i < i2; b_i++) {
        if (b_i + 1 > a_tmp.size(0)) {
          emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, a_tmp.size(0), &nb_emlrtBCI,
                                        &b_st);
        }
        if (j + 1 > a_tmp.size(1)) {
        ...
        if ((k < 1) || (k > a.size(0))) {
          emlrtDynamicBoundsCheckR2012b(k, 1, a.size(0), &pb_emlrtBCI, &b_st);
        }
        b = (j + i) + 1;
        if ((b < 1) || (b > a.size(1))) {
          emlrtDynamicBoundsCheckR2012b(b, 1, a.size(1), &qb_emlrtBCI, &b_st);
        }
