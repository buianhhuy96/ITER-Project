                              ...
                              real_T normMatrixInv[9])
{
  ...
  ptsNorm.set_size(&mf_emlrtRTEI, &st, pts.size(0), csz_idx_1);
  ...
  if (1 > ptsNorm.size(1)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, ptsNorm.size(1), &kt_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > ptsNorm.size(1)) {
    emlrtDynamicBoundsCheckR2012b(2, 1, ptsNorm.size(1), &jt_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  ncols = ptsNorm.size(0);
  b_ptsNorm.set_size(&aq_emlrtRTEI, sp, ptsNorm.size(0));
  for (i = 0; i < ncols; i++) {
    b_ptsNorm[i] = ptsNorm[i];
  }
  ncols = ptsNorm.size(0);
  c_ptsNorm.set_size(&bq_emlrtRTEI, sp, ptsNorm.size(0));
  for (i = 0; i < ncols; i++) {
  ...
  if (1 > cent_size_idx_1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, cent_size_idx_1, &it_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > cent_size_idx_1) {
    emlrtDynamicBoundsCheckR2012b(2, 1, 1, &ht_emlrtBCI, (emlrtCTX)sp);
  }
                            ...
                            real_T normMatrixInv[9])
{
  ...
  ptsNorm.set_size(&mf_emlrtRTEI, sp, pts.size(0), 2);
  if (pts.size(0) != 0) {
    nfb = (pts.size(0) != 1);
    for (inb = 0; inb < 2; inb++) {
  ...
  ptsNorm.set_size(&cq_emlrtRTEI, sp, ptsNorm.size(0), 2);
  for (col = 0; col < nfb; col++) {
