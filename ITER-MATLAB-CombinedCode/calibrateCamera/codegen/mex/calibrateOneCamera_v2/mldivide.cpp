              ...
              ::coder::array<real_T, 1U> &B)
{
  ...
  if (B.size(0) != A.size(0)) {
    emlrtErrorWithMessageIdR2018a(sp, &tc_emlrtRTEI, "MATLAB:dimagree",
                                  "MATLAB:dimagree", 0);
  }
  st.site = &fy_emlrtRSI;
  if ((A.size(0) == 0) || (B.size(0) == 0)) {
    B.set_size(&jw_emlrtRTEI, &st, 8);
    ...
    b_A.set_size(&kw_emlrtRTEI, &f_st, 8, 8);
    ...
    info = (int32_T)info_t;
    ipiv.set_size(&lw_emlrtRTEI, &g_st, 1, 8);
