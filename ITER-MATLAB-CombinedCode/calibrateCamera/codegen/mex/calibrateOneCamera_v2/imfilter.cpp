...
void b_imfilter(const emlrtStack *sp, ::coder::array<real32_T, 2U> &varargin_1)
{
  ...
  if ((varargin_1.size(0) != 0) && (varargin_1.size(1) != 0)) {
    ...
    if (!(outSizeT[0] >= 0.0)) {
      emlrtNonNegativeCheckR2012b(outSizeT[0], &ah_emlrtDCI, &c_st);
    }
    if (!(outSizeT[1] >= 0.0)) {
      emlrtNonNegativeCheckR2012b(outSizeT[1], &ah_emlrtDCI, &c_st);
    }
    varargin_1.set_size(&qe_emlrtRTEI, &c_st, static_cast<int32_T>(outSizeT[0]),
...
void d_imfilter(const emlrtStack *sp, ::coder::array<real32_T, 2U> &varargin_1)
{
  ...
  if ((varargin_1.size(0) != 0) && (varargin_1.size(1) != 0)) {
    ...
    if (idx == 1) {
      ...
      b_a.set_size(&dw_emlrtRTEI, sp, a.size(0), a.size(1));
      ...
      r.set_size(&ew_emlrtRTEI, &st, idx);
      idx = 0;
      for (i = 0; i < 29; i++) {
        if (b_s[i] != 0.0) {
      ...
      b_st.site = &ad_emlrtRSI;
      nonzero_h.set_size(&fw_emlrtRTEI, &b_st, r.size(0));
      idx = r.size(0);
      for (b_i = 0; b_i < idx; b_i++) {
      ...
      if (!(out_size_row[1] >= 0.0)) {
        emlrtNonNegativeCheckR2012b(out_size_row[1], &ah_emlrtDCI, &c_st);
      }
      b.set_size(&qe_emlrtRTEI, &c_st, b_a.size(0),
      ...
      r1.set_size(&gw_emlrtRTEI, &st, idx);
      idx = 0;
      for (i = 0; i < 29; i++) {
        if (hcol[i] != 0.0) {
      ...
      b_st.site = &ad_emlrtRSI;
      nonzero_h.set_size(&fw_emlrtRTEI, &b_st, r1.size(0));
      idx = r1.size(0);
      for (b_i = 0; b_i < idx; b_i++) {
      ...
      c_st.site = &bd_emlrtRSI;
      b_a.set_size(&hw_emlrtRTEI, &c_st, b.size(0), b.size(1));
      ...
      b.set_size(&qe_emlrtRTEI, &c_st, static_cast<int32_T>(outSizeT[0]),
                 static_cast<int32_T>(outSizeT[1]));
      if (tooBig) {
        padSizeT[0] = b_a.size(0);
        startT[0] = 29.0;
      ...
      varargin_1.set_size(&iw_emlrtRTEI, sp, b.size(0), b.size(1));
      idx = b.size(1);
      for (b_i = 0; b_i < idx; b_i++) {
        i = b.size(0);
      ...
      varargin_1.set_size(&qe_emlrtRTEI, &c_st,
              ...
              const real_T pad[2], ::coder::array<real32_T, 2U> &a)
{
  ...
  if ((a_tmp.size(0) == 0) || (a_tmp.size(1) == 0)) {
    ...
    if (!(sizeB_idx_0 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(sizeB_idx_0, &b_emlrtDCI, &b_st);
    }
    if (!(sizeB_idx_1 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(sizeB_idx_1, &b_emlrtDCI, &b_st);
    }
    a.set_size(&se_emlrtRTEI, &b_st, static_cast<int32_T>(sizeB_idx_0),
    ...
    sizeB_idx_0 = static_cast<real_T>(a_tmp.size(0)) + 2.0 * pad[0];
    if (!(sizeB_idx_0 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(sizeB_idx_0, &d_emlrtDCI, &b_st);
    }
    if (sizeB_idx_0 != static_cast<int32_T>(muDoubleScalarFloor(sizeB_idx_0))) {
      emlrtIntegerCheckR2012b(sizeB_idx_0, &c_emlrtDCI, &b_st);
    }
    sizeB_idx_1 = static_cast<real_T>(a_tmp.size(1)) + 2.0 * pad[1];
    if (!(sizeB_idx_1 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(sizeB_idx_1, &d_emlrtDCI, &b_st);
    }
    if (sizeB_idx_1 != static_cast<int32_T>(muDoubleScalarFloor(sizeB_idx_1))) {
      emlrtIntegerCheckR2012b(sizeB_idx_1, &c_emlrtDCI, &b_st);
    }
