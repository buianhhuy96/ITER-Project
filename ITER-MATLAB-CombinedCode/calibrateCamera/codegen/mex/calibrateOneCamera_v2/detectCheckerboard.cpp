                          ...
                          ::coder::array<boolean_T, 2U> &mask)
{
  ...
  if (!(height >= 0.0)) {
    emlrtNonNegativeCheckR2012b(height, &dg_emlrtDCI, (emlrtCTX)sp);
  }
  d = static_cast<int32_T>(muDoubleScalarFloor(height));
  if (height != d) {
    emlrtIntegerCheckR2012b(height, &cg_emlrtDCI, (emlrtCTX)sp);
  }
  mask.set_size(&qq_emlrtRTEI, sp, static_cast<int32_T>(height), mask.size(1));
  if (!(width >= 0.0)) {
    emlrtNonNegativeCheckR2012b(width, &fg_emlrtDCI, (emlrtCTX)sp);
  }
  d1 = static_cast<int32_T>(muDoubleScalarFloor(width));
  if (width != d1) {
    emlrtIntegerCheckR2012b(width, &eg_emlrtDCI, (emlrtCTX)sp);
  }
  mask.set_size(&qq_emlrtRTEI, sp, mask.size(0), static_cast<int32_T>(width));
  if (height != d) {
    emlrtIntegerCheckR2012b(height, &gg_emlrtDCI, (emlrtCTX)sp);
  }
  if (width != d1) {
    emlrtIntegerCheckR2012b(width, &gg_emlrtDCI, (emlrtCTX)sp);
  }
  ...
  if (Y[1] > Y[2]) {
    ...
    if (Y[1] != static_cast<int32_T>(muDoubleScalarFloor(Y[1]))) {
      emlrtIntegerCheckR2012b(Y[1], &xf_emlrtDCI, (emlrtCTX)sp);
    }
    if ((static_cast<int32_T>(Y[1]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(Y[1]), 1,
                                    static_cast<int32_T>(height), &at_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i = static_cast<int32_T>(Y[1]) - 1;
    if (Y[2] != static_cast<int32_T>(muDoubleScalarFloor(Y[2]))) {
      emlrtIntegerCheckR2012b(Y[2], &yf_emlrtDCI, (emlrtCTX)sp);
    }
    if ((static_cast<int32_T>(Y[2]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(Y[2]), 1,
                                    static_cast<int32_T>(height), &bt_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  if (b_X[1] > b_X[2]) {
    ...
    if (b_X[1] != static_cast<int32_T>(muDoubleScalarFloor(b_X[1]))) {
      emlrtIntegerCheckR2012b(b_X[1], &ag_emlrtDCI, (emlrtCTX)sp);
    }
    if ((static_cast<int32_T>(b_X[1]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_X[1]), 1,
                                    static_cast<int32_T>(width), &ct_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i2 = static_cast<int32_T>(b_X[1]) - 1;
    if (b_X[2] != static_cast<int32_T>(muDoubleScalarFloor(b_X[2]))) {
      emlrtIntegerCheckR2012b(b_X[2], &bg_emlrtDCI, (emlrtCTX)sp);
    }
    if ((static_cast<int32_T>(b_X[2]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_X[2]), 1,
                                    static_cast<int32_T>(width), &dt_emlrtBCI,
                                    (emlrtCTX)sp);
    }
                        ...
                        ::coder::array<real_T, 2U> &points, real_T boardSize[2])
{
  ...
  if ((b_I.size(0) == 0) || (b_I.size(1) == 0)) {
    Ig.set_size(&rd_emlrtRTEI, &b_st, b_I.size(0), b_I.size(1));
    ...
    Ig.set_size(&qe_emlrtRTEI, &e_st, b_I.size(0), b_I.size(1));
    if (!tooBig) {
      padSizeT[0] = a.size(0);
      startT[0] = 15.0;
      padSizeT[1] = a.size(1);
  ...
  Iy.set_size(&sd_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  ...
  b_imfilter(&b_st, Ig);
  Ixy.set_size(&td_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  loop_ub = Ig.size(0) * Ig.size(1);
  for (i = 0; i < loop_ub; i++) {
    Ixy[i] = Ig[i];
  }
  ...
  imfilter(&b_st, Ixy);
  r.set_size(&ud_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  loop_ub = Ig.size(0) * Ig.size(1);
  for (i = 0; i < loop_ub; i++) {
    r[i] = Ig[i] * 0.707106769F;
  }
  I_45.set_size(&vd_emlrtRTEI, &st, Iy.size(0), Iy.size(1));
  ...
  I_45.set_size(&wd_emlrtRTEI, &st, r.size(0), r.size(1));
  for (i = 0; i < loop_ub; i++) {
    I_45[i] = r[i] + I_45[i];
  }
  r1.set_size(&xd_emlrtRTEI, &st, Iy.size(0), Iy.size(1));
  loop_ub = Iy.size(0) * Iy.size(1);
  for (i = 0; i < loop_ub; i++) {
  ...
  emlrtSizeEqCheckNDR2012b(&iv[0], &iv1[0], &c_emlrtECI, &st);
  I_45_x.set_size(&yd_emlrtRTEI, &st, I_45.size(0), I_45.size(1));
  ...
  a.set_size(&ae_emlrtRTEI, &st, I_45.size(0), I_45.size(1));
  loop_ub = I_45.size(0) * I_45.size(1);
  for (i = 0; i < loop_ub; i++) {
    a[i] = I_45[i];
  }
  ...
  emlrtSizeEqCheckNDR2012b(&iv[0], &iv1[0], &d_emlrtECI, &st);
  loop_ub = I_45_x.size(0) * I_45_x.size(1);
  for (i = 0; i < loop_ub; i++) {
  ...
  b_abs(&b_st, I_45, a);
  I_45.set_size(&be_emlrtRTEI, &st, r.size(0), r.size(1));
  loop_ub = r.size(0) * r.size(1);
  for (i = 0; i < loop_ub; i++) {
    I_45[i] = r[i] + r1[i];
  }
  ...
  cxy.set_size(&ce_emlrtRTEI, &st, b.size(0), b.size(1));
  loop_ub = b.size(0) * b.size(1);
  for (i = 0; i < loop_ub; i++) {
    cxy[i] = b[i] - a[i];
  }
  ...
  r2.set_size(&de_emlrtRTEI, &st, trueCount);
  trueCount = 0;
  for (loop_ub = 0; loop_ub <= end; loop_ub++) {
    if (b[loop_ub] - a[loop_ub] < 0.0F) {
  ...
  for (i = 0; i < loop_ub; i++) {
    if ((r2[i] < 1) || (r2[i] > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(r2[i], 1, trueCount, &l_emlrtBCI, &st);
    }
    cxy[r2[i] - 1] = 0.0F;
  }
  ...
  r3.set_size(&de_emlrtRTEI, &st, trueCount);
  trueCount = 0;
  for (loop_ub = 0; loop_ub <= end; loop_ub++) {
    if (b[loop_ub] < 0.0F) {
  ...
  for (i = 0; i <= loop_ub; i++) {
    if ((r3[i] < 1) || (r3[i] > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(r3[i], 1, trueCount, &m_emlrtBCI, &st);
    }
    b[r3[i] - 1] = 0.0F;
  }
  st.site = &sb_emlrtRSI;
  ...
  b_points0.set_size(&ee_emlrtRTEI, &st, points0.size(0));
  for (i = 0; i < loop_ub; i++) {
    b_points0[i] = points0[i + points0.size(0)];
  }
  loop_ub = points0.size(0);
  c_points0.set_size(&fe_emlrtRTEI, &st, points0.size(0));
  for (i = 0; i < loop_ub; i++) {
  ...
  s.set_size(&ge_emlrtRTEI, &st, r2.size(0));
  loop_ub = r2.size(0);
  for (i = 0; i < loop_ub; i++) {
    s[i] = r2[i];
  }
  ...
  iv[1] = (*(int32_T(*)[2])cxy.size())[1];
  st.site = &ub_emlrtRSI;
  ::coder::internal::indexShapeCheck(&st, iv, s.size(0));
  trueCount = cxy.size(0) * cxy.size(1);
  loop_ub = s.size(0);
  for (i = 0; i < loop_ub; i++) {
    end = static_cast<int32_T>(s[i]);
    if ((end < 1) || (end > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(end, 1, trueCount, &n_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  }
  b_points0.set_size(&he_emlrtRTEI, sp, s.size(0));
  loop_ub = s.size(0);
  for (i = 0; i < loop_ub; i++) {
  ...
  points.set_size(&ie_emlrtRTEI, sp, 0, 0);
  boardSize[0] = 0.0;
  boardSize[1] = 0.0;
  st.site = &vb_emlrtRSI;
  ...
  st.site = &wb_emlrtRSI;
  loop_ub = points0.size(0);
  b_points0.set_size(&je_emlrtRTEI, &st, points0.size(0));
  for (i = 0; i < loop_ub; i++) {
    b_points0[i] = points0[i + points0.size(0)];
  }
  loop_ub = points0.size(0);
  c_points0.set_size(&ke_emlrtRTEI, &st, points0.size(0));
  for (i = 0; i < loop_ub; i++) {
    c_points0[i] = points0[i];
  }
  iv[0] = (*(int32_T(*)[2])b.size())[0];
  ...
  b_st.site = &rf_emlrtRSI;
  eml_sub2ind(&b_st, iv, b_points0, c_points0, r2);
  s.set_size(&le_emlrtRTEI, &st, r2.size(0));
  loop_ub = r2.size(0);
  for (i = 0; i < loop_ub; i++) {
    s[i] = r2[i];
  }
  ...
  b_points0.set_size(&me_emlrtRTEI, sp, s.size(0));
  loop_ub = s.size(0);
  for (i = 0; i < loop_ub; i++) {
                               ...
                               real_T theta, Checkerboard *iobj_0)
{
  ...
  if (scores.size(0) == 0) {
    ...
    board = &iobj_0[0];
    iobj_0[0].BoardIdx.set_size(&mf_emlrtRTEI, &st, 1, 1);
    iobj_0[0].BoardIdx[0] = 0.0;
    iobj_0[0].BoardIdx.set_size(&nf_emlrtRTEI, &st, 3, 3);
    for (i = 0; i < 9; i++) {
      iobj_0[0].BoardIdx[i] = 0.0;
    }
    iobj_0[0].BoardCoords.set_size(&of_emlrtRTEI, &st, 1, 1, 1);
    iobj_0[0].BoardCoords[0] = 0.0;
    iobj_0[0].BoardCoords.set_size(&pf_emlrtRTEI, &st, 3, 3, 2);
    for (i = 0; i < 18; i++) {
      iobj_0[0].BoardCoords[i] = 0.0;
    }
    iobj_0[0].Points.set_size(&qf_emlrtRTEI, &st, 1, 1);
    iobj_0[0].Points[0] = 0.0F;
    iobj_0[0].Points.set_size(&rf_emlrtRTEI, &st, 0, 2);
  } else {
    int32_T b_i;
    int32_T i;
    int32_T sgn2;
    if (points.size(0) < 1) {
      seedIdx.set_size(&if_emlrtRTEI, sp, 1, 0);
    } else {
      seedIdx.set_size(&if_emlrtRTEI, sp, 1, points.size(0));
    ...
    st.site = &xf_emlrtRSI;
    ::coder::internal::indexShapeCheck(&st, scores.size(0), iv);
    st.site = &xf_emlrtRSI;
    sgn2 = seedIdx.size(1);
    for (i = 0; i < sgn2; i++) {
      b_i = static_cast<int32_T>(seedIdx[i]);
      if (seedIdx[i] != b_i) {
        emlrtIntegerCheckR2012b(seedIdx[i], &f_emlrtDCI, &st);
      }
      if (b_i > scores.size(0)) {
        emlrtDynamicBoundsCheckR2012b(b_i, 1, scores.size(0), &kb_emlrtBCI,
                                      &st);
      }
    }
    x.set_size(&jf_emlrtRTEI, &st, seedIdx.size(1));
    sgn2 = seedIdx.size(1);
    for (i = 0; i < sgn2; i++) {
    ...
    iv[1] = (*(int32_T(*)[2])seedIdx.size())[1];
    st.site = &yf_emlrtRSI;
    ::coder::internal::b_indexShapeCheck(&st, iv, iidx.size(0));
    b_seedIdx.set_size(&kf_emlrtRTEI, sp, 1, iidx.size(0));
    sgn2 = iidx.size(0);
    for (i = 0; i < sgn2; i++) {
      if ((iidx[i] < 1) || (iidx[i] > seedIdx.size(1))) {
        emlrtDynamicBoundsCheckR2012b(iidx[i], 1, seedIdx.size(1), &lb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      b_seedIdx[i] = static_cast<uint32_T>(seedIdx[iidx[i] - 1]);
    }
    seedIdx.set_size(&kf_emlrtRTEI, sp, 1, b_seedIdx.size(1));
    ...
    if (iidx.size(0) > 2000) {
      ...
      if (1 > sgn2) {
        ...
        if (1 > seedIdx.size(1)) {
          emlrtDynamicBoundsCheckR2012b(1, 1, seedIdx.size(1), &hb_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if (sgn2 > seedIdx.size(1)) {
          emlrtDynamicBoundsCheckR2012b(sgn2, 1, seedIdx.size(1), &ib_emlrtBCI,
                                        (emlrtCTX)sp);
        }
      }
      b_seedIdx.set_size(&lf_emlrtRTEI, sp, 1, sgn2);
      for (i = 0; i < sgn2; i++) {
        b_seedIdx[i] = static_cast<uint32_T>(seedIdx[i]);
      }
      seedIdx.set_size(&lf_emlrtRTEI, sp, 1, b_seedIdx.size(1));
      sgn2 = b_seedIdx.size(1);
      for (i = 0; i < sgn2; i++) {
        seedIdx[i] = b_seedIdx[i];
      }
    ...
    for (b_i = 0; b_i < i; b_i++) {
      ...
      if (b_i + 1 > seedIdx.size(1)) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, seedIdx.size(1), &mb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      sgn2 = static_cast<int32_T>(static_cast<uint32_T>(seedIdx[b_i]));
      if (sgn2 > points.size(0)) {
        emlrtDynamicBoundsCheckR2012b(sgn2, 1, points.size(0), &jb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      ...
      if (static_cast<real_T>(b_x[1]) != static_cast<int32_T>(b_x[1])) {
        emlrtIntegerCheckR2012b(static_cast<real_T>(b_x[1]), &g_emlrtDCI, &st);
      }
      ...
      if (static_cast<real_T>(b_x[0]) != static_cast<int32_T>(b_x[0])) {
        emlrtIntegerCheckR2012b(static_cast<real_T>(b_x[0]), &h_emlrtDCI, &st);
      }
      ...
      a = Ix2[(static_cast<int32_T>(static_cast<real32_T>(
              ...
              1];
      if (static_cast<real_T>(b_x[1]) != static_cast<int32_T>(b_x[1])) {
        emlrtIntegerCheckR2012b(static_cast<real_T>(b_x[1]), &i_emlrtDCI, &st);
      }
      if ((static_cast<int32_T>(static_cast<real32_T>(d)) < 1) ||
      ...
      if (static_cast<real_T>(b_x[0]) != static_cast<int32_T>(b_x[0])) {
        emlrtIntegerCheckR2012b(static_cast<real_T>(b_x[0]), &j_emlrtDCI, &st);
      }
      if ((static_cast<int32_T>(static_cast<real32_T>(d1)) < 1) ||
      ...
      b = Ixy[(static_cast<int32_T>(static_cast<real32_T>(
              ...
              1];
      if (static_cast<real_T>(b_x[1]) != static_cast<int32_T>(b_x[1])) {
        emlrtIntegerCheckR2012b(static_cast<real_T>(b_x[1]), &k_emlrtDCI, &st);
      }
      if ((static_cast<int32_T>(static_cast<real32_T>(d)) < 1) ||
      ...
      if (static_cast<real_T>(b_x[0]) != static_cast<int32_T>(b_x[0])) {
        emlrtIntegerCheckR2012b(static_cast<real_T>(b_x[0]), &l_emlrtDCI, &st);
      }
      if ((static_cast<int32_T>(static_cast<real32_T>(d1)) < 1) ||
                     ...
                     const ::coder::array<real32_T, 2U> &b_I)
{
  ...
  if (!muSingleScalarIsInf(x)) {
    ...
    if (b_board->BoardCoords.size(0) < b_board->BoardCoords.size(1)) {
      st.site = &pr_emlrtRSI;
      c_board.set_size(&up_emlrtRTEI, &st, b_board->BoardIdx.size(0),
      ...
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &bq_emlrtBCI, &st);
      }
      loop_ub = b_board->BoardCoords.size(0);
      npages = b_board->BoardCoords.size(1);
      c_board.set_size(&vp_emlrtRTEI, &st, loop_ub, npages);
      for (i = 0; i < npages; i++) {
        for (i1 = 0; i1 < loop_ub; i1++) {
      ...
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &aq_emlrtBCI, &st);
      }
      loop_ub = b_board->BoardCoords.size(0);
      npages = b_board->BoardCoords.size(1);
      c_board.set_size(&wp_emlrtRTEI, &st, loop_ub, npages);
      for (i = 0; i < npages; i++) {
        for (i1 = 0; i1 < loop_ub; i1++) {
          c_board[i1 + c_board.size(0) * i] =
              b_board->BoardCoords[(i1 + b_board->BoardCoords.size(0) * i) +
      ...
      b_board->BoardCoords.set_size(&xp_emlrtRTEI, &st, r.size(0), r.size(1),
                                    2);
    ...
    st.site = &qr_emlrtRSI;
    newBoardCoords1.set_size(&yp_emlrtRTEI, &st, b_board->BoardIdx.size(0),
                             b_board->BoardIdx.size(1));
    ...
    if ((newBoardCoords1.size(0) == 0) && (newBoardCoords1.size(1) == 0)) {
      emlrtErrorWithMessageIdR2018a(
          &b_st, &sb_emlrtRTEI, "Coder:toolbox:eml_all_or_any_specialEmpty",
    ...
    y.set_size(&aq_emlrtRTEI, &b_st, 1, newBoardCoords1.size(1));
    ...
    if (::coder::internal::ifWhileCond(&st, y)) {
      ...
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &as_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &xr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &tr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &rr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &pr_emlrtBCI, &st);
      }
      ...
      i = b_board->BoardCoords.size(1);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &nr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &lr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &hr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &fr_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &er_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &dr_emlrtBCI, &st);
      }
      ...
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &br_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &yq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (3 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (3 > i) {
        emlrtDynamicBoundsCheckR2012b(3, 1, i, &uq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &sq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(2);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &qq_emlrtBCI, &st);
      }
      ...
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &oq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &mq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (3 > i) {
      ...
      i = b_board->BoardCoords.size(1);
      if (3 > i) {
        emlrtDynamicBoundsCheckR2012b(3, 1, i, &iq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(0);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &gq_emlrtBCI, &st);
      }
      i = b_board->BoardCoords.size(1);
      if (2 > i) {
      ...
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &eq_emlrtBCI, &st);
      }
      upperLeftPolyY[0] =
          b_board->BoardCoords[b_board->BoardCoords.size(0) +
                               b_board->BoardCoords.size(0) *
      ...
      r4.set_size(&jq_emlrtRTEI, &st, npages);
      npages = 0;
      for (i = 0; i <= i2; i++) {
        if (upperLeftMask[i]) {
          r4[npages] = i + 1;
      ...
      r5.set_size(&jq_emlrtRTEI, &st, npages);
      npages = 0;
      for (i = 0; i <= i2; i++) {
        if (nextSquareMask[i]) {
          r5[npages] = i + 1;
      ...
      c_I.set_size(&kq_emlrtRTEI, &b_st, r4.size(0));
      loop_ub = r4.size(0);
      for (i = 0; i < loop_ub; i++) {
        if ((r4[i] < 1) || (r4[i] > npages)) {
          emlrtDynamicBoundsCheckR2012b(r4[i], 1, npages, &xs_emlrtBCI, &b_st);
        }
        c_I[i] = b_I[r4[i] - 1];
      }
      ...
      b_st.site = &qs_emlrtRSI;
      npages = b_I.size(0) * b_I.size(1);
      c_I.set_size(&lq_emlrtRTEI, &b_st, r5.size(0));
      loop_ub = r5.size(0);
      for (i = 0; i < loop_ub; i++) {
        if ((r5[i] < 1) || (r5[i] > npages)) {
          emlrtDynamicBoundsCheckR2012b(r5[i], 1, npages, &ys_emlrtBCI, &b_st);
        }
        c_I[i] = b_I[r5[i] - 1];
      }
      c_st.site = &qs_emlrtRSI;
      ...
      if (i1 < 0) {
        emlrtDynamicBoundsCheckR2012b(i1, 0, MAX_int32_T, &os_emlrtBCI, &st);
      }
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &ns_emlrtBCI, &st);
      }
      cornerIdx[1] = b_board->BoardIdx[i1 - 1];
      i = b_board->BoardIdx.size(0);
      i1 = b_board->BoardIdx.size(0);
      if (i1 < 0) {
        emlrtDynamicBoundsCheckR2012b(i1, 0, MAX_int32_T, &qs_emlrtBCI, &st);
      }
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &ps_emlrtBCI, &st);
      }
      i = b_board->BoardIdx.size(1);
      npages = b_board->BoardIdx.size(1);
      if (npages < 0) {
        emlrtDynamicBoundsCheckR2012b(npages, 0, MAX_int32_T, &qs_emlrtBCI,
                                      &st);
      }
      if ((npages < 1) || (npages > i)) {
        emlrtDynamicBoundsCheckR2012b(npages, 1, i, &ps_emlrtBCI, &st);
      }
      cornerIdx[2] =
          b_board
      ...
      if (i1 < 0) {
        emlrtDynamicBoundsCheckR2012b(i1, 0, MAX_int32_T, &ss_emlrtBCI, &st);
      }
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &rs_emlrtBCI, &st);
      }
      ...
      npages = 0;
      ii.set_size(&bq_emlrtRTEI, &d_st, 1, 1);
      i2 = 0;
      exitg1 = false;
      while ((!exitg1) && (i2 < 4)) {
        if (cornerIdx[i2] != 0.0) {
      ...
      if (npages == 0) {
        ii.set_size(&nl_emlrtRTEI, &d_st, 1, 0);
      }
      numRot.set_size(&cq_emlrtRTEI, &st, 1, ii.size(1));
      loop_ub = ii.size(1);
      for (i = 0; i < loop_ub; i++) {
        numRot[0] = static_cast<real_T>(ii[0]) - 1.0;
      }
      if (ii.size(1) == 0) {
        numRot.set_size(&cq_emlrtRTEI, &st, 1, 1);
        numRot[0] = 0.0;
      }
      y.set_size(&dq_emlrtRTEI, sp, 1, 1);
      y[0] = (numRot[0] == 2.0);
      st.site = &ur_emlrtRSI;
      if (::coder::internal::ifWhileCond(&st, y)) {
        st.site = &vr_emlrtRSI;
        ...
        if (i2 != 0) {
          st.site = &xr_emlrtRSI;
          newBoardCoords1.set_size(&eq_emlrtRTEI, &st,
          ...
          b_board->BoardIdx.set_size(&fq_emlrtRTEI, &st,
          ...
          i = b_board->BoardCoords.size(2);
          if (1 > i) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i, &dq_emlrtBCI, &st);
          }
          loop_ub = b_board->BoardCoords.size(0);
          npages = b_board->BoardCoords.size(1);
          newBoardCoords1.set_size(&gq_emlrtRTEI, &st, loop_ub, npages);
          for (i = 0; i < npages; i++) {
            for (i1 = 0; i1 < loop_ub; i1++) {
          ...
          i = b_board->BoardCoords.size(2);
          if (2 > i) {
            emlrtDynamicBoundsCheckR2012b(2, 1, i, &cq_emlrtBCI, &st);
          }
          loop_ub = b_board->BoardCoords.size(0);
          npages = b_board->BoardCoords.size(1);
          newBoardCoords2.set_size(&hq_emlrtRTEI, &st, loop_ub, npages);
          for (i = 0; i < npages; i++) {
            for (i1 = 0; i1 < loop_ub; i1++) {
          ...
          cat(&b_st, newBoardCoords1, newBoardCoords2, r);
          b_board->BoardCoords.set_size(&iq_emlrtRTEI, &st, r.size(0),
                                        r.size(1), 2);
          loop_ub = r.size(0) * r.size(1) * 2;
          for (i = 0; i < loop_ub; i++) {
            b_board->BoardCoords[i] = r[i];
    ...
    if (p == t) {
      i = b_board->BoardCoords.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &ms_emlrtBCI, (emlrtCTX)sp);
      }
      i = b_board->BoardCoords.size(1);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &ls_emlrtBCI, (emlrtCTX)sp);
      }
      loop_ub = b_board->BoardCoords.size(2);
      r1.set_size(&mq_emlrtRTEI, sp, 1, 1, loop_ub);
      for (i = 0; i < loop_ub; i++) {
      ...
      if (npages < 0) {
        emlrtDynamicBoundsCheckR2012b(npages, 0, MAX_int32_T, &ks_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if ((npages < 1) || (npages > i)) {
        emlrtDynamicBoundsCheckR2012b(npages, 1, i, &js_emlrtBCI, (emlrtCTX)sp);
      }
      i = b_board->BoardCoords.size(1);
      i2 = b_board->BoardCoords.size(1);
      if (i2 < 0) {
        emlrtDynamicBoundsCheckR2012b(i2, 0, MAX_int32_T, &is_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if ((i2 < 1) || (i2 > i)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, i, &hs_emlrtBCI, (emlrtCTX)sp);
      }
      loop_ub = b_board->BoardCoords.size(2);
      r2.set_size(&nq_emlrtRTEI, sp, 1, 1, loop_ub);
      for (i = 0; i < loop_ub; i++) {
      ...
      r3.set_size(&mq_emlrtRTEI, sp, 1, 1, r1.size(2));
      loop_ub = r1.size(2);
      for (i = 0; i < loop_ub; i++) {
        r3[i] = (r1[i] > r2[i]);
      }
      ...
      if (d_any(&st, r3)) {
        ...
        i = b_board->BoardCoords.size(2);
        if (1 > i) {
          emlrtDynamicBoundsCheckR2012b(1, 1, i, &gs_emlrtBCI, (emlrtCTX)sp);
        }
        i = b_board->BoardCoords.size(0);
        i1 = b_board->BoardCoords.size(0);
        if (i1 < 0) {
          emlrtDynamicBoundsCheckR2012b(i1, 0, MAX_int32_T, &us_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if ((i1 < 1) || (i1 > i)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, i, &ts_emlrtBCI, (emlrtCTX)sp);
        }
        i = b_board->BoardCoords.size(1);
        npages = b_board->BoardCoords.size(1);
        if (npages < 0) {
          emlrtDynamicBoundsCheckR2012b(npages, 0, MAX_int32_T, &ws_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if ((npages < 1) || (npages > i)) {
          emlrtDynamicBoundsCheckR2012b(npages, 1, i, &vs_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        ...
        if (b_x != 0.0) {
          ...
          b_st.site = &fs_emlrtRSI;
          cat(&b_st, newBoardCoords1, newBoardCoords2, r);
          b_board->BoardCoords.set_size(&xp_emlrtRTEI, &st, r.size(0),
                                        r.size(1), 2);
          loop_ub = r.size(0) * r.size(1) * 2;
          for (i = 0; i < loop_ub; i++) {
            b_board->BoardCoords[i] = r[i];
              ...
              ::coder::array<real_T, 2U> &points, real_T boardSize[2])
{
  ...
  d_this.set_size(&sq_emlrtRTEI, sp, c_this);
  for (i = 0; i < c_this; i++) {
    d_this[i] = (b_this->BoardIdx[i] == 0.0);
  }
  st.site = &pt_emlrtRSI;
  if (b_any(&st, d_this)) {
    points.set_size(&yq_emlrtRTEI, sp, 0, 0);
    boardSize[0] = 0.0;
    boardSize[1] = 0.0;
  } else {
    real_T numPoints;
    ...
    if (!(numPoints >= 0.0)) {
      emlrtNonNegativeCheckR2012b(numPoints, &ig_emlrtDCI, (emlrtCTX)sp);
    }
    if (numPoints != static_cast<int32_T>(numPoints)) {
      emlrtIntegerCheckR2012b(numPoints, &hg_emlrtDCI, (emlrtCTX)sp);
    }
    points.set_size(&tq_emlrtRTEI, sp, static_cast<int32_T>(numPoints), 2);
    if (numPoints != static_cast<int32_T>(numPoints)) {
      emlrtIntegerCheckR2012b(numPoints, &jg_emlrtDCI, (emlrtCTX)sp);
    }
    ...
    if (1 > i) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i, &et_emlrtBCI, (emlrtCTX)sp);
    }
    c_this = b_this->BoardCoords.size(0);
    loop_ub = b_this->BoardCoords.size(1);
    x.set_size(&uq_emlrtRTEI, sp, loop_ub, c_this);
    for (i = 0; i < c_this; i++) {
      for (i1 = 0; i1 < loop_ub; i1++) {
        x[i1 + x.size(0) * i] =
    ...
    r.set_size(&vq_emlrtRTEI, sp, static_cast<int32_T>(numPoints));
    for (i = 0; i < c_this; i++) {
      r[i] = i;
    }
    c_this = x.size(0) * x.size(1);
    emlrtSubAssignSizeCheckR2012b(r.size(), 1, &c_this, 1, &vc_emlrtECI,
                                  (emlrtCTX)sp);
    c_this = x.size(0) * x.size(1);
    for (i = 0; i < c_this; i++) {
      points[r[i]] = x[i];
    ...
    i = b_this->BoardCoords.size(2);
    if (2 > i) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i, &ft_emlrtBCI, (emlrtCTX)sp);
    }
    c_this = b_this->BoardCoords.size(0);
    loop_ub = b_this->BoardCoords.size(1);
    x.set_size(&wq_emlrtRTEI, sp, loop_ub, c_this);
    for (i = 0; i < c_this; i++) {
      for (i1 = 0; i1 < loop_ub; i1++) {
        x[i1 + x.size(0) * i] =
            b_this->BoardCoords[(i + b_this->BoardCoords.size(0) * i1) +
    ...
    r.set_size(&xq_emlrtRTEI, sp, points.size(0));
    for (i = 0; i < c_this; i++) {
      r[i] = i;
    }
    c_this = x.size(0) * x.size(1);
    emlrtSubAssignSizeCheckR2012b(r.size(), 1, &c_this, 1, &wc_emlrtECI,
                                  (emlrtCTX)sp);
    c_this = x.size(0) * x.size(1);
    for (i = 0; i < c_this; i++) {
