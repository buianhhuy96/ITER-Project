            ...
            ::coder::array<real_T, 2U> &jacobian)
{
  static const char_T b_cv[19]{'l', 'e', 'v', 'e', 'n', 'b', 'e', 'r', 'g', '-',
                               'm', 'a', 'r', 'q', 'u', 'a', 'r', 'd', 't'};
  static const char_T t9_FiniteDifferenceType[7]{'f', 'o', 'r', 'w',
                                                 'a', 'r', 'd'};
  ...
  for (nx = 0; nx <= m; nx++) {
    if (nx + 1 > f_temp.size(0)) {
      emlrtDynamicBoundsCheckR2012b(nx + 1, 1, f_temp.size(0), &hu_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (nx + 1 > fCurrent.size(0)) {
      emlrtDynamicBoundsCheckR2012b(nx + 1, 1, fCurrent.size(0), &hu_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  if (i < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(i), &pg_emlrtDCI,
                                (emlrtCTX)sp);
  }
  ...
  if (1 > f_temp.size(0)) {
    ...
    if (1 > i) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i, &hu_emlrtBCI, (emlrtCTX)sp);
    }
    if (f_temp.size(0) > i) {
      emlrtDynamicBoundsCheckR2012b(f_temp.size(0), 1, i, &hu_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  iv[0] = r.size(0);
  iv[1] = r1.size(0);
  emlrtSubAssignSizeCheckR2012b(&iv[0], 2, jacobian.size(), 2, &bd_emlrtECI,
                                (emlrtCTX)sp);
  loop_ub = x0.size(0);
  for (i = 0; i < loop_ub; i++) {
    nx = jacobian.size(0);
  ...
  *resnorm = internal::blas::xdot(f_temp.size(0), fCurrent, fCurrent);
  ...
  utils::FiniteDifferences::factoryConstruct(
      &st, &b_this, x0.size(0), f_temp.size(0), t9_FiniteDifferenceType,
      &FiniteDifferences);
  ...
  jacobianFiniteDifference(
      &st, augJacobian, fCurrent, x, t9_FiniteDifferenceType, TypicalX,
  ...
  for (nx = 0; nx < n; nx++) {
    ...
    if ((i < 1) || (i > augJacobian.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, augJacobian.size(0), &hu_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  while ((!exitg1) && (b_exitflag == -5)) {
    ...
    if (hasFiniteBounds) {
      ...
      c_st.site = &jfb_emlrtRSI;
      d_st.site = &kfb_emlrtRSI;
      e_st.site = &lfb_emlrtRSI;
      ...
      xp.set_size(&ue_emlrtRTEI, &i_st, f_temp.size(0));
      nx = f_temp.size(0);
      h_st.site = &mfb_emlrtRSI;
      if ((1 <= f_temp.size(0)) && (f_temp.size(0) > 2147483646)) {
      ...
      for (nx = 0; nx < n; nx++) {
        if (nx + 1 > hasLB.size(0)) {
          emlrtDynamicBoundsCheckR2012b(nx + 1, 1, hasLB.size(0), &hu_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if (hasLB[nx]) {
          if (nx + 1 > x.size(0)) {
            emlrtDynamicBoundsCheckR2012b(nx + 1, 1, x.size(0), &hu_emlrtBCI,
                                          (emlrtCTX)sp);
          }
          emlrtDynamicBoundsCheckR2012b(nx + 1, 1, 0, &iu_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if (nx + 1 > hasUB.size(0)) {
          emlrtDynamicBoundsCheckR2012b(nx + 1, 1, hasUB.size(0), &hu_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if (hasUB[nx]) {
    ...
    if (hasFiniteBounds) {
      ...
      for (nx = 0; nx < n; nx++) {
        ...
        if (indActive[nx]) {
          st.site = &tcb_emlrtRSI;
          if (nx + 1 > n) {
            emlrtDynamicBoundsCheckR2012b(nx + 1, 1, n, &hu_emlrtBCI, &st);
          }
          ...
          if (nx + 1 > dx.size(0)) {
            emlrtDynamicBoundsCheckR2012b(nx + 1, 1, dx.size(0), &hu_emlrtBCI,
                                          (emlrtCTX)sp);
          }
    ...
    reprojectWrapper(&c_st, xp, &fun->workspace.initialParams,
                     fun->workspace.world_points, fun->workspace.image_points,
                     f_temp);
    st.site = &tcb_emlrtRSI;
    ...
    for (nx = 0; nx <= m; nx++) {
      ...
      if (nx + 1 > fNew.size(0)) {
        emlrtDynamicBoundsCheckR2012b(nx + 1, 1, fNew.size(0), &hu_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      fNew[nx] = f_temp[nx];
    }
    ...
    if ((resnormNew < *resnorm) && evalOK) {
      ...
      *resnorm = resnormNew;
      ...
      evalOK = b_jacobianFiniteDifference(
          &st, augJacobian, fCurrent, &funcCount, xp, t9_FiniteDifferenceType,
      ...
      if (1 > m_temp) {
        ...
        if (1 > augJacobian.size(0)) {
          emlrtDynamicBoundsCheckR2012b(1, 1, augJacobian.size(0), &hu_emlrtBCI,
                                        (emlrtCTX)sp);
        }
  ...
  if (hasFiniteBounds) {
    ...
    for (nx = 0; nx < n; nx++) {
      ...
      if (hasLB[nx]) {
        ...
        emlrtDynamicBoundsCheckR2012b(nx + 1, 1, 0, &iu_emlrtBCI, (emlrtCTX)sp);
      }
      if (nx + 1 > hasUB.size(0)) {
        emlrtDynamicBoundsCheckR2012b(nx + 1, 1, hasUB.size(0), &hu_emlrtBCI,
                                      (emlrtCTX)sp);
                     ...
                     ::coder::array<real_T, 1U> &varargout_2)
{
  ...
  covrtLogBasicBlock(&emlrtCoverageInstance, 0, 5);
  c_st.site = &vcb_emlrtRSI;
  reprojectWrapper(&c_st, x, &fun->workspace.initialParams,
                   fun->workspace.world_points, fun->workspace.image_points,
                   varargout_2);
  st.site = &tcb_emlrtRSI;
