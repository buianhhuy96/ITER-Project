...
void bwmorphApplyOnce(const emlrtStack *sp, ::coder::array<boolean_T, 2U> &bw)
{
  ...
  i = bw.size(0);
  if (i < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(i), &bh_emlrtDCI, &st);
  }
  i1 = bw.size(1);
  if (i1 < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(i1), &bh_emlrtDCI, &st);
  }
  m.set_size(&cv_emlrtRTEI, &st, i, i1);
  ...
  emlrtSizeEqCheckNDR2012b(&iv[0], &iv1[0], &be_emlrtECI, (emlrtCTX)sp);
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&dv_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (1 > m.size(0)) {
  ...
  i4 = bw.size(0);
  if (i4 < 0) {
    emlrtDynamicBoundsCheckR2012b(i4, 0, MAX_int32_T, &jw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (1 > bw.size(0)) {
    i4 = 1;
    ...
    i4 = bw.size(0);
    if (1 > i4) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i4, &iw_emlrtBCI, (emlrtCTX)sp);
    }
    i4 = 2;
    i5 = bw.size(0);
    i6 = bw.size(0);
    if ((i6 < 1) || (i6 > i5)) {
      emlrtDynamicBoundsCheckR2012b(i6, 1, i5, &hw_emlrtBCI, (emlrtCTX)sp);
    }
    i5 = i6 - 1;
  }
  i6 = bw.size(1);
  if (i6 < 0) {
    emlrtDynamicBoundsCheckR2012b(i6, 0, MAX_int32_T, &gw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (1 > bw.size(1)) {
    i6 = 1;
    ...
    i6 = bw.size(1);
    if (1 > i6) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i6, &fw_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = 2;
    i7 = bw.size(1);
    i8 = bw.size(1);
    if ((i8 < 1) || (i8 > i7)) {
      emlrtDynamicBoundsCheckR2012b(i8, 1, i7, &ew_emlrtBCI, (emlrtCTX)sp);
    }
    i7 = i8 - 1;
  }
  st.site = &agb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i5, i4);
  r.set_size(&ev_emlrtRTEI, sp, loop_ub + 1);
  for (i5 = 0; i5 <= loop_ub; i5++) {
    r[i5] = i4 * i5;
  }
  st.site = &agb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i7, i6);
  r1.set_size(&fv_emlrtRTEI, sp, loop_ub + 1);
  ...
  iv1[1] = b_loop_ub + 1;
  emlrtSubAssignSizeCheckR2012b(&iv[0], 2, &iv1[0], 2, &ae_emlrtECI,
                                (emlrtCTX)sp);
  ...
  iv1[0] = (*(int32_T(*)[2])m.size())[0];
  iv1[1] = (*(int32_T(*)[2])m.size())[1];
  emlrtSizeEqCheckNDR2012b(&iv[0], &iv1[0], &yd_emlrtECI, (emlrtCTX)sp);
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&gv_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (2 > m.size(0)) {
  ...
  i6 = bw.size(0);
  if (i6 < 0) {
    emlrtDynamicBoundsCheckR2012b(i6, 0, MAX_int32_T, &dw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > bw.size(0)) {
    i6 = 0;
    ...
    i6 = bw.size(0);
    if (2 > i6) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i6, &cw_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = 1;
    i7 = 2;
    i8 = bw.size(0);
    i9 = bw.size(0);
    if ((i9 < 1) || (i9 > i8)) {
      emlrtDynamicBoundsCheckR2012b(i9, 1, i8, &bw_emlrtBCI, (emlrtCTX)sp);
    }
    i8 = i9 - 1;
  }
  i9 = bw.size(1);
  if (i9 < 0) {
    emlrtDynamicBoundsCheckR2012b(i9, 0, MAX_int32_T, &aw_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > bw.size(1)) {
    i9 = 0;
    ...
    i9 = bw.size(1);
    if (2 > i9) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i9, &yv_emlrtBCI, (emlrtCTX)sp);
    }
    i9 = 1;
    i10 = 2;
    i11 = bw.size(1);
    ...
    if ((b_loop_ub < 1) || (b_loop_ub > i11)) {
      emlrtDynamicBoundsCheckR2012b(b_loop_ub, 1, i11, &xv_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i11 = b_loop_ub - 1;
  }
  ...
  r.set_size(&hv_emlrtRTEI, sp, loop_ub + 1);
  for (i8 = 0; i8 <= loop_ub; i8++) {
    r[i8] = i6 + i7 * i8;
  }
  st.site = &yfb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i11 - i9, i10);
  r1.set_size(&iv_emlrtRTEI, sp, loop_ub + 1);
  ...
  iv1[1] = b_loop_ub + 1;
  emlrtSubAssignSizeCheckR2012b(&iv[0], 2, &iv1[0], 2, &xd_emlrtECI,
                                (emlrtCTX)sp);
  ...
  iv1[0] = (*(int32_T(*)[2])m.size())[0];
  iv1[1] = (*(int32_T(*)[2])m.size())[1];
  emlrtSizeEqCheckNDR2012b(&iv[0], &iv1[0], &wd_emlrtECI, (emlrtCTX)sp);
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&jv_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (1 > m.size(0)) {
  ...
  i5 = bw.size(0);
  if (i5 < 0) {
    emlrtDynamicBoundsCheckR2012b(i5, 0, MAX_int32_T, &wv_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (1 > bw.size(0)) {
    i5 = 1;
    ...
    i5 = bw.size(0);
    if (1 > i5) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i5, &vv_emlrtBCI, (emlrtCTX)sp);
    }
    i5 = 2;
    i6 = bw.size(0);
    i7 = bw.size(0);
    if ((i7 < 1) || (i7 > i6)) {
      emlrtDynamicBoundsCheckR2012b(i7, 1, i6, &uv_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = i7 - 1;
  }
  i7 = bw.size(1);
  if (i7 < 0) {
    emlrtDynamicBoundsCheckR2012b(i7, 0, MAX_int32_T, &tv_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > bw.size(1)) {
    i7 = 0;
    ...
    i7 = bw.size(1);
    if (2 > i7) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i7, &sv_emlrtBCI, (emlrtCTX)sp);
    }
    i7 = 1;
    i8 = 2;
    i9 = bw.size(1);
    i10 = bw.size(1);
    if ((i10 < 1) || (i10 > i9)) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, &rv_emlrtBCI, (emlrtCTX)sp);
    }
    i9 = i10 - 1;
  }
  st.site = &xfb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i6, i5);
  r.set_size(&kv_emlrtRTEI, sp, loop_ub + 1);
  for (i6 = 0; i6 <= loop_ub; i6++) {
    r[i6] = i5 * i6;
  }
  st.site = &xfb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i9 - i7, i8);
  r1.set_size(&lv_emlrtRTEI, sp, loop_ub + 1);
  for (i5 = 0; i5 <= loop_ub; i5++) {
    r1[i5] = i7 + i8 * i5;
  }
  iv[0] = r.size(0);
  ...
  iv1[1] = b_loop_ub + 1;
  emlrtSubAssignSizeCheckR2012b(&iv[0], 2, &iv1[0], 2, &vd_emlrtECI,
                                (emlrtCTX)sp);
  for (i1 = 0; i1 <= b_loop_ub; i1++) {
    for (i4 = 0; i4 <= loop_ub; i4++) {
  ...
  iv1[0] = (*(int32_T(*)[2])m.size())[0];
  iv1[1] = (*(int32_T(*)[2])m.size())[1];
  emlrtSizeEqCheckNDR2012b(&iv[0], &iv1[0], &ud_emlrtECI, (emlrtCTX)sp);
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&mv_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (2 > m.size(0)) {
  ...
  i5 = bw.size(0);
  if (i5 < 0) {
    emlrtDynamicBoundsCheckR2012b(i5, 0, MAX_int32_T, &qv_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (2 > bw.size(0)) {
    i5 = 0;
    ...
    i5 = bw.size(0);
    if (2 > i5) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i5, &pv_emlrtBCI, (emlrtCTX)sp);
    }
    i5 = 1;
    i6 = 2;
    i7 = bw.size(0);
    i8 = bw.size(0);
    if ((i8 < 1) || (i8 > i7)) {
      emlrtDynamicBoundsCheckR2012b(i8, 1, i7, &ov_emlrtBCI, (emlrtCTX)sp);
    }
    i7 = i8 - 1;
  }
  i8 = bw.size(1);
  if (i8 < 0) {
    emlrtDynamicBoundsCheckR2012b(i8, 0, MAX_int32_T, &nv_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  if (1 > bw.size(1)) {
    i8 = 1;
    ...
    i8 = bw.size(1);
    if (1 > i8) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i8, &mv_emlrtBCI, (emlrtCTX)sp);
    }
    i8 = 2;
    i9 = bw.size(1);
    i10 = bw.size(1);
    if ((i10 < 1) || (i10 > i9)) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, &lv_emlrtBCI, (emlrtCTX)sp);
    }
    i9 = i10 - 1;
  }
  st.site = &wfb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i7 - i5, i6);
  r.set_size(&nv_emlrtRTEI, sp, loop_ub + 1);
  for (i7 = 0; i7 <= loop_ub; i7++) {
    r[i7] = i5 + i6 * i7;
  }
  st.site = &wfb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i9, i8);
  r1.set_size(&ov_emlrtRTEI, sp, loop_ub + 1);
  for (i5 = 0; i5 <= loop_ub; i5++) {
    r1[i5] = i8 * i5;
  }
  iv[0] = r.size(0);
  ...
  iv1[1] = b_loop_ub + 1;
  emlrtSubAssignSizeCheckR2012b(&iv[0], 2, &iv1[0], 2, &td_emlrtECI,
                                (emlrtCTX)sp);
  for (i2 = 0; i2 <= b_loop_ub; i2++) {
    for (i4 = 0; i4 <= loop_ub; i4++) {
