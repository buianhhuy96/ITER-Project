                  ...
                  ::coder::array<real_T, 2U> &varargout_1)
{
  ...
  b_varargin_2.set_size(&vt_emlrtRTEI, &b_st, 1, 3);
  for (i = 0; i < 3; i++) {
    b_varargin_2[i] = varargin_2[i];
  }
  projectedPoints.set_size(&wt_emlrtRTEI, &b_st, 4, 3);
  for (i = 0; i < 3; i++) {
  ...
  ldb_t = (ptrdiff_t)3;
  ldc_t = (ptrdiff_t)4;
  cameraMatrix.set_size(&eh_emlrtRTEI, &d_st, 4, 3);
  ...
  result.set_size(&wt_emlrtRTEI, &b_st, varargin_3.size(0), 4);
  for (i = 0; i < 3; i++) {
    for (i1 = 0; i1 < k; i1++) {
  ...
  projectedPoints.set_size(&eh_emlrtRTEI, &d_st, result.size(0), 3);
  ...
  b_projectedPoints.set_size(&xt_emlrtRTEI, sp, projectedPoints.size(0), 2);
  for (i = 0; i < 2; i++) {
    for (i1 = 0; i1 < k; i1++) {
  ...
  k = projectedPoints.size(0);
  c_projectedPoints.set_size(&yt_emlrtRTEI, sp, projectedPoints.size(0));
  for (i = 0; i < k; i++) {
  ...
  if (K[1] != 0.0) {
    ...
    c_projectedPoints.set_size(&au_emlrtRTEI, sp, varargout_1.size(0));
    for (i = 0; i < k; i++) {
      c_projectedPoints[i] =
    ...
    k = varargout_1.size(0);
    r.set_size(&bu_emlrtRTEI, sp, varargout_1.size(0));
    for (i = 0; i < k; i++) {
      r[i] = i;
    }
    ...
    c_projectedPoints.set_size(&cu_emlrtRTEI, sp, varargout_1.size(0));
    for (i = 0; i <= k; i++) {
  ...
  b_projectedPoints.set_size(&du_emlrtRTEI, sp, varargout_1.size(0), 2);
