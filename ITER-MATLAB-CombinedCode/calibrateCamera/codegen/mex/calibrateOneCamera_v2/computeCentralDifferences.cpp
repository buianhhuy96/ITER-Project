    ...
    const ::coder::array<real_T, 1U> &c_runTimeOptions_FiniteDifferen)
{
  ...
  while ((!exitg1) && (idx <= obj->nVar - 1)) {
    ...
    i = xk.size(0);
    if ((idx + 1 < 1) || (idx + 1 > i)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &nx_emlrtBCI, &b_st);
    }
    ...
    i = obj->hasLB.size(0);
    if ((idx + 1 < 1) || (idx + 1 > i)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &mx_emlrtBCI, (emlrtCTX)sp);
    }
    guard1 = false;
    guard2 = false;
    if (obj->hasLB[idx]) {
      ...
      i = obj->hasUB.size(0);
      if ((idx + 1 < 1) || (idx + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &mx_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if (obj->hasUB[idx]) {
        guard2 = true;
    ...
    if (guard2) {
      ...
      if (obj->hasLB[idx]) {
        ...
        if (obj->hasUB[idx]) {
          ...
          if ((idx + 1 < 1) || (idx + 1 > 0)) {
            emlrtDynamicBoundsCheckR2012b(idx + 1, 1, 0, &ox_emlrtBCI,
                                          (emlrtCTX)sp);
          }
          formulaType = 0;
        } else {
          ...
          case 0:
            ...
            for (idx_col = 0; idx_col <= ncols; idx_col++) {
              if ((idx_col + 1 < 1) || (idx_col + 1 > 0)) {
                emlrtDynamicBoundsCheckR2012b(idx_col + 1, 1, 0, &px_emlrtBCI,
                                              &st);
              }
              if ((idx + 1 < 1) || (idx + 1 > 0)) {
                emlrtDynamicBoundsCheckR2012b(idx + 1, 1, 0, &qx_emlrtBCI, &st);
              }
            }
            break;
          case 1:
          ...
          case 0:
            ...
            for (idx_col = 0; idx_col <= ncols; idx_col++) {
              ...
              if ((idx_col + 1 < 1) || (idx_col + 1 > i)) {
                emlrtDynamicBoundsCheckR2012b(idx_col + 1, 1, i, &rx_emlrtBCI,
                                              &st);
              }
              i = obj->cEq_2.size(0);
              if ((idx_col + 1 < 1) || (idx_col + 1 > i)) {
              ...
              if ((formulaType < 1) || (formulaType > i)) {
                emlrtDynamicBoundsCheckR2012b(formulaType, 1, i, &rx_emlrtBCI,
                                              &st);
              }
            ...
            for (idx_col = 0; idx_col <= ncols; idx_col++) {
              if ((idx_col + 1 < 1) || (idx_col + 1 > cEqCurrent.size(0))) {
                emlrtDynamicBoundsCheckR2012b(
                    idx_col + 1, 1, cEqCurrent.size(0), &rx_emlrtBCI, &st);
              }
              i = obj->cEq_1.size(0);
              if (idx_col + 1 > i) {
                emlrtDynamicBoundsCheckR2012b(idx_col + 1, 1, i, &rx_emlrtBCI,
