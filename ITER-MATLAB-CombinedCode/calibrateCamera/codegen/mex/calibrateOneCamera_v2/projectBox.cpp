                    ...
                    const ::coder::array<boolean_T, 1U> &hasUB)
{
  ...
  i = dx.size(0);
  if (i < 0) {
    emlrtDynamicBoundsCheckR2012b(i, 0, MAX_int32_T, &ax_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  n = i - 1;
  dxInfNorm = 0.0;
  if (x.size(0) == 0) {
    ...
    for (int32_T b_i{0}; b_i <= n; b_i++) {
      if (b_i + 1 > hasLB.size(0)) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, hasLB.size(0), &bx_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if (b_i + 1 > hasUB.size(0)) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, hasUB.size(0), &bx_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      i = dx.size(0);
      if (b_i + 1 > i) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, i, &bx_emlrtBCI,
                                      (emlrtCTX)sp);
      }
                  ...
                  const ::coder::array<boolean_T, 1U> &hasUB)
{
  ...
  for (int32_T b_i{0}; b_i < i; b_i++) {
    ...
    i1 = dx.size(0);
    if (b_i + 1 > i1) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, i1, &bx_emlrtBCI, (emlrtCTX)sp);
    }
  }
}
