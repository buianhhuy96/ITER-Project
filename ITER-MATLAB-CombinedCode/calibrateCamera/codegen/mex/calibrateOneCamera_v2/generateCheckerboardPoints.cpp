                                ...
                                ::coder::array<real_T, 2U> &worldPoints)
{
  ...
  if (!(d >= 0.0)) {
    emlrtNonNegativeCheckR2012b(d, &lg_emlrtDCI, (emlrtCTX)sp);
  }
  d1 = static_cast<int32_T>(muDoubleScalarFloor(d));
  if (d != d1) {
    emlrtIntegerCheckR2012b(d, &kg_emlrtDCI, (emlrtCTX)sp);
  }
  worldPoints.set_size(&ar_emlrtRTEI, sp, static_cast<int32_T>(d), 2);
  if (d != d1) {
    emlrtIntegerCheckR2012b(d, &mg_emlrtDCI, (emlrtCTX)sp);
  }
  ...
  for (int32_T j{0}; j < i; j++) {
    ...
    for (int32_T b_i{0}; b_i < k; b_i++) {
      ...
      if ((i1 < 1) || (i1 > worldPoints.size(0))) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, worldPoints.size(0), &gt_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      worldPoints[i1 - 1] = static_cast<real_T>(j) * squareSize;
      if (i1 > worldPoints.size(0)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, worldPoints.size(0), &ht_emlrtBCI,
                                      (emlrtCTX)sp);
      }
