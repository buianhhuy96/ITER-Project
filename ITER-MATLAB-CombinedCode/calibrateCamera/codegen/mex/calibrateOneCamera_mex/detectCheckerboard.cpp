                                  ...
                                  const ::coder::array<real32_T, 2U> &b_I)
{
  ...
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &gq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(1);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &hq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &iq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &jq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(1);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &kq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (1 > i) {
  ...
  i = b_this->BoardCoords.size(0);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &mq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(1);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &nq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &oq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &pq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(1);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &qq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &rq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (1 > i) {
  ...
  i = b_this->BoardCoords.size(1);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &tq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &uq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (1 > i) {
  ...
  i = b_this->BoardCoords.size(1);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &wq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &xq_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (2 > i) {
  ...
  i = b_this->BoardCoords.size(1);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &ar_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (2 > i) {
  ...
  i = b_this->BoardCoords.size(1);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &dr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (2 > i) {
  ...
  i = b_this->BoardCoords.size(0);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &fr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(1);
  if (2 > i) {
  ...
  i = b_this->BoardCoords.size(0);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &ir_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(1);
  if (3 > i) {
    emlrtDynamicBoundsCheckR2012b(3, 1, i, &jr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &kr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &lr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(1);
  if (3 > i) {
    emlrtDynamicBoundsCheckR2012b(3, 1, i, &mr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &nr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &or_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(1);
  if (2 > i) {
  ...
  i = b_this->BoardCoords.size(2);
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &qr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (1 > i) {
  ...
  i = b_this->BoardCoords.size(1);
  if (3 > i) {
    emlrtDynamicBoundsCheckR2012b(3, 1, i, &vr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (2 > i) {
  ...
  i = b_this->BoardCoords.size(1);
  if (3 > i) {
    emlrtDynamicBoundsCheckR2012b(3, 1, i, &yr_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(2);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &as_emlrtBCI, (emlrtCTX)sp);
  }
  i = b_this->BoardCoords.size(0);
  if (2 > i) {
  ...
  i = b_this->BoardCoords.size(2);
  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &ds_emlrtBCI, (emlrtCTX)sp);
  }
  ...
  b_iv[0] = (*(int32_T(*)[2])((::coder::array<real32_T, 2U> *)&b_I)->size())[0];
  b_iv[1] = (*(int32_T(*)[2])((::coder::array<real32_T, 2U> *)&b_I)->size())[1];
  iv1[0] = (*(int32_T(*)[2])upperLeftMask.size())[0];
  iv1[1] = (*(int32_T(*)[2])upperLeftMask.size())[1];
  st.site = &kq_emlrtRSI;
  ::Codegen::coder::internal::indexShapeCheck(&st, b_iv, iv1);
  b_iv[0] = (*(int32_T(*)[2])((::coder::array<real32_T, 2U> *)&b_I)->size())[0];
  b_iv[1] = (*(int32_T(*)[2])((::coder::array<real32_T, 2U> *)&b_I)->size())[1];
  ...
  r.set_size(&ro_emlrtRTEI, sp, trueCount);
  trueCount = 0;
  for (i = 0; i <= end; i++) {
    if (upperLeftMask[i]) {
      r[trueCount] = i + 1;
  ...
  r1.set_size(&ro_emlrtRTEI, sp, trueCount);
  trueCount = 0;
  for (i = 0; i <= end; i++) {
    if (nextSquareMask[i]) {
      r1[trueCount] = i + 1;
  ...
  c_I.set_size(&so_emlrtRTEI, &st, r.size(0));
  end = r.size(0);
  for (i = 0; i < end; i++) {
    if ((r[i] < 1) || (r[i] > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(r[i], 1, trueCount, &es_emlrtBCI, &st);
    }
    c_I[i] = b_I[r[i] - 1];
  }
  ...
  st.site = &kq_emlrtRSI;
  trueCount = b_I.size(0) * b_I.size(1);
  c_I.set_size(&to_emlrtRTEI, &st, r1.size(0));
  end = r1.size(0);
  for (i = 0; i < end; i++) {
    if ((r1[i] < 1) || (r1[i] > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(r1[i], 1, trueCount, &fs_emlrtBCI, &st);
    }
    c_I[i] = b_I[r1[i] - 1];
  }
  b_st.site = &kq_emlrtRSI;
                          ...
                          ::coder::array<boolean_T, 2U> &mask)
{
  ...
  mask.set_size(&uo_emlrtRTEI, sp, static_cast<int32_T>(height),
  ...
  if (Y[1] > Y[2]) {
    ...
    if ((static_cast<int32_T>(Y[1]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(Y[1]), 1,
                                    static_cast<int32_T>(height), &gs_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    if ((static_cast<int32_T>(Y[2]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(Y[2]), 1,
                                    static_cast<int32_T>(height), &hs_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  if (b_X[1] > b_X[2]) {
    ...
    if ((static_cast<int32_T>(b_X[1]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_X[1]), 1,
                                    static_cast<int32_T>(width), &is_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    if ((static_cast<int32_T>(b_X[2]) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_X[2]), 1,
                                    static_cast<int32_T>(width), &js_emlrtBCI,
                                    (emlrtCTX)sp);
    }
                        ...
                        ::coder::array<real_T, 2U> &points, real_T boardSize[2])
{
  ...
  if ((b_I.size(0) == 0) || (b_I.size(1) == 0)) {
    Ig.set_size(&ed_emlrtRTEI, &b_st, b_I.size(0), b_I.size(1));
    ...
    Ig.set_size(&de_emlrtRTEI, &e_st, b_I.size(0), b_I.size(1));
    if (!tooBig) {
      padSizeT[0] = a.size(0);
      startT[0] = 15.0;
      padSizeT[1] = a.size(1);
  ...
  Iy.set_size(&fd_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  ...
  b_imfilter(&b_st, Ig);
  Ixy.set_size(&gd_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  loop_ub = Ig.size(0) * Ig.size(1);
  for (i = 0; i < loop_ub; i++) {
    Ixy[i] = Ig[i];
  }
  ...
  imfilter(&b_st, Ixy);
  r.set_size(&hd_emlrtRTEI, &st, Ig.size(0), Ig.size(1));
  loop_ub = Ig.size(0) * Ig.size(1);
  for (i = 0; i < loop_ub; i++) {
    r[i] = Ig[i] * 0.707106769F;
  }
  I_45.set_size(&id_emlrtRTEI, &st, Iy.size(0), Iy.size(1));
  ...
  emlrtSizeEqCheckNDR2012b(&b_iv[0], &iv1[0], &b_emlrtECI, &st);
  loop_ub = r.size(0) * r.size(1);
  I_45.set_size(&jd_emlrtRTEI, &st, r.size(0), r.size(1));
  for (i = 0; i < loop_ub; i++) {
    I_45[i] = r[i] + I_45[i];
  }
  r1.set_size(&kd_emlrtRTEI, &st, Iy.size(0), Iy.size(1));
  loop_ub = Iy.size(0) * Iy.size(1);
  for (i = 0; i < loop_ub; i++) {
  ...
  emlrtSizeEqCheckNDR2012b(&b_iv[0], &iv1[0], &c_emlrtECI, &st);
  I_45_x.set_size(&ld_emlrtRTEI, &st, I_45.size(0), I_45.size(1));
  ...
  a.set_size(&md_emlrtRTEI, &st, I_45.size(0), I_45.size(1));
  loop_ub = I_45.size(0) * I_45.size(1);
  for (i = 0; i < loop_ub; i++) {
    a[i] = I_45[i];
  }
  ...
  b_abs(&b_st, I_45, a);
  I_45.set_size(&nd_emlrtRTEI, &st, r.size(0), r.size(1));
  loop_ub = r.size(0) * r.size(1);
  for (i = 0; i < loop_ub; i++) {
    I_45[i] = r[i] + r1[i];
  }
  ...
  cxy.set_size(&od_emlrtRTEI, &st, b.size(0), b.size(1));
  loop_ub = b.size(0) * b.size(1);
  for (i = 0; i < loop_ub; i++) {
    cxy[i] = b[i] - a[i];
  }
  ...
  r2.set_size(&pd_emlrtRTEI, &st, trueCount);
  trueCount = 0;
  for (loop_ub = 0; loop_ub <= end; loop_ub++) {
    if (b[loop_ub] - a[loop_ub] < 0.0F) {
  ...
  for (i = 0; i < loop_ub; i++) {
    if ((r2[i] < 1) || (r2[i] > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(r2[i], 1, trueCount, &y_emlrtBCI, &st);
    }
    cxy[r2[i] - 1] = 0.0F;
  }
  ...
  r3.set_size(&pd_emlrtRTEI, &st, trueCount);
  trueCount = 0;
  for (loop_ub = 0; loop_ub <= end; loop_ub++) {
    if (b[loop_ub] < 0.0F) {
  ...
  for (i = 0; i <= loop_ub; i++) {
    if ((r3[i] < 1) || (r3[i] > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(r3[i], 1, trueCount, &ab_emlrtBCI, &st);
    }
    b[r3[i] - 1] = 0.0F;
  }
  st.site = &cb_emlrtRSI;
  ...
  b_points0.set_size(&qd_emlrtRTEI, &st, points0.size(0));
  for (i = 0; i < loop_ub; i++) {
    b_points0[i] = points0[i + points0.size(0)];
  }
  loop_ub = points0.size(0);
  c_points0.set_size(&rd_emlrtRTEI, &st, points0.size(0));
  for (i = 0; i < loop_ub; i++) {
  ...
  s.set_size(&sd_emlrtRTEI, &st, r2.size(0));
  loop_ub = r2.size(0);
  for (i = 0; i < loop_ub; i++) {
    s[i] = r2[i];
  }
  ...
  b_iv[1] = (*(int32_T(*)[2])cxy.size())[1];
  st.site = &eb_emlrtRSI;
  ::Codegen::coder::internal::indexShapeCheck(&st, b_iv, s.size(0));
  trueCount = cxy.size(0) * cxy.size(1);
  loop_ub = s.size(0);
  for (i = 0; i < loop_ub; i++) {
    end = static_cast<int32_T>(s[i]);
    if ((end < 1) || (end > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(end, 1, trueCount, &bb_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  }
  b_points0.set_size(&td_emlrtRTEI, sp, s.size(0));
  loop_ub = s.size(0);
  for (i = 0; i < loop_ub; i++) {
  ...
  points.set_size(&ud_emlrtRTEI, sp, 0, 0);
  boardSize[0] = 0.0;
  boardSize[1] = 0.0;
  st.site = &fb_emlrtRSI;
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    if ((end < 1) || (end > trueCount)) {
      emlrtDynamicBoundsCheckR2012b(end, 1, trueCount, &cb_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  }
                               ...
                               real_T theta, Checkerboard *iobj_0)
{
  ...
  if (scores.size(0) == 0) {
    ...
    board = &iobj_0[0];
    iobj_0[0].BoardIdx.set_size(&ue_emlrtRTEI, &st, 1, 1);
    iobj_0[0].BoardIdx[0] = 0.0;
    iobj_0[0].BoardIdx.set_size(&ve_emlrtRTEI, &st, 3, 3);
    for (i = 0; i < 9; i++) {
      iobj_0[0].BoardIdx[i] = 0.0;
    }
    iobj_0[0].BoardCoords.set_size(&we_emlrtRTEI, &st, 1, 1, 1);
    iobj_0[0].BoardCoords[0] = 0.0;
    iobj_0[0].BoardCoords.set_size(&xe_emlrtRTEI, &st, 3, 3, 2);
    for (i = 0; i < 18; i++) {
      iobj_0[0].BoardCoords[i] = 0.0;
    }
    iobj_0[0].Points.set_size(&ye_emlrtRTEI, &st, 1, 1);
    iobj_0[0].Points[0] = 0.0F;
    iobj_0[0].Points.set_size(&af_emlrtRTEI, &st, 0, 2);
  } else {
    int32_T a;
    int32_T i;
    int32_T sgn2;
    if (points.size(0) < 1) {
      seedIdx.set_size(&qe_emlrtRTEI, sp, 1, 0);
    } else {
      seedIdx.set_size(&qe_emlrtRTEI, sp, 1, points.size(0));
    ...
    st.site = &ve_emlrtRSI;
    ::Codegen::coder::internal::indexShapeCheck(&st, scores.size(0), b_iv);
    st.site = &ve_emlrtRSI;
    sgn2 = seedIdx.size(1);
    for (i = 0; i < sgn2; i++) {
      ...
      if (a > scores.size(0)) {
        emlrtDynamicBoundsCheckR2012b(a, 1, scores.size(0), &xb_emlrtBCI, &st);
      }
    }
    x.set_size(&re_emlrtRTEI, &st, seedIdx.size(1));
    sgn2 = seedIdx.size(1);
    for (i = 0; i < sgn2; i++) {
    ...
    b_iv[1] = (*(int32_T(*)[2])seedIdx.size())[1];
    st.site = &we_emlrtRSI;
    ::Codegen::coder::internal::b_indexShapeCheck(&st, b_iv, iidx.size(0));
    b_seedIdx.set_size(&se_emlrtRTEI, sp, 1, iidx.size(0));
    sgn2 = iidx.size(0);
    for (i = 0; i < sgn2; i++) {
      if ((iidx[i] < 1) || (iidx[i] > seedIdx.size(1))) {
        emlrtDynamicBoundsCheckR2012b(iidx[i], 1, seedIdx.size(1), &yb_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      b_seedIdx[i] = static_cast<uint32_T>(seedIdx[iidx[i] - 1]);
    }
    seedIdx.set_size(&se_emlrtRTEI, sp, 1, b_seedIdx.size(1));
    ...
    if (iidx.size(0) > 2000) {
      ...
      if (1 > sgn2) {
        ...
        if (1 > seedIdx.size(1)) {
          emlrtDynamicBoundsCheckR2012b(1, 1, seedIdx.size(1), &wb_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        if (sgn2 > seedIdx.size(1)) {
          emlrtDynamicBoundsCheckR2012b(sgn2, 1, seedIdx.size(1), &vb_emlrtBCI,
                                        (emlrtCTX)sp);
        }
      }
      for (i = 0; i < sgn2; i++) {
      ...
      seedIdx.set_size(&te_emlrtRTEI, sp, 1, sgn2);
    }
    st.site = &xe_emlrtRSI;
    ...
    for (int32_T b_i{0}; b_i < i; b_i++) {
      ...
      if (b_i + 1 > seedIdx.size(1)) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, seedIdx.size(1), &ac_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      a = static_cast<int32_T>(static_cast<uint32_T>(seedIdx[b_i]));
      if (a > points.size(0)) {
        emlrtDynamicBoundsCheckR2012b(a, 1, points.size(0), &ub_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      st.site = &af_emlrtRSI;
      d = seedIdx[b_i];
      a = static_cast<int32_T>(
          points[(static_cast<int32_T>(static_cast<uint32_T>(d)) +
                 ...
                 1]);
      if ((a < 1) || (a > Ix2.size(0))) {
        emlrtDynamicBoundsCheckR2012b(a, 1, Ix2.size(0), &bc_emlrtBCI, &st);
      }
      sgn2 = static_cast<int32_T>(
          points[static_cast<int32_T>(static_cast<uint32_T>(d)) - 1]);
      if ((sgn2 < 1) || (sgn2 > Ix2.size(1))) {
        emlrtDynamicBoundsCheckR2012b(sgn2, 1, Ix2.size(1), &cc_emlrtBCI, &st);
      }
      b_a = Ix2[(static_cast<int32_T>(static_cast<real32_T>(a)) +
                ...
                1];
      if (a > Ixy.size(0)) {
        emlrtDynamicBoundsCheckR2012b(a, 1, Ixy.size(0), &dc_emlrtBCI, &st);
      }
      if (sgn2 > Ixy.size(1)) {
        emlrtDynamicBoundsCheckR2012b(sgn2, 1, Ixy.size(1), &ec_emlrtBCI, &st);
      }
      b = Ixy[(static_cast<int32_T>(static_cast<real32_T>(a)) +
              ...
              1];
      if (a > Iy2.size(0)) {
        emlrtDynamicBoundsCheckR2012b(a, 1, Iy2.size(0), &fc_emlrtBCI, &st);
      }
      if (sgn2 > Iy2.size(1)) {
        emlrtDynamicBoundsCheckR2012b(sgn2, 1, Iy2.size(1), &gc_emlrtBCI, &st);
      }
                     ...
                     const ::coder::array<real32_T, 2U> &b_I)
{
  ...
  if (!muSingleScalarIsInf(x)) {
    ...
    if (b_board->BoardCoords.size(0) < b_board->BoardCoords.size(1)) {
      st.site = &jp_emlrtRSI;
      c_board.set_size(&co_emlrtRTEI, &st, b_board->BoardIdx.size(0),
      ...
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &op_emlrtBCI, &st);
      }
      loop_ub = b_board->BoardCoords.size(0);
      npages = b_board->BoardCoords.size(1);
      c_board.set_size(&do_emlrtRTEI, &st, loop_ub, npages);
      for (i = 0; i < npages; i++) {
        for (i1 = 0; i1 < loop_ub; i1++) {
      ...
      i = b_board->BoardCoords.size(2);
      if (2 > i) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &np_emlrtBCI, &st);
      }
      loop_ub = b_board->BoardCoords.size(0);
      npages = b_board->BoardCoords.size(1);
      c_board.set_size(&eo_emlrtRTEI, &st, loop_ub, npages);
      for (i = 0; i < npages; i++) {
        for (i1 = 0; i1 < loop_ub; i1++) {
          c_board[i1 + c_board.size(0) * i] =
              b_board->BoardCoords[(i1 + b_board->BoardCoords.size(0) * i) +
      ...
      b_board->BoardCoords.set_size(&fo_emlrtRTEI, &st, r.size(0), r.size(1),
                                    2);
    ...
    st.site = &kp_emlrtRSI;
    newBoardCoords1.set_size(&go_emlrtRTEI, &st, b_board->BoardIdx.size(0),
                             b_board->BoardIdx.size(1));
    ...
    y.set_size(&ho_emlrtRTEI, &b_st, 1, newBoardCoords1.size(1));
    ...
    if (::Codegen::coder::internal::ifWhileCond(&st, y)) {
      ...
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &tp_emlrtBCI, &st);
      }
      i = b_board->BoardIdx.size(1);
      if (1 > i) {
      ...
      i = b_board->BoardIdx.size(0);
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &rp_emlrtBCI, &st);
      }
      cornerIdx[0] = b_board->BoardIdx[0];
      i = b_board->BoardIdx.size(0);
      i1 = b_board->BoardIdx.size(0);
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &bq_emlrtBCI, &st);
      }
      cornerIdx[1] = b_board->BoardIdx[i1 - 1];
      i = b_board->BoardIdx.size(0);
      i1 = b_board->BoardIdx.size(0);
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &cq_emlrtBCI, &st);
      }
      i = b_board->BoardIdx.size(1);
      npages = b_board->BoardIdx.size(1);
      if ((npages < 1) || (npages > i)) {
        emlrtDynamicBoundsCheckR2012b(npages, 1, i, &cq_emlrtBCI, &st);
      }
      cornerIdx[2] =
          b_board
      ...
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &dq_emlrtBCI, &st);
      }
      ...
      if (::Codegen::coder::internal::ifWhileCond(&st, c_numRot_data)) {
        ...
        if (i2 != 0) {
          st.site = &rp_emlrtRSI;
          newBoardCoords1.set_size(&io_emlrtRTEI, &st,
          ...
          b_board->BoardIdx.set_size(&jo_emlrtRTEI, &st,
          ...
          i = b_board->BoardCoords.size(2);
          if (1 > i) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i, &qp_emlrtBCI, &st);
          }
          loop_ub = b_board->BoardCoords.size(0);
          npages = b_board->BoardCoords.size(1);
          newBoardCoords1.set_size(&ko_emlrtRTEI, &st, loop_ub, npages);
          for (i = 0; i < npages; i++) {
            for (i1 = 0; i1 < loop_ub; i1++) {
          ...
          i = b_board->BoardCoords.size(2);
          if (2 > i) {
            emlrtDynamicBoundsCheckR2012b(2, 1, i, &pp_emlrtBCI, &st);
          }
          loop_ub = b_board->BoardCoords.size(0);
          npages = b_board->BoardCoords.size(1);
          newBoardCoords2.set_size(&lo_emlrtRTEI, &st, loop_ub, npages);
          for (i = 0; i < npages; i++) {
            for (i1 = 0; i1 < loop_ub; i1++) {
          ...
          cat(&b_st, newBoardCoords1, newBoardCoords2, r);
          b_board->BoardCoords.set_size(&mo_emlrtRTEI, &st, r.size(0),
                                        r.size(1), 2);
          loop_ub = r.size(0) * r.size(1) * 2;
          for (i = 0; i < loop_ub; i++) {
            b_board->BoardCoords[i] = r[i];
    ...
    if ((i2 == 0) == (npages == 0)) {
      ...
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &yp_emlrtBCI, (emlrtCTX)sp);
      }
      loop_ub = b_board->BoardCoords.size(2);
      r1.set_size(&no_emlrtRTEI, sp, 1, 1, loop_ub);
      for (i = 0; i < loop_ub; i++) {
      ...
      npages = b_board->BoardCoords.size(0);
      if ((npages < 1) || (npages > i)) {
        emlrtDynamicBoundsCheckR2012b(npages, 1, i, &xp_emlrtBCI, (emlrtCTX)sp);
      }
      i = b_board->BoardCoords.size(1);
      i2 = b_board->BoardCoords.size(1);
      if ((i2 < 1) || (i2 > i)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, i, &wp_emlrtBCI, (emlrtCTX)sp);
      }
      loop_ub = b_board->BoardCoords.size(2);
      r2.set_size(&oo_emlrtRTEI, sp, 1, 1, loop_ub);
      for (i = 0; i < loop_ub; i++) {
      ...
      emlrtSizeEqCheckNDR2012b(&b_iv[0], &iv1[0], &uc_emlrtECI, (emlrtCTX)sp);
      r3.set_size(&no_emlrtRTEI, sp, 1, 1, r1.size(2));
      loop_ub = r1.size(2);
      for (i = 0; i < loop_ub; i++) {
        r3[i] = (r1[i] > r2[i]);
      }
      ...
      if (c_any(&st, r3)) {
        i = b_board->BoardCoords.size(2);
        if (1 > i) {
          emlrtDynamicBoundsCheckR2012b(1, 1, i, &vp_emlrtBCI, (emlrtCTX)sp);
        }
        i = b_board->BoardCoords.size(0);
        i1 = b_board->BoardCoords.size(0);
        if ((i1 < 1) || (i1 > i)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, i, &eq_emlrtBCI, (emlrtCTX)sp);
        }
        i = b_board->BoardCoords.size(1);
        npages = b_board->BoardCoords.size(1);
        if ((npages < 1) || (npages > i)) {
          emlrtDynamicBoundsCheckR2012b(npages, 1, i, &fq_emlrtBCI,
                                        (emlrtCTX)sp);
        }
        ...
        if (numRot_data != 0.0) {
          ...
          b_st.site = &yp_emlrtRSI;
          cat(&b_st, newBoardCoords1, newBoardCoords2, r);
          b_board->BoardCoords.set_size(&fo_emlrtRTEI, &st, r.size(0),
                                        r.size(1), 2);
          loop_ub = r.size(0) * r.size(1) * 2;
          for (i = 0; i < loop_ub; i++) {
            b_board->BoardCoords[i] = r[i];
              ...
              ::coder::array<real_T, 2U> &points, real_T boardSize[2])
{
  ...
  d_this.set_size(&wo_emlrtRTEI, sp, c_this);
  for (i = 0; i < c_this; i++) {
    d_this[i] = (b_this->BoardIdx[i] == 0.0);
  }
  st.site = &er_emlrtRSI;
  if (any(&st, d_this)) {
    points.set_size(&bp_emlrtRTEI, sp, 0, 0);
    boardSize[0] = 0.0;
    boardSize[1] = 0.0;
  } else {
    real_T numPoints;
    ...
    points.set_size(&xo_emlrtRTEI, sp, static_cast<int32_T>(numPoints), 2);
    if (numPoints != static_cast<int32_T>(numPoints)) {
    ...
    i = b_this->BoardCoords.size(2);
    if (1 > i) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i, &ks_emlrtBCI, (emlrtCTX)sp);
    }
    c_this = b_this->BoardCoords.size(0);
    loop_ub = b_this->BoardCoords.size(1);
    x.set_size(&yo_emlrtRTEI, sp, loop_ub, c_this);
    for (i = 0; i < c_this; i++) {
      for (i1 = 0; i1 < loop_ub; i1++) {
        x[i1 + x.size(0) * i] =
    ...
    emlrtSubAssignSizeCheckR2012b(&c_this, 1, &loop_ub, 1, &vc_emlrtECI,
                                  (emlrtCTX)sp);
    loop_ub = x.size(0) * x.size(1);
    for (i = 0; i < loop_ub; i++) {
      points[i] = x[i];
    ...
    i = b_this->BoardCoords.size(2);
    if (2 > i) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i, &ls_emlrtBCI, (emlrtCTX)sp);
    }
    c_this = b_this->BoardCoords.size(0);
    loop_ub = b_this->BoardCoords.size(1);
    x.set_size(&ap_emlrtRTEI, sp, loop_ub, c_this);
    for (i = 0; i < c_this; i++) {
      for (i1 = 0; i1 < loop_ub; i1++) {
        x[i1 + x.size(0) * i] =
            b_this->BoardCoords[(i + b_this->BoardCoords.size(0) * i1) +
    ...
    loop_ub = x.size(0) * x.size(1);
    emlrtSubAssignSizeCheckR2012b(points.size(), 1, &loop_ub, 1, &wc_emlrtECI,
                                  (emlrtCTX)sp);
    loop_ub = x.size(0) * x.size(1);
    for (i = 0; i < loop_ub; i++) {
