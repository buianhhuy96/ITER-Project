    ...
    const ::coder::array<real_T, 1U> &c_runTimeOptions_FiniteDifferen)
{
  ...
  if (obj->isEmptyNonlcon) {
    ...
    while ((!exitg1) && (idx <= obj->nVar - 1)) {
      ...
      i = xk.size(0);
      if ((idx + 1 < 1) || (idx + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &tv_emlrtBCI, &c_st);
      }
      if ((idx + 1 < 1) ||
      ...
      if ((idx + 1 < 1) || (idx + 1 > runTimeOptions_TypicalX.size(0))) {
        emlrtDynamicBoundsCheckR2012b(
            idx + 1, 1, runTimeOptions_TypicalX.size(0), &tv_emlrtBCI, &c_st);
      }
      i = xk.size(0);
      if ((idx + 1 < 1) || (idx + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &tv_emlrtBCI, &c_st);
      ...
      i = obj->hasLB.size(0);
      if ((idx + 1 < 1) || (idx + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &rv_emlrtBCI, &st);
      }
      i = obj->hasUB.size(0);
      if ((idx + 1 < 1) || (idx + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &rv_emlrtBCI, &st);
      ...
      if (guard1) {
        ...
        for (int32_T ncols{0}; ncols < formulaType; ncols++) {
          ...
          if ((ncols + 1 < 1) || (ncols + 1 > i)) {
            emlrtDynamicBoundsCheckR2012b(ncols + 1, 1, i, &rv_emlrtBCI, &st);
          }
          ...
          i1 = (idx + ldJE * ncols) + 1;
          if ((i1 < 1) || (i1 > i)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, i, &rv_emlrtBCI, &st);
          }
          JacCeqTrans[i1 - 1] =
    ...
    while ((!exitg1) && (idx <= obj->nVar - 1)) {
      ...
      if ((idx + 1 < 1) || (idx + 1 > runTimeOptions_TypicalX.size(0))) {
        emlrtDynamicBoundsCheckR2012b(
            idx + 1, 1, runTimeOptions_TypicalX.size(0), &sv_emlrtBCI, &c_st);
      }
      i = xk.size(0);
      if ((idx + 1 < 1) || (idx + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &sv_emlrtBCI, &c_st);
      }
      deltaX = 1.4901161193847656E-8 *
               muDoubleScalarMax(muDoubleScalarAbs(xk[idx]), 1.0);
      i = obj->hasLB.size(0);
      if ((idx + 1 < 1) || (idx + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &qv_emlrtBCI, &st);
      }
      i = obj->hasUB.size(0);
      if ((idx + 1 < 1) || (idx + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &qv_emlrtBCI, &st);
        ...
        if (obj->mEq > 0) {
          ...
          case 0: {
            ...
            for (formulaType = 0; formulaType <= ncols; formulaType++) {
              ...
              if ((i1 < 1) || (i1 > i)) {
                emlrtDynamicBoundsCheckR2012b(i1, 1, i, &uv_emlrtBCI, &b_st);
              }
              JacCeqTrans[i1 - 1] =
