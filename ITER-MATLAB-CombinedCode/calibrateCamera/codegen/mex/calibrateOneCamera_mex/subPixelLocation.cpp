                      ...
                      ::coder::array<real_T, 2U> &loc)
{
  ...
  for (int32_T id{0}; id < i; id++) {
    ...
    i1 = loc.size(0);
    if ((id + 1 < 1) || (id + 1 > i1)) {
      emlrtDynamicBoundsCheckR2012b(id + 1, 1, i1, &dv_emlrtBCI, (emlrtCTX)sp);
    }
    st.site = &fr_emlrtRSI;
    i1 = loc.size(0);
    if ((id + 1 < 1) || (id + 1 > i1)) {
      emlrtDynamicBoundsCheckR2012b(id + 1, 1, i1, &cv_emlrtBCI, &st);
    }
    loop_ub = loc.size(1);
    ...
    if (any(&b_st, loc_data)) {
      ...
      i1 = loc.size(1);
      if (1 > i1) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i1, &ev_emlrtBCI, &st);
      }
      if (loc[id] > (static_cast<real_T>(metric.size(1)) - 2.0) - 1.0) {
        ...
        if (loc[id + loc.size(0)] >
          ...
          i1 = loc.size(1);
          if (2 > i1) {
            emlrtDynamicBoundsCheckR2012b(2, 1, i1, &gv_emlrtBCI, &st);
          }
          i1 = loc.size(1);
          if (2 > i1) {
            emlrtDynamicBoundsCheckR2012b(2, 1, i1, &hv_emlrtBCI, &st);
          }
          if (loc[id + loc.size(0)] - 2.0 > loc[id + loc.size(0)] + 2.0) {
            ...
            if ((static_cast<int32_T>(d) < 1) ||
                (static_cast<int32_T>(d) > metric.size(0))) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(d), 1,
                                            metric.size(0), &jv_emlrtBCI, &st);
            }
            i2 = static_cast<int32_T>(d) - 1;
          }
          i3 = loc.size(1);
          if (1 > i3) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i3, &kv_emlrtBCI, &st);
          }
          i3 = loc.size(1);
          if (1 > i3) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i3, &lv_emlrtBCI, &st);
          }
          if (loc[id] - 2.0 > loc[id] + 2.0) {
            ...
            if ((static_cast<int32_T>(d) < 1) ||
              ...
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(d), 1,
                                            metric.size(1), &mv_emlrtBCI, &st);
            }
            i3 = static_cast<int32_T>(d) - 2;
            d = loc[id] + 2.0;
            if (d != static_cast<int32_T>(muDoubleScalarFloor(d))) {
              emlrtIntegerCheckR2012b(d, &rd_emlrtDCI, &st);
            }
            if ((static_cast<int32_T>(d) < 1) ||
                (static_cast<int32_T>(d) > metric.size(1))) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(d), 1,
                                            metric.size(1), &nv_emlrtBCI, &st);
            }
          ...
          b_metric.set_size(&ps_emlrtRTEI, &b_st, loop_ub, b_loop_ub);
          ...
          b_iv[0] = 1;
          b_iv[1] = 2;
          emlrtSizeEqCheckNDR2012b(&loc_size[0], &b_iv[0], &be_emlrtECI, &st);
          loop_ub = 2;
    ...
    b_iv[0] = 1;
    b_iv[1] = loc.size(1);
    emlrtSubAssignSizeCheckR2012b(&b_iv[0], 2, &loc_size[0], 2, &ae_emlrtECI,
                                  (emlrtCTX)sp);
    for (i1 = 0; i1 < loop_ub; i1++) {
