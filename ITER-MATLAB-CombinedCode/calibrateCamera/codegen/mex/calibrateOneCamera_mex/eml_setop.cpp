                ...
                int32_T *ib_size)
{
  ...
  na = a.size(1);
  c.set_size(&yj_emlrtRTEI, sp, 1, a.size(1));
  ia.set_size(&ak_emlrtRTEI, sp, a.size(1));
  *ib_size = 0;
  st.site = &hm_emlrtRSI;
  ...
  if (a.size(1) > 0) {
    ...
    ia.set_size(&dk_emlrtRTEI, sp, na);
  }
  st.site = &nm_emlrtRSI;
  b_st.site = &ef_emlrtRSI;
  internal::sort(&b_st, ia, sbb_emlrtRSI);
  st.site = &om_emlrtRSI;
  ...
  if (a.size(1) > 0) {
    ...
    c.set_size(&ek_emlrtRTEI, sp, c.size(0), nc);
  }
                ...
                int32_T *ib_size)
{
  ...
  *ib_size = 0;
  ...
  st.site = &im_emlrtRSI;
  n = b.size(0) + 1;
  bperm.set_size(&bk_emlrtRTEI, &st, b.size(0));
  i = b.size(0);
  for (b_i = 0; b_i < i; b_i++) {
    bperm[b_i] = 0;
  }
  if (b.size(0) != 0) {
    ...
    iwork.set_size(&ck_emlrtRTEI, &b_st, b.size(0));
    i = b.size(0) - 1;
  ...
  if (a.size(1) > 0) {
    ...
    ia.set_size(&dk_emlrtRTEI, sp, b_i);
  }
  st.site = &nm_emlrtRSI;
  b_st.site = &ef_emlrtRSI;
  internal::sort(&b_st, ia, sbb_emlrtRSI);
