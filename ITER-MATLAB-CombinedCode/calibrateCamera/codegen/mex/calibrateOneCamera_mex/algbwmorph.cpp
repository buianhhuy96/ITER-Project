...
void bwmorphApplyOnce(const emlrtStack *sp, ::coder::array<boolean_T, 2U> &bw)
{
  ...
  st.site = &ee_emlrtRSI;
  m.set_size(&es_emlrtRTEI, &st, bw.size(0), bw.size(1));
  ...
  emlrtSizeEqCheckNDR2012b(&b_iv[0], &iv1[0], &yd_emlrtECI, (emlrtCTX)sp);
  ...
  if (1 > bw.size(0)) {
    ...
    i4 = bw.size(0);
    if (1 > i4) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i4, &bv_emlrtBCI, (emlrtCTX)sp);
    }
    i4 = 2;
    i6 = bw.size(0);
    i5 = bw.size(0);
    if ((i5 < 1) || (i5 > i6)) {
      emlrtDynamicBoundsCheckR2012b(i5, 1, i6, &av_emlrtBCI, (emlrtCTX)sp);
    }
  }
  if (1 > bw.size(1)) {
    i6 = 1;
    ...
    i6 = bw.size(1);
    if (1 > i6) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i6, &yu_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = 2;
    i8 = bw.size(1);
    i7 = bw.size(1);
    if ((i7 < 1) || (i7 > i8)) {
      emlrtDynamicBoundsCheckR2012b(i7, 1, i8, &xu_emlrtBCI, (emlrtCTX)sp);
    }
  }
  st.site = &rbb_emlrtRSI;
  b_iv[0] = div_s32_floor(&st, i5 - 1, i4) + 1;
  st.site = &rbb_emlrtRSI;
  b_iv[1] = div_s32_floor(&st, i7 - 1, i6) + 1;
  st.site = &rbb_emlrtRSI;
  ...
  iv1[1] = b_loop_ub + 1;
  emlrtSubAssignSizeCheckR2012b(&b_iv[0], 2, &iv1[0], 2, &xd_emlrtECI,
                                (emlrtCTX)sp);
  ...
  iv1[0] = (*(int32_T(*)[2])m.size())[0];
  iv1[1] = (*(int32_T(*)[2])m.size())[1];
  emlrtSizeEqCheckNDR2012b(&b_iv[0], &iv1[0], &wd_emlrtECI, (emlrtCTX)sp);
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&gs_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (2 > m.size(0)) {
  ...
  if (2 > bw.size(0)) {
    ...
    i5 = bw.size(0);
    if (2 > i5) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i5, &wu_emlrtBCI, (emlrtCTX)sp);
    }
    i5 = 2;
    i8 = 2;
    i7 = bw.size(0);
    ...
    if ((loop_ub < 1) || (loop_ub > i7)) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 1, i7, &vu_emlrtBCI, (emlrtCTX)sp);
    }
  }
  if (2 > bw.size(1)) {
    i7 = 1;
    ...
    i7 = bw.size(1);
    if (2 > i7) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i7, &uu_emlrtBCI, (emlrtCTX)sp);
    }
    i7 = 2;
    i9 = 2;
    b_loop_ub = bw.size(1);
    ...
    if ((i10 < 1) || (i10 > b_loop_ub)) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, b_loop_ub, &tu_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  }
  st.site = &qbb_emlrtRSI;
  b_iv[0] = div_s32_floor(&st, loop_ub - i5, i8) + 1;
  st.site = &qbb_emlrtRSI;
  b_iv[1] = div_s32_floor(&st, i10 - i7, i9) + 1;
  st.site = &qbb_emlrtRSI;
  ...
  iv1[1] = b_loop_ub + 1;
  emlrtSubAssignSizeCheckR2012b(&b_iv[0], 2, &iv1[0], 2, &vd_emlrtECI,
                                (emlrtCTX)sp);
  ...
  iv1[0] = (*(int32_T(*)[2])m.size())[0];
  iv1[1] = (*(int32_T(*)[2])m.size())[1];
  emlrtSizeEqCheckNDR2012b(&b_iv[0], &iv1[0], &ud_emlrtECI, (emlrtCTX)sp);
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&hs_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (1 > m.size(0)) {
  ...
  if (1 > bw.size(0)) {
    ...
    i6 = bw.size(0);
    if (1 > i6) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i6, &su_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = 2;
    i5 = bw.size(0);
    i8 = bw.size(0);
    if ((i8 < 1) || (i8 > i5)) {
      emlrtDynamicBoundsCheckR2012b(i8, 1, i5, &ru_emlrtBCI, (emlrtCTX)sp);
    }
  }
  if (2 > bw.size(1)) {
    i5 = 1;
    ...
    i5 = bw.size(1);
    if (2 > i5) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i5, &qu_emlrtBCI, (emlrtCTX)sp);
    }
    i5 = 2;
    i7 = 2;
    loop_ub = bw.size(1);
    i9 = bw.size(1);
    if ((i9 < 1) || (i9 > loop_ub)) {
      emlrtDynamicBoundsCheckR2012b(i9, 1, loop_ub, &pu_emlrtBCI, (emlrtCTX)sp);
    }
  }
  st.site = &pbb_emlrtRSI;
  b_iv[0] = div_s32_floor(&st, i8 - 1, i6) + 1;
  st.site = &pbb_emlrtRSI;
  b_iv[1] = div_s32_floor(&st, i9 - i5, i7) + 1;
  st.site = &pbb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i1, i);
  iv1[0] = loop_ub + 1;
  st.site = &pbb_emlrtRSI;
  ...
  iv1[1] = b_loop_ub + 1;
  emlrtSubAssignSizeCheckR2012b(&b_iv[0], 2, &iv1[0], 2, &td_emlrtECI,
                                (emlrtCTX)sp);
  for (i1 = 0; i1 <= b_loop_ub; i1++) {
  ...
  loop_ub = bw.size(0) * bw.size(1);
  m.set_size(&is_emlrtRTEI, sp, bw.size(0), bw.size(1));
  for (i = 0; i < loop_ub; i++) {
    m[i] = (bw[i] && m[i]);
  }
  if (2 > m.size(0)) {
  ...
  if (2 > bw.size(0)) {
    ...
    i6 = bw.size(0);
    if (2 > i6) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i6, &ou_emlrtBCI, (emlrtCTX)sp);
    }
    i6 = 2;
    i5 = 2;
    i8 = bw.size(0);
    i7 = bw.size(0);
    if ((i7 < 1) || (i7 > i8)) {
      emlrtDynamicBoundsCheckR2012b(i7, 1, i8, &nu_emlrtBCI, (emlrtCTX)sp);
    }
  }
  if (1 > bw.size(1)) {
    i8 = 1;
    ...
    i8 = bw.size(1);
    if (1 > i8) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i8, &mu_emlrtBCI, (emlrtCTX)sp);
    }
    i8 = 2;
    loop_ub = bw.size(1);
    i9 = bw.size(1);
    if ((i9 < 1) || (i9 > loop_ub)) {
      emlrtDynamicBoundsCheckR2012b(i9, 1, loop_ub, &lu_emlrtBCI, (emlrtCTX)sp);
    }
  }
  st.site = &obb_emlrtRSI;
  b_iv[0] = div_s32_floor(&st, i7 - i6, i5) + 1;
  st.site = &obb_emlrtRSI;
  b_iv[1] = div_s32_floor(&st, i9 - 1, i8) + 1;
  st.site = &obb_emlrtRSI;
  loop_ub = div_s32_floor(&st, i2 - i, i1);
  iv1[0] = loop_ub + 1;
  st.site = &obb_emlrtRSI;
  ...
  iv1[1] = b_loop_ub + 1;
  emlrtSubAssignSizeCheckR2012b(&b_iv[0], 2, &iv1[0], 2, &rd_emlrtECI,
                                (emlrtCTX)sp);
  for (i2 = 0; i2 <= b_loop_ub; i2++) {
    for (i4 = 0; i4 <= loop_ub; i4++) {
