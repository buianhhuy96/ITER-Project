...
processed_images = uint8(preprocessImages(images, camera_params));



% Load robot poses
num_of_images = size(processed_images,4);
valid_idx = logical(ones(num_of_images,1)); %[0,0,1,1,1,1,0,1,1,1,0,1,1,0,1]);
...
[image_points, valid_idx, cam_extrinsics, camera_poses, world_points] = ComputeCamExtrinsics(processed_images, square_size, camera_params);
