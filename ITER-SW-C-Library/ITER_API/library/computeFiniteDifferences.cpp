...
bool computeFiniteDifferences(
    t_struct_T *obj, const ::coder::array<double, 1U> &cEqCurrent,
    ...
    const ::coder::array<double, 1U> &runTimeOptions_FiniteDifferenceStepSize)
{
  ...
  if (obj->isEmptyNonlcon) {
    ...
    while ((!exitg1) && (b_idx <= (obj->nVar - 1))) {
      ...
      d_evalOK = internal::b_finDiffEvalAndChkErr(
      ...
      if (!d_evalOK) {
        if (!modifiedStep) {
          ...
          if ((!obj->hasBounds) || insideBnds) {
            c_evalOK = internal::b_finDiffEvalAndChkErr(
    ...
    while ((!exitg1) && (idx <= (obj->nVar - 1))) {
      ...
      do {
        exitg2 = 0;
        e_evalOK = internal::b_finDiffEvalAndChkErr(
            &obj->nonlin, obj->mEq, obj->SpecifyConstraintGradient, obj->cEq_1,
            idx + 1, delta1, b_xk);
        b_evalOK = e_evalOK;
        obj->numEvals++;
        ...
        if (!e_evalOK) {
          ...
          bool g_evalOK;
          g_evalOK = internal::b_finDiffEvalAndChkErr(
              &obj->nonlin, obj->mEq, obj->SpecifyConstraintGradient,
