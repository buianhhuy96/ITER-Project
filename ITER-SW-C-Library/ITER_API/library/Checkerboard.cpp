...
#pragma omp parallel for \
 ...
 private(b_arr,i1,k,y,g_x,exitg1)
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
          ...
          // Return Type  : void
          //
          void b_Checkerboard::b_findClosestIndices(const ::coder::array<double,
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            d_this = BoardIdx.reshape(b_this);
            do_vectors(y, d_this, remIdx, ia, c_ib);
            if (remIdx.size(1) != 0) {
              int c_loop_ub;
              int d_loop_ub;
              int e_loop_ub;
 ...
 num_threads(omp_get_max_threads())
              ...
              for (int c_i{0}; c_i < i4; c_i++) {
                ...
                for (int b_i8{0}; b_i8 < f_loop_ub; b_i8++) {
                  p[b_i8] = predictedPoints[(c_ii[c_i] + (predictedPoints.size(0)
                    * b_i8)) - 1];
                }
                ...
                for (int i10{0}; i10 < g_loop_ub; i10++) {
                  ...
                  for (int i11{0}; i11 < j_loop_ub; i11++) {
                    e_this[i11 + (e_this.size(0) * i10)] = Points[((static_cast<
                      int>(remIdx[i11])) + (Points.size(0) * i10)) - 1];
                  }
                }
                ...
                for (int i16{0}; i16 < i_loop_ub; i16++) {
                  ...
                  for (int i17{0}; i17 < o_loop_ub; i17++) {
                    e_this[i17 + (e_this.size(0) * i16)] = Points[((static_cast<
                      int>(validBoardIdx[i17])) + (Points.size(0) * i16)) - 1];
                  }
                }
                ...
                if (minDist < (::coder::internal::b_minimum(r2) / 2.0F)) {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
          ...
          // Return Type  : void
          //
          void b_Checkerboard::b_findIndependentVar(double coordsToUse[2]) const
          {
            array<double, 1U> b_x;
            array<double, 1U> g_x;
            array<int, 1U> r2;
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            g_x.set_size(r4.size(0));
            f_loop_ub = r4.size(0);
            if ((static_cast<int>(r4.size(0) < 4)) != 0) {
              for (int i3{0}; i3 < f_loop_ub; i3++) {
                g_x[i3] = BoardCoords[((r4[i3] + BoardCoords.size(0)) +
                  (BoardCoords.size(0) * BoardCoords.size(1))) - 1] -
                  BoardCoords[(r5[i3] + (BoardCoords.size(0) * BoardCoords.size
                  (1))) - 1];
              }
            } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            if (std::abs(combineVectorElements(b_x) / (static_cast<double>
                  (b_x.size(0)))) > std::abs(combineVectorElements(g_x) / (
                  static_cast<double>(g_x.size(0))))) {
              coordsToUse[0] = 1.0;
              coordsToUse[1] = 2.0;
            } else {
              coordsToUse[0] = 2.0;
          ...
          // Return Type  : void
          //
          void b_Checkerboard::b_findIndependentVar(const ::coder::array<double,
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int b_i = 0; b_i < b_loop_ub; b_i++) {
                r[b_i] = (BoardIdx[b_i + (BoardIdx.size(0) * (b_idx - 1))] > 0.0);
              }
            }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i1 = 0; i1 < d_loop_ub; i1++) {
                r1[i1] = (BoardIdx[i1 + (BoardIdx.size(0) * (c_idx - 1))] > 0.0);
              }
            }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            if ((static_cast<int>(r4.size(0) < 4)) != 0) {
              for (int i3{0}; i3 < f_loop_ub; i3++) {
                g_x[i3] = BoardCoords[((r4[i3] + (BoardCoords.size(0) * (h_idx -
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i3 = 0; i3 < f_loop_ub; i3++) {
                g_x[i3] = BoardCoords[((r4[i3] + (BoardCoords.size(0) * (j_idx -
                  1))) + (BoardCoords.size(0) * BoardCoords.size(1))) - 1] -
          ...
          // Return Type  : void
          //
          void b_Checkerboard::b_fitPolynomialIndices(::coder::array<double, 2U>
            &newIndices) const
          {
            ...
            for (int j{0}; j < i1; j++) {
              ...
              if (c_ii.size(1) >= 2) {
                ...
                coordDist = (BoardCoords[(j + (BoardCoords.size(0) * (c_ii[0] -
                  ...
                  (BoardCoords.size(0) * (c_ii[1] - 1))) + ((BoardCoords.size(0)
                  * BoardCoords.size(1)) * ((static_cast<int>(coordsToUse[0])) -
                  1))]) / ((static_cast<double>(c_ii[1])) - (static_cast<double>
                            (coordDist_tmp)));
                i_n = 0;
                i4 = c_ii.size(1);
                b_this.set_size(1, c_ii.size(1));
                d_this.set_size(1, c_ii.size(1));
                for (int b_k{0}; b_k < i4; b_k++) {
                  ...
                  b_this[b_k] = BoardCoords[(j + (BoardCoords.size(0) *
                    (c_ii[b_k] - 1))) + ((BoardCoords.size(0) * BoardCoords.size
                    (1)) * ((static_cast<int>(coordsToUse[0])) - 1))];
                  d_this[b_k] = BoardCoords[(j + (BoardCoords.size(0) *
                    (c_ii[b_k] - 1))) + ((BoardCoords.size(0) * BoardCoords.size
                    (1)) * ((static_cast<int>(coordsToUse[1])) - 1))];
                }
                ...
                b_polyfit(b_this, d_this, static_cast<double>(u_n), currCurve);
                currRad = coordDist / 4.0;
                refCoordValue = BoardCoords[(j + (BoardCoords.size(0) * (c_ii[0]
                  - 1))) + ((BoardCoords.size(0) * BoardCoords.size(1)) * ((
                  static_cast<int>(coordsToUse[0])) - 1))];
                currCoord = currRad + refCoordValue;
                exitg1 = false;
                while ((!exitg1) && (std::abs(currCoord - refCoordValue) < (((
                           static_cast<double>(coordDist_tmp)) * 1.5) * std::abs
                         (coordDist)))) {
                  dv[0] = 1.0;
                  dv[1] = 2.0;
              ...
              if (validIdx.size(1) >= 2) {
                ...
                for (int i5{0}; i5 < d_loop_ub; i5++) {
                  b_this[i5] = BoardCoords[(j + (BoardCoords.size(0) * ((
                    static_cast<int>(validIdx[i5])) - 1))) + ((BoardCoords.size
                ...
                for (int i6{0}; i6 < e_loop_ub; i6++) {
                  d_this[i6] = BoardCoords[(j + (BoardCoords.size(0) * ((
                    static_cast<int>(validIdx[i6])) - 1))) + ((BoardCoords.size
                    (0) * BoardCoords.size(1)) * ((static_cast<int>(coordsToUse
                    [1])) - 1))];
                }
                ...
                b_polyfit(b_this, d_this, static_cast<double>(i_n), currCurve);
                currRad = coordDist / 4.0;
                refCoordValue = BoardCoords[(j + (BoardCoords.size(0) * ((
                  static_cast<int>(firstValidIdx)) - 1))) + ((BoardCoords.size(0)
                  * BoardCoords.size(1)) * ((static_cast<int>(coordsToUse[0])) -
                  1))];
                currCoord = currRad + refCoordValue;
                exitg1 = false;
            ...
            for (int j{0}; j < i1; j++) {
              ...
              if (validIdx.size(0) >= 2) {
                ...
                for (int i7{0}; i7 < e_loop_ub; i7++) {
                  d_this[i7] = BoardCoords[(((static_cast<int>(validIdx[i7])) +
                    (BoardCoords.size(0) * j)) + ((BoardCoords.size(0) *
                ...
                polyfit(b_this, d_this, static_cast<double>(u_n), currCurve);
                currRad = coordDist / 4.0;
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            if (varargout_1) {
              ...
              d_this.set_size(r2.size(0), 1, i7);
              j_loop_ub = i7;
 ...
 private(i9,k_loop_ub)
              ...
              for (int b_i8 = 0; b_i8 < j_loop_ub; b_i8++) {
                ...
                for (i9 = 0; i9 < k_loop_ub; i9++) {
                  d_this[i9 + (d_this.size(0) * b_i8)] = (BoardCoords[(r2[i9] +
                    ((BoardCoords.size(0) * BoardCoords.size(1)) * b_i8)) - 1] +
                    BoardCoords[((r3[i9] + (BoardCoords.size(0) * 2)) +
                                 ((BoardCoords.size(0) * BoardCoords.size(1)) *
                                  b_i8)) - 1]) - (2.0 * BoardCoords[((r4[i9] +
                    BoardCoords.size(0)) + ((BoardCoords.size(0) *
                    BoardCoords.size(1)) * b_i8)) - 1]);
                }
              }

              b_squeeze(d_this, f_num);
              d_end = r.size(0) - 1;
              d_trueCount = 0;
              for (int q_i{0}; q_i <= d_end; q_i++) {
                if ((r[q_i]) && (r1[q_i])) {
              ...
              for (int eb_i{0}; eb_i <= e_end; eb_i++) {
                if ((r[eb_i]) && (r1[eb_i])) {
                  r6[e_partialTrueCount] = eb_i + 1;
                  e_partialTrueCount++;
                }
              }
              ...
              d_this.set_size(r5.size(0), 1, i10);
              m_loop_ub = i10;
 ...
 private(i12,q_loop_ub)
              ...
              for (int i11 = 0; i11 < m_loop_ub; i11++) {
                ...
                for (i12 = 0; i12 < q_loop_ub; i12++) {
                  d_this[i12 + (d_this.size(0) * i11)] = BoardCoords[(r5[i12] +
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
                ...
                newEnergy = std::fmax(oldEnergy, static_cast<float>(::coder::
                  internal::b_maximum(g_x)));
              } else {
                newEnergy = std::fmax(oldEnergy, static_cast<float>(static_cast<
                  double>(rt_hypotd_snf(f_num[0], f_num[1]) / rt_hypotd_snf
                          (e_denom[0], e_denom[1]))));
              }
            }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int g_i{0}; g_i < i4; g_i++) {
                ...
                for (int i5{0}; i5 < h_loop_ub; i5++) {
                  num[i5] = (BoardCoords[((static_cast<int>(d)) +
                             ...
                             - 1] + BoardCoords[((static_cast<int>(static_cast<
                    double>(d + 2.0))) + ((BoardCoords.size(0) *
          ...
          // Return Type  : float
          //
          float b_Checkerboard::computeNewEnergyHorizontal(const ::coder::array<
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i1 = 0; i1 < d_loop_ub; i1++) {
                r1[i1] = (BoardIdx[i1 + (BoardIdx.size(0) * (d_idx - 1))] > 0.0);
              }
            }
...
#pragma omp parallel for \
 ...
 private(i9,k_loop_ub)
              ...
              for (int b_i8 = 0; b_i8 < j_loop_ub; b_i8++) {
                ...
                for (i9 = 0; i9 < k_loop_ub; i9++) {
                  d_this[i9 + (d_this.size(0) * b_i8)] = (BoardCoords[((r2[i9] +
                    (BoardCoords.size(0) * (g_idx - 1))) + ((BoardCoords.size(0)
                    * BoardCoords.size(1)) * b_i8)) - 1] + BoardCoords[((r3[i9]
                    + (BoardCoords.size(0) * (h_idx - 1))) + ((BoardCoords.size
                    (0) * BoardCoords.size(1)) * b_i8)) - 1]) - (2.0 *
...
#pragma omp parallel for \
 ...
 private(i12,q_loop_ub)
              ...
              for (int i11 = 0; i11 < m_loop_ub; i11++) {
                ...
                for (i12 = 0; i12 < q_loop_ub; i12++) {
                  d_this[i12 + (d_this.size(0) * i11)] = BoardCoords[((r5[i12] +
                    (BoardCoords.size(0) * (m_idx - 1))) + ((BoardCoords.size(0)
                    * BoardCoords.size(1)) * i11)) - 1] - BoardCoords[((r6[i12]
                    + (BoardCoords.size(0) * (o_idx - 1))) + ((BoardCoords.size
                    (0) * BoardCoords.size(1)) * i11)) - 1];
                }
              }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
                ...
                for (int i5{0}; i5 < h_loop_ub; i5++) {
                  num[i5] = (BoardCoords[(((static_cast<int>(d)) +
                    (BoardCoords.size(0) * ((static_cast<int>(b_d1)) - 1))) +
                              ((BoardCoords.size(0) * BoardCoords.size(1)) * i5))
                             - 1] + BoardCoords[(((static_cast<int>(static_cast<
                    double>(d + 2.0))) + (BoardCoords.size(0) * ((static_cast<
                    int>(b_d1)) - 1))) + ((BoardCoords.size(0) *
                    BoardCoords.size(1)) * i5)) - 1]) - (2.0 * BoardCoords[(((
                    static_cast<int>(static_cast<double>(d + 1.0))) +
                    (BoardCoords.size(0) * ((static_cast<int>(b_d1)) - 1))) +
                    ((BoardCoords.size(0) * BoardCoords.size(1)) * i5)) - 1]);
                ...
                for (int i6{0}; i6 < i_loop_ub; i6++) {
                  denom[i6] = BoardCoords[(((static_cast<int>(d2)) +
                    ...
                    BoardCoords[(((static_cast<int>(static_cast<double>(d2 + 2.0)))
                                  + (BoardCoords.size(0) * ((static_cast<int>(d3))
          ...
          float b_Checkerboard::computeNewEnergyVertical(float oldEnergy) const
          {
            ...
            if ((static_cast<int>(loop_ub < 4)) != 0) {
              for (int b_i{0}; b_i < loop_ub; b_i++) {
                r[b_i] = ((BoardIdx[BoardIdx.size(0) * b_i] > 0.0) && (BoardIdx
              ...
              for (int i6 = 0; i6 < h_loop_ub; i6++) {
                ...
                for (i7 = 0; i7 < j_loop_ub; i7++) {
                  r3[i7 + (r3.size(1) * i6)] = BoardCoords[(BoardCoords.size(0) *
                    (r2[i7] - 1)) + ((BoardCoords.size(0) * BoardCoords.size(1))
                                     * i6)];
                }
              }
 ...
 private(i12,o_loop_ub)
              ...
              for (int i11 = 0; i11 < m_loop_ub; i11++) {
                ...
                for (i12 = 0; i12 < o_loop_ub; i12++) {
                  r5[i12 + (r5.size(1) * i11)] = BoardCoords[((BoardCoords.size
                    (0) * (r4[i12] - 1)) + ((BoardCoords.size(0) *
                    BoardCoords.size(1)) * i11)) + 2];
                }
              }
 ...
 private(i16,r_loop_ub)
              ...
              for (int i14 = 0; i14 < p_loop_ub; i14++) {
                ...
                for (i16 = 0; i16 < r_loop_ub; i16++) {
                  b[i16 + (b.size(1) * i14)] = BoardCoords[((BoardCoords.size(0)
                    * (r6[i16] - 1)) + ((BoardCoords.size(0) * BoardCoords.size
                    (1)) * i14)) + 1];
                }
              }
 ...
 private(i20,u_loop_ub)
              ...
              for (int i19 = 0; i19 < t_loop_ub; i19++) {
                ...
                for (i20 = 0; i20 < u_loop_ub; i20++) {
                  r3[i20 + (r3.size(1) * i19)] = BoardCoords[(BoardCoords.size(0)
                    * (r7[i20] - 1)) + ((BoardCoords.size(0) * BoardCoords.size
                    (1)) * i19)];
                }
              }
 ...
 private(i24,x_loop_ub)
              ...
              for (int i22 = 0; i22 < v_loop_ub; i22++) {
                ...
                for (i24 = 0; i24 < x_loop_ub; i24++) {
                  r5[i24 + (r5.size(1) * i22)] = BoardCoords[((BoardCoords.size
                    (0) * (r8[i24] - 1)) + ((BoardCoords.size(0) *
                    BoardCoords.size(1)) * i22)) + 2];
                }
              }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
                ...
                ib_loop_ub = g_x.size(0);
                if ((static_cast<int>(g_x.size(0) < 4)) != 0) {
                  for (int i30{0}; i30 < ib_loop_ub; i30++) {
                    g_x[i30] = g_x[i30] / b_y[i30];
                  }
                } else {
            ...
            if (validNewRowIdx.size(1) != 0) {
              ...
              for (int e_i{0}; e_i < i5; e_i++) {
                ...
                for (int b_i8{0}; b_i8 < i_loop_ub; b_i8++) {
                  num[b_i8] = (BoardCoords[(BoardCoords.size(0) * ((static_cast<
                    int>(d)) - 1)) + ((BoardCoords.size(0) * BoardCoords.size(1))
                                      * b_i8)] + BoardCoords[(BoardCoords.size(0)
                    * ((static_cast<int>(static_cast<double>(d + 2.0))) - 1)) +
                               ((BoardCoords.size(0) * BoardCoords.size(1)) *
                                b_i8)]) - (2.0 * BoardCoords[(BoardCoords.size(0)
                ...
                for (int i9{0}; i9 < k_loop_ub; i9++) {
                  denom[i9] = BoardCoords[(BoardCoords.size(0) * ((static_cast<
                    int>(b_d1)) - 1)) + ((BoardCoords.size(0) * BoardCoords.size
                    (1)) * i9)] - BoardCoords[(BoardCoords.size(0) * ((
                    static_cast<int>(static_cast<double>(b_d1 + 2.0))) - 1)) +
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i1 = 0; i1 < d_loop_ub; i1++) {
                r1[i1] = (BoardIdx[(d_idx + (BoardIdx.size(0) * i1)) - 1] > 0.0);
              }
            }
              ...
              for (int i6 = 0; i6 < h_loop_ub; i6++) {
                ...
                for (i7 = 0; i7 < j_loop_ub; i7++) {
                  r3[i7 + (r3.size(1) * i6)] = BoardCoords[((g_idx +
                    (BoardCoords.size(0) * (r2[i7] - 1))) + ((BoardCoords.size(0)
                    * BoardCoords.size(1)) * i6)) - 1];
                }
              }
              ...
              for (int i11 = 0; i11 < m_loop_ub; i11++) {
                ...
                for (i12 = 0; i12 < o_loop_ub; i12++) {
                  r5[i12 + (r5.size(1) * i11)] = BoardCoords[((h_idx +
                    (BoardCoords.size(0) * (r4[i12] - 1))) + ((BoardCoords.size
                    (0) * BoardCoords.size(1)) * i11)) - 1];
                }
              }
              ...
              for (int i14 = 0; i14 < p_loop_ub; i14++) {
                ...
                for (i16 = 0; i16 < r_loop_ub; i16++) {
                  b[i16 + (b.size(1) * i14)] = BoardCoords[((j_idx +
                    (BoardCoords.size(0) * (r6[i16] - 1))) + ((BoardCoords.size
                    (0) * BoardCoords.size(1)) * i14)) - 1];
                }
              }
              ...
              for (int i19 = 0; i19 < t_loop_ub; i19++) {
                ...
                for (i20 = 0; i20 < u_loop_ub; i20++) {
                  r3[i20 + (r3.size(1) * i19)] = BoardCoords[((m_idx +
                    (BoardCoords.size(0) * (r7[i20] - 1))) + ((BoardCoords.size
                    (0) * BoardCoords.size(1)) * i19)) - 1];
                }
              }
              ...
              for (int i22 = 0; i22 < v_loop_ub; i22++) {
                ...
                for (i24 = 0; i24 < x_loop_ub; i24++) {
                  r5[i24 + (r5.size(1) * i22)] = BoardCoords[((o_idx +
                    (BoardCoords.size(0) * (r8[i24] - 1))) + ((BoardCoords.size
                    (0) * BoardCoords.size(1)) * i22)) - 1];
                }
              }
              ...
              for (int e_i{0}; e_i < i5; e_i++) {
                ...
                for (int b_i8{0}; b_i8 < i_loop_ub; b_i8++) {
                  num[b_i8] = (BoardCoords[(((static_cast<int>(d)) +
                    ...
                    (BoardCoords.size(0) * ((static_cast<int>(static_cast<double>
                    (b_d1 + 2.0))) - 1))) + ((BoardCoords.size(0) *
                    BoardCoords.size(1)) * b_i8)) - 1]) - (2.0 * BoardCoords[(((
                    static_cast<int>(d)) + (BoardCoords.size(0) * ((static_cast<
                    int>(static_cast<double>(b_d1 + 1.0))) - 1))) +
                    ((BoardCoords.size(0) * BoardCoords.size(1)) * b_i8)) - 1]);
                }
                ...
                for (int i10{0}; i10 < k_loop_ub; i10++) {
                  denom[i10] = BoardCoords[(((static_cast<int>(d2)) +
                    ...
                    BoardCoords[(((static_cast<int>(d2)) + (BoardCoords.size(0) *
                    ((static_cast<int>(static_cast<double>(d3 + 2.0))) - 1))) +
                                 ((BoardCoords.size(0) * BoardCoords.size(1)) *
                                  i10)) - 1];
                }
 ...
 num_threads(omp_get_max_threads())
            ...
            for (int j{0}; j < i1; j++) {
              ...
              if (validIdx.size(1) >= 2) {
                ...
                e_loop_ub = validIdx.size(1);
                for (int i7{0}; i7 < e_loop_ub; i7++) {
                  d_this[i7] = BoardCoords[(j + (BoardCoords.size(0) * ((
                    static_cast<int>(validIdx[i7])) - 1))) + ((BoardCoords.size
                    (0) * BoardCoords.size(1)) * ((static_cast<int>(coordsToUse
                    [1])) - 1))];
                }
...
#pragma omp parallel for \
 ...
 private(i1,c_loop_ub)
            ...
            if ((static_cast<int>(indices.size(1) < 4)) != 0) {
              for (int i2{0}; i2 < b_loop_ub; i2++) {
                newBoard[d_this + (newBoard.size(0) * i2)] = indices[i2];
              }
            } else {
 ...
 private(i11,m_loop_ub)
            ...
            for (int i12{0}; i12 < o_loop_ub; i12++) {
              for (int i13{0}; i13 < unnamed_idx_1; i13++) {
                newBoardCoords[(f_this + (newBoardCoords.size(0) * (r3[i13] - 1)))
                  + ((newBoardCoords.size(0) * newBoardCoords.size(1)) * r[i12])]
                  = r2[i13 + (unnamed_idx_1 * i12)];
              }
            }
...
#pragma omp parallel for \
 ...
 private(i6,h_loop_ub)
            ...
            d_this[0] = BoardCoords.size(0);
            d_this[1] = BoardCoords.size(1) + 1;
            d_this[2] = BoardCoords.size(2);
            newBoardCoords.set_size(d_this[0], d_this[1], d_this[2]);
            g_loop_ub = d_this[2];
...
#pragma omp parallel for \
 ...
 private(i18,s_loop_ub,i19,t_loop_ub)
          ...
          // Return Type  : void
          //
          void b_Checkerboard::expandBoardRight(const ::coder::array<double, 2U>
            &indices, ::coder::array<double, 2U> &newBoard, ::coder::array<
            double, 3U> &newBoardCoords) const
          {
            array<double, 2U> r2;
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            e_loop_ub = r.size(0);
            for (int i3{0}; i3 < e_loop_ub; i3++) {
              newBoard[r[i3] + (newBoard.size(0) * d_this)] = indices[i3];
            }
            ...
            for (int i13{0}; i13 < q_loop_ub; i13++) {
              for (int i14{0}; i14 < unnamed_idx_0; i14++) {
                newBoardCoords[((r3[i14] + (newBoardCoords.size(0) * f_this)) +
                                 ...
                                 * r[i13])) - 1] = r2[i14 + (unnamed_idx_0 * i13)];
              }
            }
...
#pragma omp parallel for \
 ...
 private(i5,f_loop_ub)
            ...
            d_this[0] = BoardCoords.size(0) + 1;
            d_this[1] = BoardCoords.size(1);
            d_this[2] = BoardCoords.size(2);
            newBoardCoords.set_size(d_this[0], d_this[1], d_this[2]);
            e_loop_ub = d_this[2];
...
#pragma omp parallel for \
 ...
 private(i17,q_loop_ub,i18,r_loop_ub)
          ...
          {
            array<double, 2U> b_indices;
            array<double, 2U> b_predictedPoints;
            array<double, 2U> remIdx;
            array<double, 2U> y;
            array<double, 1U> d_this;
            array<float, 2U> diffs;
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int c_i{0}; c_i < i4; c_i++) {
                ...
                ::coder::internal::minimum(dists, &ex, &iindx);
                indices[c_ii[c_i] - 1] = remIdx[iindx - 1];
              }
            }
          }
          ...
          // Return Type  : void
          //
          void b_Checkerboard::findClosestOnCurve(const double predictedPoint[2],
            double radius, const ::coder::array<double, 2U> &curve, const double
            coordsToUse[2], const ::coder::array<double, 2U> &removedIdx, ::
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads()) \
 private(currPt,d_a,z1,b_y,i_k,j_k,k_k,k_N,m_k,i30,i31,b_t,i32,cb_k,i33,i34,i36)

              for (int h_i = 0; h_i < i26; h_i++) {
                currPt.set_size(outsize[0], outsize[1]);
                if ((outsize[0] != 0) && (outsize[1] != 0)) {
                  i36 = queryPts.size(1) - 1;
                  for (cb_k = 0; cb_k <= i36; cb_k++) {
                    i32 = numDataPts - 1;
                    for (b_t = 0; b_t <= i32; b_t++) {
                      currPt[b_t + (currPt.size(0) * cb_k)] = queryPts[h_i +
                        (queryPts.size(0) * cb_k)];
                    }
                  }
                }
                ...
                for (i31 = 0; i31 < 2; i31++) {
                  for (i30 = 0; i30 < ab_loop_ub; i30++) {
                    d_a[i30 + (d_a.size(0) * i31)] = (static_cast<float>
                      (dataPts[i30 + (dataPts.size(0) * i31)])) - currPt[i30 +
                      (currPt.size(0) * i31)];
                  }
                }
                ...
                for (m_k = 0; m_k < 2; m_k++) {
                  k_N = z1.size(0);
                  for (k_k = 0; k_k < k_N; k_k++) {
                    z1[k_k + (z1.size(0) * m_k)] = rt_powf_snf(d_a[k_k +
                      (d_a.size(0) * m_k)], 2.0F);
                  }
                }
                ...
                if (z1.size(0) == 0) {
                  ...
                  i34 = z1.size(0);
                  for (j_k = 0; j_k < i34; j_k++) {
                    b_y[j_k] = z1[j_k];
                  }

                  i33 = z1.size(0);
                  for (i_k = 0; i_k < i33; i_k++) {
                    b_y[i_k] = b_y[i_k] + z1[i_k + z1.size(0)];
                  }
                }

                dist[h_i] = static_cast<double>(std::sqrt(::coder::internal::
                  b_minimum(b_y)));
              }
              ...
              if (dist.size(0) <= 2) {
                ...
                if (!std::isnan(dist[0])) {
                  ...
                  h_k = 2;
                  exitg1 = false;
                  while ((!exitg1) && (h_k <= last)) {
                    if (!std::isnan(dist[h_k - 1])) {
                      b_idx = h_k;
                      exitg1 = true;
                    } else {
                      h_k++;
              ...
              if ((static_cast<int>(dists.size(0) < 4)) != 0) {
                for (int i29{0}; i29 < bb_loop_ub; i29++) {
                  b_x[i29] = ((static_cast<double>(dists[i29])) < radius);
                }
              } else {
 ...
 num_threads(omp_get_max_threads())
              ...
              if ((static_cast<int>(c_ii.size(0) < 4)) != 0) {
                for (int i37{0}; i37 < cb_loop_ub; i37++) {
                  d_idx[i37] = static_cast<unsigned int>(c_ii[i37]);
                }
              } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            h_loop_ub = r8.size(1);
            if ((static_cast<int>(r8.size(1) < 4)) != 0) {
              for (int i5{0}; i5 < h_loop_ub; i5++) {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int b_i = 0; b_i < b_loop_ub; b_i++) {
                r[b_i] = (BoardIdx[(b_idx + (BoardIdx.size(0) * b_i)) - 1] > 0.0);
              }
            }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i1 = 0; i1 < d_loop_ub; i1++) {
                r1[i1] = (BoardIdx[(c_idx + (BoardIdx.size(0) * i1)) - 1] > 0.0);
              }
            }
            ...
            if ((static_cast<int>(r2.size(1) < 4)) != 0) {
              for (int i2{0}; i2 < e_loop_ub; i2++) {
                r3[i2] = BoardCoords[(d_idx + (BoardCoords.size(0) * (r2[i2] - 1)))
                  - 1];
              }
            } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i2 = 0; i2 < e_loop_ub; i2++) {
                r3[i2] = BoardCoords[(e_idx + (BoardCoords.size(0) * (r2[i2] - 1)))
                  - 1];
              }
            }
            ...
            if ((static_cast<int>(r4.size(1) < 4)) != 0) {
              for (int i3{0}; i3 < f_loop_ub; i3++) {
                r5[i3] = BoardCoords[(f_idx + (BoardCoords.size(0) * (r4[i3] - 1)))
                  - 1];
              }
            } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i3 = 0; i3 < f_loop_ub; i3++) {
                r5[i3] = BoardCoords[(g_idx + (BoardCoords.size(0) * (r4[i3] - 1)))
                  - 1];
              }
            }
            ...
            if ((static_cast<int>(r6.size(1) < 4)) != 0) {
              for (int i4{0}; i4 < g_loop_ub; i4++) {
                r7[i4] = BoardCoords[((h_idx + (BoardCoords.size(0) * (r6[i4] -
                  1))) + (BoardCoords.size(0) * BoardCoords.size(1))) - 1];
              }
            } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i4 = 0; i4 < g_loop_ub; i4++) {
                r7[i4] = BoardCoords[((j_idx + (BoardCoords.size(0) * (r6[i4] -
                  1))) + (BoardCoords.size(0) * BoardCoords.size(1))) - 1];
              }
            }
            ...
            if ((static_cast<int>(r8.size(1) < 4)) != 0) {
              for (int i5{0}; i5 < h_loop_ub; i5++) {
                r9[i5] = BoardCoords[((m_idx + (BoardCoords.size(0) * (r8[i5] -
                  1))) + (BoardCoords.size(0) * BoardCoords.size(1))) - 1];
              }
            } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i5 = 0; i5 < h_loop_ub; i5++) {
                r9[i5] = BoardCoords[((o_idx + (BoardCoords.size(0) * (r8[i5] -
                  1))) + (BoardCoords.size(0) * BoardCoords.size(1))) - 1];
              }
            }
 ...
 num_threads(omp_get_max_threads())
            ...
            for (int k{0}; k < inner; k++) {
              for (int c_i{0}; c_i <= mc; c_i++) {
                y[c_i] = y[c_i] + (pointVectors[c_i + (pointVectors.size(0) * k)]
                                   * b_v[k]);
              }
            }
 ...
 private(i3,d_loop_ub)
            ...
            for (int i2 = 0; i2 < c_loop_ub; i2++) {
              ...
              for (i3 = 0; i3 < d_loop_ub; i3++) {
                r[i3 + (r.size(0) * i2)] = (BoardIdx[i3 + (BoardIdx.size(0) * i2)]
                  > 0.0);
              }
            }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
          ...
          // Return Type  : void
          //
          void b_Checkerboard::findSearchParams(const ::coder::array<double, 2U>
            ...
            *moveMultiplier, double *firstValidIdx) const
          {
            if (idx[0] == 1.0) {
              ...
              *coordDist = (BoardCoords[(((static_cast<int>(currIdx)) +
                ...
                (currIdx)) + (BoardCoords.size(0) * ((static_cast<int>(validIdx
              ...
              *coordDist = (BoardCoords[(((static_cast<int>(currIdx)) +
                (BoardCoords.size(0) * ((static_cast<int>(validIdx[validIdx.size
                (1) - 1])) - 1))) + ((BoardCoords.size(0) * BoardCoords.size(1))
                * ((static_cast<int>(coordsToUse[0])) - 1))) - 1] - BoardCoords
                            [(((static_cast<int>(currIdx)) + (BoardCoords.size(0)
                * ((static_cast<int>(validIdx[validIdx.size(1) - 2])) - 1))) +
                              ((BoardCoords.size(0) * BoardCoords.size(1)) * ((
                static_cast<int>(coordsToUse[0])) - 1))) - 1]) /
                (validIdx[validIdx.size(1) - 1] - validIdx[validIdx.size(1) - 2]);
            }
          }
            ...
            *moveMultiplier, double *firstValidIdx) const
          {
            if (idx[0] == 1.0) {
              ...
              *coordDist = (BoardCoords[(((static_cast<int>(validIdx[0])) +
                ...
                ((BoardCoords.size(0) * BoardCoords.size(1)) * ((static_cast<int>
                (coordsToUse[0])) - 1))) - 1] - BoardCoords[(((static_cast<int>
                (validIdx[1])) + (BoardCoords.size(0) * ((static_cast<int>
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              if (c_ii.size(1) >= 2) {
                ...
                for (int k{0}; k < i3; k++) {
                  ...
                  b_this[k] = BoardCoords[(j + (BoardCoords.size(0) * (c_ii[k] -
                    1))) + ((BoardCoords.size(0) * BoardCoords.size(1)) * ((
                              static_cast<int>(coordsToUse[0])) - 1))];
                  d_this[k] = BoardCoords[(j + (BoardCoords.size(0) * (c_ii[k] -
                    1))) + ((BoardCoords.size(0) * BoardCoords.size(1)) * ((
          ...
          // Return Type  : void
          //
          void b_Checkerboard::fitPolynomialIndices(const ::coder::array<double,
 ...
 num_threads(omp_get_max_threads())
            ...
            for (int j{0}; j < i1; j++) {
              ...
              if (validIdx.size(0) >= 2) {
                ...
                e_loop_ub = validIdx.size(0);
                for (int i6{0}; i6 < e_loop_ub; i6++) {
                  d_this[i6] = BoardCoords[(((static_cast<int>(validIdx[i6])) +
                    (BoardCoords.size(0) * j)) + ((BoardCoords.size(0) *
                    BoardCoords.size(1)) * ((static_cast<int>(coordsToUse[1])) -
                    1))) - 1];
                }
                ...
                polyfit(b_this, d_this, static_cast<double>(i_n), currCurve);
                currRad = coordDist / 4.0;
                refCoordValue = BoardCoords[(((static_cast<int>(firstValidIdx))
                  + (BoardCoords.size(0) * j)) + ((BoardCoords.size(0) *
                  BoardCoords.size(1)) * ((static_cast<int>(coordsToUse[0])) - 1)))
             ...
             case 4:
              {
                ...
                d_this = BoardIdx.size(0) - 1;
                c_loop_ub = BoardIdx.size(0);
                for (int i10{0}; i10 <= b_loop_ub; i10++) {
                  for (int i14{0}; i14 < c_loop_ub; i14++) {
                    BoardIdx[i14 + ((d_this + 1) * i10)] = BoardIdx[i14 +
                      (BoardIdx.size(0) * i10)];
                  }
                }

                BoardIdx.set_size(d_this + 1, b_loop_ub + 1);
                      ...
                      if (IsDistortionHigh) {
                        ...
                        for (int j{0}; j < i7; j++) {
                          ...
                          if (c_ii.size(0) >= 2) {
                            ...
                            coordDist = (coordDist_tmp - BoardCoords[((c_ii[1] +
                              (BoardCoords.size(0) * j)) + ((BoardCoords.size(0)
                              * BoardCoords.size(1)) * ((static_cast<int>
                              (coordsToUse[0])) - 1))) - 1]) / ((static_cast<
                              double>(c_ii[1])) - (static_cast<double>(c_ii[0])));
                            h_n = 0;
                            i41 = c_ii.size(0);
                            ...
                            polyfit(e_this, f_this, static_cast<double>(i_n),
                                    currCurve);
                            currRad = coordDist / 4.0;
                              ...
                              if (isequal(coordsToUse, dv)) {
                                if (currCurve.size(1) != 0) {
                                  ...
                                  for (int h_k{0}; h_k <= (i77 - 2); h_k++) {
                                    k_y = (currCoord * k_y) + currCurve[h_k + 1];
                                  }
                                }
                                ...
                                if (currCurve.size(1) != 0) {
                                  ...
                                  for (int g_k{0}; g_k <= (i76 - 2); g_k++) {
                                    e_y = (currCoord * e_y) + currCurve[g_k + 1];
                                  }
                                }
                        ...
                        for (int i1{0}; i1 < d_loop_ub; i1++) {
                          for (int i5{0}; i5 < loop_ub; i5++) {
                            b_this[i5 + (b_this.size(1) * i1)] = BoardCoords
                              [((BoardCoords.size(0) * i5) + ((BoardCoords.size
                                  (0) * BoardCoords.size(1)) * i1)) + 1];
                          }
                        }
                        ...
                        for (int i10{0}; i10 < o_loop_ub; i10++) {
                          for (int i15{0}; i15 < j_loop_ub; i15++) {
                            b_this[i15 + (b_this.size(1) * i10)] = BoardCoords
                              [(BoardCoords.size(0) * i15) + ((BoardCoords.size
                              (0) * BoardCoords.size(1)) * i10)];
                          }
                        }
                        ...
                        for (int i70{0}; i70 < xc_loop_ub; i70++) {
                          ...
                          for (int i74{0}; i74 < cd_loop_ub; i74++) {
                            BoardCoords[(i74 + (BoardCoords.size(0) * i70)) +
                              ((BoardCoords.size(0) * BoardCoords.size(1)) * i61)]
                              = r1[(i74 + (r1.size(0) * i70)) + ((r1.size(0) *
                              r1.size(1)) * i61)];
                          }
                        }
                      }
                   ...
                   case 2:
                    {
                      ...
                      if ((static_cast<double>(numRows)) < ((static_cast<double>
                            (numRows)) - 2.0)) {
                        idx.set_size(1, 0);
                      } else {
                        int e_loop_ub;
                      ...
                      if (IsDistortionHigh) {
                          ...
                          for (int i25{0}; i25 < eb_loop_ub; i25++) {
                            for (int i36{0}; i36 < y_loop_ub; i36++) {
                              b_this[i36 + (b_this.size(1) * i25)] =
                                BoardCoords[((g_idx + (BoardCoords.size(0) * i36))
                                             + ((BoardCoords.size(0) *
                                                 BoardCoords.size(1)) * i25)) -
                                1];
                            }
                          ...
                          for (int i53{0}; i53 < ec_loop_ub; i53++) {
                            for (int i64{0}; i64 < bc_loop_ub; i64++) {
                              b_this[i64 + (b_this.size(1) * i53)] =
                                BoardCoords[((j_idx + (BoardCoords.size(0) * i64))
                                             + ((BoardCoords.size(0) *
                                                 BoardCoords.size(1)) * i53)) -
                                1];
                            }
                          }
                        ...
                        for (int i24{0}; i24 < db_loop_ub; i24++) {
                          for (int i35{0}; i35 < x_loop_ub; i35++) {
                            b_this[i35 + (b_this.size(1) * i24)] = BoardCoords
                              [((f_idx + (BoardCoords.size(0) * i35)) +
                                ((BoardCoords.size(0) * BoardCoords.size(1)) *
                                 i24)) - 1];
                          }
                        }
                        ...
                        for (int i57{0}; i57 < oc_loop_ub; i57++) {
                          ...
                          for (int i68{0}; i68 < vc_loop_ub; i68++) {
                            BoardCoords[(i68 + (BoardCoords.size(0) * i57)) +
                              ((BoardCoords.size(0) * BoardCoords.size(1)) * i48)]
                              = r1[(i68 + (r1.size(0) * i57)) + ((r1.size(0) *
                              r1.size(1)) * i48)];
                          }
                        }
                      }
                   ...
                   case 3:
                    {
                      ...
                      if (IsDistortionHigh) {
                        ...
                        if (!y) {
                          ...
                          q_loop_ub = BoardCoords.size(0);
                          r_loop_ub = BoardCoords.size(2);
                          d_this.set_size(q_loop_ub, 1, r_loop_ub);
                          for (int i14{0}; i14 < r_loop_ub; i14++) {
                            for (int i19{0}; i19 < q_loop_ub; i19++) {
                              d_this[i19 + (d_this.size(0) * i14)] =
                        ...
                        d_this.set_size(b_loop_ub, 1, f_loop_ub);
                        for (int i4{0}; i4 < f_loop_ub; i4++) {
                          for (int i6{0}; i6 < b_loop_ub; i6++) {
                            d_this[i6 + (d_this.size(0) * i4)] = BoardCoords[(i6
                              + BoardCoords.size(0)) + ((BoardCoords.size(0) *
                              BoardCoords.size(1)) * i4)];
                          }
                        }
                        ...
                        p_loop_ub = BoardCoords.size(2);
                        d_this.set_size(m_loop_ub, 1, p_loop_ub);
                        for (int i11{0}; i11 < p_loop_ub; i11++) {
                          for (int i17{0}; i17 < m_loop_ub; i17++) {
                            d_this[i17 + (d_this.size(0) * i11)] =
                        ...
                        for (int i44{0}; i44 < vb_loop_ub; i44++) {
                          ...
                          for (int i54{0}; i54 < ic_loop_ub; i54++) {
                            BoardCoords[(i54 + (BoardCoords.size(0) * i44)) +
                              ((BoardCoords.size(0) * BoardCoords.size(1)) * i31)]
                              = r1[(i54 + (r1.size(0) * i44)) + ((r1.size(0) *
                              r1.size(1)) * i31)];
                          }
                        }
                      }
                   ...
                   default:
                    {
                      ...
                      if ((static_cast<double>(numCols)) < ((static_cast<double>
                            (numCols)) - 2.0)) {
                        idx.set_size(1, 0);
                      } else {
                        int c_loop_ub;
                      ...
                      if (IsDistortionHigh) {
                        ...
                        if (!b_y) {
                          ...
                          d_this.set_size(v_loop_ub, 1, cb_loop_ub);
                          for (int i23{0}; i23 < cb_loop_ub; i23++) {
                            for (int i34{0}; i34 < v_loop_ub; i34++) {
                              d_this[i34 + (d_this.size(0) * i23)] =
                                BoardCoords[(i34 + (BoardCoords.size(0) * (e_idx
                                - 1))) + ((BoardCoords.size(0) *
                                           BoardCoords.size(1)) * i23)];
                            }
                          }
                          ...
                          d_this.set_size(xb_loop_ub, 1, dc_loop_ub);
                          for (int i51{0}; i51 < dc_loop_ub; i51++) {
                            for (int i60{0}; i60 < xb_loop_ub; i60++) {
                              d_this[i60 + (d_this.size(0) * i51)] =
                                BoardCoords[(i60 + (BoardCoords.size(0) * (h_idx
                                - 1))) + ((BoardCoords.size(0) *
                                           BoardCoords.size(1)) * i51)];
                            }
                          }
                        ...
                        i_loop_ub = BoardCoords.size(2);
                        d_this.set_size(g_loop_ub, 1, i_loop_ub);
                        for (int b_i8{0}; b_i8 < i_loop_ub; b_i8++) {
                          for (int i12{0}; i12 < g_loop_ub; i12++) {
                            d_this[i12 + (d_this.size(0) * b_i8)] = BoardCoords
                              [(i12 + (BoardCoords.size(0) * (b_idx - 1))) +
                              ((BoardCoords.size(0) * BoardCoords.size(1)) *
                               b_i8)];
                          }
                        }
                        ...
                        d_this.set_size(u_loop_ub, 1, bb_loop_ub);
                        for (int i22{0}; i22 < bb_loop_ub; i22++) {
                          for (int i33{0}; i33 < u_loop_ub; i33++) {
                            d_this[i33 + (d_this.size(0) * i22)] = BoardCoords
                              [(i33 + (BoardCoords.size(0) * (d_idx - 1))) +
                              ((BoardCoords.size(0) * BoardCoords.size(1)) * i22)];
                          }
                        }
                        ...
                        for (int i55{0}; i55 < jc_loop_ub; i55++) {
                          ...
                          for (int i65{0}; i65 < tc_loop_ub; i65++) {
                            BoardCoords[(i65 + (BoardCoords.size(0) * i55)) +
                              ((BoardCoords.size(0) * BoardCoords.size(1)) * i45)]
                              = r1[(i65 + (r1.size(0) * i55)) + ((r1.size(0) *
                              r1.size(1)) * i45)];
                          }
                        }
                      }
                     ...
                     case 1:
                      {
                        ...
                        if (IsDistortionHigh) {
                          ...
                          for (int j{0}; j < i9; j++) {
                            ...
                            for (int i22{0}; i22 < v_loop_ub; i22++) {
                              b_x[i22] = BoardCoords[(i22 + (BoardCoords.size(0)
                            ...
                            if (c_ii.size(0) >= 2) {
                              ...
                              polyfit(e_this, f_this, static_cast<double>(u_n),
                                      currCurve);
                              currRad = coordDist / 4.0;
                              currCoord = currRad + coordDist_tmp;
                              exitg2 = false;
                          ...
                          for (int i2{0}; i2 < d_loop_ub; i2++) {
                            for (int i6{0}; i6 < loop_ub; i6++) {
                              b_this[i6 + (b_this.size(1) * i2)] = BoardCoords
                                [((BoardCoords.size(0) * i6) +
                                  ((BoardCoords.size(0) * BoardCoords.size(1)) *
                                   i2)) + 1];
                            }
                          }
                          ...
                          for (int i29{0}; i29 < fb_loop_ub; i29++) {
                            ...
                            for (int i38{0}; i38 < pb_loop_ub; i38++) {
                              ...
                              predictedPoints[i38 + (predictedPoints.size(0) *
                                i29)] = (b_d1 + b_d1) - b_p1[i38 + (b_p1.size(0)
                                * i29)];
                            }
                          }
                          ...
                          for (int i62{0}; i62 < mc_loop_ub; i62++) {
                            ...
                            for (int i64{0}; i64 < pc_loop_ub; i64++) {
                              predictedPoints[(r4[i64] + (predictedPoints.size(0)
                                * i62)) - 1] = rtNaN;
                            }
                          }
                        ...
                        if (IsDistortionHigh) {
                          ...
                          for (int i11{0}; i11 < m_loop_ub; i11++) {
                            for (int i20{0}; i20 < i_loop_ub; i20++) {
                              b_this[i20 + (b_this.size(1) * i11)] =
                                BoardCoords[((c_idx + (BoardCoords.size(0) * i20))
                                             + ((BoardCoords.size(0) *
                                                 BoardCoords.size(1)) * i11)) -
                                1];
                            }
                          ...
                          for (int i32{0}; i32 < gb_loop_ub; i32++) {
                            for (int i39{0}; i39 < cb_loop_ub; i39++) {
                              b_this[i39 + (b_this.size(1) * i32)] =
                                BoardCoords[((e_idx + (BoardCoords.size(0) * i39))
                                             + ((BoardCoords.size(0) *
                                                 BoardCoords.size(1)) * i32)) -
                                1];
                            }
                          ...
                          for (int i69{0}; i69 < sc_loop_ub; i69++) {
                            ...
                            for (int i71{0}; i71 < uc_loop_ub; i71++) {
                              predictedPoints[(r7[i71] + (predictedPoints.size(0)
                                * i69)) - 1] = rtNaN;
                            }
                          }
                        ...
                        if (IsDistortionHigh) {
                          ...
                          for (int i5{0}; i5 < f_loop_ub; i5++) {
                            for (int i7{0}; i7 < b_loop_ub; i7++) {
                              d_this[i7 + (d_this.size(0) * i5)] = BoardCoords
                                [(i7 + BoardCoords.size(0)) + ((BoardCoords.size
                                (0) * BoardCoords.size(1)) * i5)];
                            }
                          }
                          ...
                          d_this.set_size(o_loop_ub, 1, q_loop_ub);
                          for (int i16{0}; i16 < q_loop_ub; i16++) {
                            for (int i23{0}; i23 < o_loop_ub; i23++) {
                              d_this[i23 + (d_this.size(0) * i16)] =
                          ...
                          for (int i63{0}; i63 < oc_loop_ub; i63++) {
                            ...
                            for (int i65{0}; i65 < qc_loop_ub; i65++) {
                              predictedPoints[(r5[i65] + (predictedPoints.size(0)
                                * i63)) - 1] = rtNaN;
                            }
                          }
                     ...
                     default:
                      {
                        ...
                        if (IsDistortionHigh) {
                          ...
                          d_this.set_size(h_loop_ub, 1, j_loop_ub);
                          for (int i10{0}; i10 < j_loop_ub; i10++) {
                            for (int i18{0}; i18 < h_loop_ub; i18++) {
                              d_this[i18 + (d_this.size(0) * i10)] =
                                BoardCoords[(i18 + (BoardCoords.size(0) * (b_idx
                                - 1))) + ((BoardCoords.size(0) *
                                           BoardCoords.size(1)) * i10)];
                            }
                          }
                          ...
                          eb_loop_ub = BoardCoords.size(2);
                          d_this.set_size(ab_loop_ub, 1, eb_loop_ub);
                          for (int i31{0}; i31 < eb_loop_ub; i31++) {
                            for (int i36{0}; i36 < ab_loop_ub; i36++) {
                              d_this[i36 + (d_this.size(0) * i31)] =
                                BoardCoords[(i36 + (BoardCoords.size(0) * (d_idx
                                - 1))) + ((BoardCoords.size(0) *
                                           BoardCoords.size(1)) * i31)];
                            }
                          }
                          ...
                          for (int i68{0}; i68 < rc_loop_ub; i68++) {
                            ...
                            for (int i70{0}; i70 < tc_loop_ub; i70++) {
                              predictedPoints[(r6[i70] + (predictedPoints.size(0)
                                * i68)) - 1] = rtNaN;
                            }
                          }
          ...
          void b_Checkerboard::initialize(double seedIdx, const ::coder::array<
            float, 2U> &b_points, const float b_v1[2], const float v2[2])
          {
            array<double, 2U> r1;
 ...
 num_threads(omp_get_max_threads())
            ...
            if ((static_cast<int>(b_loop_ub < 4)) != 0) {
              for (int i5{0}; i5 < b_loop_ub; i5++) {
                center[i5] = Points[((static_cast<int>(seedIdx)) + (Points.size
                  (0) * i5)) - 1];
              }
            } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            e_v1[0] = -b_v1[0];
            e_v1[1] = -b_v1[1];
            BoardIdx[1] = findNeighbor(pointVectors, euclideanDists, e_v1);
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
            ...
            if (varargout_1) {
              ...
              int x_loop_ub;
              int y_loop_ub;
              d_this = static_cast<int>(BoardIdx[(BoardIdx.size(0) * 2) + 1]);
              m_loop_ub = Points.size(1);
              b_r.set_size(1, m_loop_ub);
              o_loop_ub = m_loop_ub;
              if ((static_cast<int>(m_loop_ub < 4)) != 0) {
                for (int i14{0}; i14 < m_loop_ub; i14++) {
                  b_r[i14] = Points[(d_this + (Points.size(0) * i14)) - 1];
                }
              } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              db_l.set_size(1, s_loop_ub);
              t_loop_ub = s_loop_ub;
              if ((static_cast<int>(s_loop_ub < 4)) != 0) {
                for (int i17{0}; i17 < s_loop_ub; i17++) {
                  db_l[i17] = Points[(e_this + (Points.size(0) * i17)) - 1];
                }
              } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i19{0}; i19 < w_loop_ub; i19++) {
                BoardCoords[((BoardCoords.size(0) * BoardCoords.size(1)) * r[i19])
                  + 1] = static_cast<double>(db_l[i19]);
              }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              for (int i25{0}; i25 < hb_loop_ub; i25++) {
                BoardCoords[BoardCoords.size(0) + ((BoardCoords.size(0) *
                  BoardCoords.size(1)) * r[i25])] = static_cast<double>(c_u[i25]);
              }
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              kb_loop_ub = b_r.size(1);
              if ((static_cast<int>(b_r.size(1) < 4)) != 0) {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
              ...
              left.set_size(1, db_l.size(1));
              mb_loop_ub = db_l.size(1);
              if ((static_cast<int>(db_l.size(1) < 4)) != 0) {
                for (int i29{0}; i29 < mb_loop_ub; i29++) {
                  left[i29] = db_l[i29] - center[i29];
                }
              } else {
 ...
 num_threads(omp_get_max_threads())
                ...
                if ((static_cast<int>(vb_loop_ub < 4)) != 0) {
                  for (int i36{0}; i36 < vb_loop_ub; i36++) {
                    r1[i36] = static_cast<double>(Points[(h_this + (Points.size
                      (0) * i36)) - 1]);
                  }
                } else {
 ...
 num_threads(omp_get_max_threads())
                ...
                if ((static_cast<int>(bc_loop_ub < 4)) != 0) {
                  for (int i39{0}; i39 < bc_loop_ub; i39++) {
                    r1[i39] = static_cast<double>(Points[(i_this + (Points.size
                      (0) * i39)) - 1]);
                  }
                } else {
 ...
 num_threads(omp_get_max_threads())
                ...
                if ((static_cast<int>(gc_loop_ub < 4)) != 0) {
                  for (int i42{0}; i42 < gc_loop_ub; i42++) {
                    r1[i42] = static_cast<double>(Points[(j_this + (Points.size
                      (0) * i42)) - 1]);
                  }
                } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
                ...
                for (int i43{0}; i43 < ic_loop_ub; i43++) {
                  BoardCoords[((BoardCoords.size(0) * 2) + ((BoardCoords.size(0)
                    * BoardCoords.size(1)) * r[i43])) + 2] = r1[i43];
                }
 ...
 num_threads(omp_get_max_threads())
                ...
                if ((static_cast<int>(mc_loop_ub < 4)) != 0) {
                  for (int i45{0}; i45 < mc_loop_ub; i45++) {
                    r1[i45] = static_cast<double>(Points[(k_this + (Points.size
                      (0) * i45)) - 1]);
                  }
                } else {
                  ...
                  if ((static_cast<int>((tc_loop_ub * 3) < 4)) != 0) {
                    for (int i49{0}; i49 < tc_loop_ub; i49++) {
                      ...
                      row2[(3 * i49) + 1] = Points[((static_cast<int>
                        ...
                        i49)) - 1];
                      row2[(3 * i49) + 2] = Points[((static_cast<int>(BoardIdx
                        [(BoardIdx.size(0) * 2) + 1])) + (Points.size(0) * i49))
                        - 1];
                    }
                  } else {
                  ...
                  if ((static_cast<int>((vc_loop_ub * 3) < 4)) != 0) {
                    for (int i50{0}; i50 < vc_loop_ub; i50++) {
                      ...
                      row3[(3 * i50) + 1] = Points[((static_cast<int>
                        (BoardIdx[BoardIdx.size(0) + 2])) + (Points.size(0) *
                        i50)) - 1];
                      row3[(3 * i50) + 2] = Points[((static_cast<int>(BoardIdx
                        [(BoardIdx.size(0) * 2) + 2])) + (Points.size(0) * i50))
                        - 1];
                    }
                  } else {
                  ...
                  if ((static_cast<int>((row1.size(1) * 3) < 4)) != 0) {
                    for (int i51{0}; i51 < xc_loop_ub; i51++) {
                      num[3 * i51] = (row1[3 * i51] + row3[3 * i51]) - (2.0F *
                        row2[3 * i51]);
                      num[(3 * i51) + 1] = (row1[(3 * i51) + 1] + row3[(3 * i51)
                                            + 1]) - (2.0F * row2[(3 * i51) + 1]);
                      num[(3 * i51) + 2] = (row1[(3 * i51) + 2] + row3[(3 * i51)
                                            + 2]) - (2.0F * row2[(3 * i51) + 2]);
                    }
                  } else {
 ...
 num_threads(omp_get_max_threads())
                  ...
                  if ((static_cast<int>((row1.size(1) * 3) < 4)) != 0) {
                    for (int i52{0}; i52 < yc_loop_ub; i52++) {
                      ...
                      denom[(3 * i52) + 1] = row1[(3 * i52) + 1] - row3[(3 * i52)
                        + 1];
                      denom[(3 * i52) + 2] = row1[(3 * i52) + 2] - row3[(3 * i52)
                        + 2];
                    }
                  } else {
                  ...
                  if ((static_cast<int>((ed_loop_ub * 3) < 4)) != 0) {
                    for (int i55{0}; i55 < ed_loop_ub; i55++) {
                      col3[3 * i55] = Points[((static_cast<int>
                        (BoardIdx[BoardIdx.size(0) * 2])) + (Points.size(0) *
                        i55)) - 1];
                      col3[(3 * i55) + 1] = Points[((static_cast<int>(BoardIdx
                        [(BoardIdx.size(0) * 2) + 1])) + (Points.size(0) * i55))
                        - 1];
                      col3[(3 * i55) + 2] = Points[((static_cast<int>(BoardIdx
                        [(BoardIdx.size(0) * 2) + 2])) + (Points.size(0) * i55))
                        - 1];
                    }
                  } else {
                  ...
                  if ((static_cast<int>((col1.size(1) * 3) < 4)) != 0) {
                    for (int i56{0}; i56 < gd_loop_ub; i56++) {
                      num[3 * i56] = (col1[3 * i56] + col3[3 * i56]) - (2.0F *
                        col2[3 * i56]);
                      num[(3 * i56) + 1] = (col1[(3 * i56) + 1] + col3[(3 * i56)
                                            + 1]) - (2.0F * col2[(3 * i56) + 1]);
                      num[(3 * i56) + 2] = (col1[(3 * i56) + 2] + col3[(3 * i56)
                                            + 2]) - (2.0F * col2[(3 * i56) + 2]);
                    }
                  } else {
 ...
 num_threads(omp_get_max_threads())
                  ...
                  if ((static_cast<int>((col1.size(1) * 3) < 4)) != 0) {
                    for (int i57{0}; i57 < hd_loop_ub; i57++) {
                      ...
                      denom[(3 * i57) + 1] = col1[(3 * i57) + 1] - col3[(3 * i57)
                        + 1];
                      denom[(3 * i57) + 2] = col1[(3 * i57) + 2] - col3[(3 * i57)
                        + 2];
                    }
                  } else {
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads())
                  ...
                  boardSize = static_cast<float>(static_cast<int>(BoardIdx.size
                    (0) * BoardIdx.size(1)));
                  z1[0] /= z1_idx_0;
                  b_z1[0] = rt_hypotf_snf(num[0], num[3]) / rt_hypotf_snf(denom
                    [0], denom[3]);
                  z1[1] /= z1_idx_1;
                  b_z1[1] = rt_hypotf_snf(num[1], num[4]) / rt_hypotf_snf(denom
                    [1], denom[4]);
                  z1[2] /= z1_idx_2;
                  b_z1[2] = rt_hypotf_snf(num[2], num[5]) / rt_hypotf_snf(denom
                    [2], denom[5]);
                  e = (boardSize * std::fmax(std::fmax(0.0F, ::coder::internal::
                         maximum(z1)), ::coder::internal::maximum(b_z1))) -
                    boardSize;
                }
