  ...
  if ((bwin.size(0) != 0) && (bwin.size(1) != 0)) {
    ...
    if (bwin.size(0) >= 2) {
      if (bwin.size(1) >= 2) {
        ...
        b_i = bwin.size(0);
        if ((static_cast<int>((bwin.size(0) - 2) < 4)) != 0) {
          for (int rowInd{0}; rowInd <= (b_i - 3); rowInd++) {
            c_B[rowInd + 1] =
                lut[((((((static_cast<int>(bwin[rowInd])) * 8) +
                        ((static_cast<int>(bwin[rowInd + 1])) * 16)) +
                       ((static_cast<int>(bwin[rowInd + 2])) * 32)) +
                      ((static_cast<int>(bwin[rowInd + bwin.size(0)])) * 64)) +
                     ((static_cast<int>(bwin[(rowInd + bwin.size(0)) + 1])) *
                      128)) +
                    ((static_cast<int>(bwin[(rowInd + bwin.size(0)) + 2])) *
                     256)];
          }
        } else {
#pragma omp parallel for num_threads(omp_get_max_threads())
        ...
        lookUpInd =
            (((((static_cast<int>(bwin[(static_cast<int>(inDims[0])) - 2])) *
                8) +
               ((static_cast<int>(bwin[(static_cast<int>(inDims[0])) - 1])) *
                16)) +
              ((static_cast<int>(
                   bwin[((static_cast<int>(inDims[0])) + bwin.size(0)) - 2])) *
               64)) +
             ((static_cast<int>(
                  bwin[((static_cast<int>(inDims[0])) + bwin.size(0)) - 1])) *
              128)) +
            1;
        c_B[(static_cast<int>(inDims[0])) - 1] = lut[lookUpInd - 1];
        //  process second column to last but one
        //  column-------------------------
        ub_loop = (static_cast<int>(inDims[1])) - 3;
#pragma omp parallel for num_threads(omp_get_max_threads()) private(           \
    lookUpInd, i4, c_rowInd)
        ...
        if ((static_cast<int>(((static_cast<int>(inDims[1])) - 2) < 4)) != 0) {
          for (int c_colInd{0}; c_colInd <= (i3 - 3); c_colInd++) {
            //  process first row element
            c_B[c_B.size(0) * (c_colInd + 1)] = lut
...
#pragma omp parallel for num_threads(omp_get_max_threads())
        ...
        colInd_tmp_tmp = (static_cast<int>(inDims[1])) - 1;
        d_colInd = (static_cast<int>(inDims[1])) - 1;
        ...
        if ((static_cast<int>(((static_cast<int>(inDims[0])) - 2) < 4)) != 0) {
          for (int d_rowInd{0}; d_rowInd <= (i5 - 3); d_rowInd++) {
            c_B[(d_rowInd + (c_B.size(0) * colInd_tmp_tmp)) + 1] = lut
                [(((((static_cast<int>(
                         bwin[d_rowInd +
                              (bwin.size(0) * (colInd_tmp_tmp - 1))])) +
                     ((static_cast<int>(
                          bwin[(d_rowInd +
                                (bwin.size(0) * (colInd_tmp_tmp - 1))) +
                               1])) *
                    ...
                    ((static_cast<int>(
                     ...
                     4)) +
                   ((static_cast<int>(
                        bwin[d_rowInd + (bwin.size(0) * colInd_tmp_tmp)])) *
                    8)) +
                  ((static_cast<int>(
                       bwin[(d_rowInd + (bwin.size(0) * colInd_tmp_tmp)) +
                            1])) *
                   16)) +
                 ((static_cast<int>(
                      bwin[(d_rowInd + (bwin.size(0) * colInd_tmp_tmp)) + 2])) *
                  32)];
          }
        } else {
#pragma omp parallel for num_threads(omp_get_max_threads())
          ...
          for (int d_rowInd = 0; d_rowInd <= (i5 - 3); d_rowInd++) {
            c_B[(d_rowInd + (c_B.size(0) * d_colInd)) + 1] =
                lut[(((((static_cast<int>(
                            bwin[d_rowInd + (bwin.size(0) * (d_colInd - 1))])) +
                        ((static_cast<int>(
                             bwin[(d_rowInd + (bwin.size(0) * (d_colInd - 1))) +
                                  1])) *
                         2)) +
                       ((static_cast<int>(
                        ...
                        4)) +
                      ((static_cast<int>(
                           bwin[d_rowInd + (bwin.size(0) * d_colInd)])) *
                       8)) +
                     ((static_cast<int>(
                          bwin[(d_rowInd + (bwin.size(0) * d_colInd)) + 1])) *
                      16)) +
                    ((static_cast<int>(
                         bwin[(d_rowInd + (bwin.size(0) * d_colInd)) + 2])) *
                     32)];
          }
        }
...
#pragma omp parallel for num_threads(omp_get_max_threads())
        ...
        c_B[(static_cast<int>(inDims[0])) - 1] =
            lut[((static_cast<int>(bwin[(static_cast<int>(inDims[0])) - 2])) *
                 8) +
                ((static_cast<int>(bwin[(static_cast<int>(inDims[0])) - 1])) *
                 16)];
      }
      if ((static_cast<int>(inDims[1])) > 1) {
        int i2;
        //  input size is 1xN
        c_B[0] = lut[((static_cast<int>(bwin[0])) * 16) +
                     ((static_cast<int>(bwin[bwin.size(0)])) * 128)];
        i2 = static_cast<int>(inDims[1]);
        if ((static_cast<int>(((static_cast<int>(inDims[1])) - 2) < 4)) != 0) {
          for (int colInd{0}; colInd <= (i2 - 3); colInd++) {
            c_B[c_B.size(0) * (colInd + 1)] =
                lut[(((static_cast<int>(bwin[bwin.size(0) * colInd])) * 2) +
...
#pragma omp parallel for num_threads(omp_get_max_threads())
        ...
        c_B[c_B.size(0) * ((static_cast<int>(inDims[1])) - 1)] =
            lut[((static_cast<int>(bwin[bwin.size(0) *
                                        ((static_cast<int>(inDims[1])) - 2)])) *
                 2) +
                ((static_cast<int>(bwin[bwin.size(0) *
                                        ((static_cast<int>(inDims[1])) - 1)])) *
                 16)];
      }
    }
  }
